...
@Metadata(mv={2, 3, 0}, k=1, xi=48, d1={"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007\u00a2\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\f\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\tH\u0002\u00a2\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u000e\u001a\u00020\tH\u0002\u00a2\u0006\u0004\b\u000e\u0010\u000fJ\u0017\u0010\u0011\u001a\u00020\t2\u0006\u0010\u0010\u001a\u00020\tH\u0002\u00a2\u0006\u0004\b\u0011\u0010\u0012J\u0017\u0010\u0013\u001a\u00020\t2\u0006\u0010\u0010\u001a\u00020\tH\u0002\u00a2\u0006\u0004\b\u0013\u0010\u0012R\u0014\u0010\u0015\u001a\u00020\u00148\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0018\u001a\u00020\u00178\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\u0014\u0010\u001b\u001a\u00020\u001a8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0014\u0010\u001e\u001a\u00020\u001d8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u001e\u0010\u001fR\u0014\u0010!\u001a\u00020 8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b!\u0010\"\u00a8\u0006#"}, d2={"Lorg/cobalt/internal/visual/BlockOverlayModule;", "Lorg/cobalt/api/module/Module;", "<init>", "()V", "Lorg/cobalt/api/event/impl/render/WorldRenderEvent$Last;", "event", "", "onRender", "(Lorg/cobalt/api/event/impl/render/WorldRenderEvent$Last;)V", "", "argb", "Lorg/cobalt/internal/pathfinding/OverlayRenderEngine$Color;", "toOverlayColor", "(I)Lorg/cobalt/internal/pathfinding/OverlayRenderEngine$Color;", "resolveColor", "()I", "baseArgb", "rainbowColor", "(I)I", "duttColor", "", "TAG", "Ljava/lang/String;", "Lorg/cobalt/api/module/setting/impl/CheckboxSetting;", "enabled", "Lorg/cobalt/api/module/setting/impl/CheckboxSetting;", "Lorg/cobalt/api/module/setting/impl/ColorSetting;", "overlayColor", "Lorg/cobalt/api/module/setting/impl/ColorSetting;", "Lorg/cobalt/api/module/setting/impl/SliderSetting;", "overlayOpacity", "Lorg/cobalt/api/module/setting/impl/SliderSetting;", "Lorg/cobalt/api/module/setting/impl/ModeSetting;", "colorMode", "Lorg/cobalt/api/module/setting/impl/ModeSetting;", "cobalt"})
public final class BlockOverlayModule
extends Module {
    @NotNull
    public static final BlockOverlayModule INSTANCE = new BlockOverlayModule();
    @NotNull
    private static final String TAG = "block-overlay";
    @NotNull
    private static final CheckboxSetting enabled = new CheckboxSetting("Enabled", "Fill the targeted block with a translucent overlay.", false);
    @NotNull
    private static final ColorSetting overlayColor = new ColorSetting("Overlay Color", "Block overlay color (RGBA).", -1);
    @NotNull
    private static final SliderSetting overlayOpacity = new SliderSetting("Opacity", "Fill opacity (0-100%).", 0.2, 0.0, 1.0, 0.0, 32, null);
    @NotNull
    ...
    public final void onRender(@NotNull WorldRenderEvent.Last event) {
        ...
        if (class_6382 == null) {
            BlockOverlayModule $this$onRender_u24lambda_u240 = this;
            boolean bl = false;
        ...
        if (class_7462 == null) {
            BlockOverlayModule $this$onRender_u24lambda_u241 = this;
            boolean bl = false;
            OverlayRenderEngine.INSTANCE.clearTag(TAG);
            return;
        }
        ...
        int fillAlpha = RangesKt.coerceIn((int)MathKt.roundToInt((double)((double)baseColor.getA() * ((Number)overlayOpacity.getValue()).doubleValue())), (int)0, (int)255);
        OverlayRenderEngine.Color fillColor = baseColor.withAlpha(fillAlpha);
        OverlayRenderEngine.addBox$default(OverlayRenderEngine.INSTANCE, (class_1937)level2, minX, minY, minZ, maxX, maxY, maxZ, fillColor, null, 1.0f, 2, TAG, false, 4096, null);
    ...
    private final int resolveColor() {
        return switch (((Number)colorMode.getValue()).intValue()) {
            case 1 -> this.rainbowColor(overlayColor.getValue());
            case 2 -> this.duttColor(overlayColor.getValue());
            default -> overlayColor.getValue();
        };
    }
    ...
    static {
        ...
        colorMode = new ModeSetting("Color Mode", "Color mode for the overlay.", 0, (String[])objectArray);
        objectArray = new Setting[]{enabled, overlayColor, overlayOpacity, colorMode};
