...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.searchBox = linearLayout.addChild(new EditBox(this.font, this.width / 2 - 100, 22, 200, 20, this.searchBox, (Component)Component.translatable((String)"selectWorld.search")));
        ...
        try {
            ...
            this.minecraft.setScreen(new RealmsGenericErrorScreen(UNABLE_TO_LOAD_WORLD, Component.nullToEmpty((String)exception.getMessage()), this.lastScreen));
            return;
        }
        ...
        this.uploadButton = linearLayout2.addChild(Button.builder((Component)Component.translatable((String)"mco.upload.button.name"), button -> this.list.getSelectedOpt().ifPresent(this::upload)).build());
