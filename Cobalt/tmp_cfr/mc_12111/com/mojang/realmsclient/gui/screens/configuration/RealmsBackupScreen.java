...
extends RealmsScreen {
    ...
    static final Component RESTORE_TOOLTIP = Component.translatable((String)"mco.backup.button.restore");
    static final Component HAS_CHANGES_TOOLTIP = Component.translatable((String)"mco.backup.changes.tooltip");
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        if (this.noBackups && this.backupList != null) {
            guiGraphics.drawString(this.font, NO_BACKUPS_LABEL, this.width / 2 - this.font.width((FormattedText)NO_BACKUPS_LABEL) / 2, this.backupList.getY() + this.backupList.getHeight() / 2 - this.font.lineHeight / 2, -1);
        }
    }
    ...
    extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public Entry(Backup backup) {
            ...
            if (!backup.changeList.isEmpty()) {
                this.changesButton = Button.builder(HAS_CHANGES_TOOLTIP, button -> RealmsBackupScreen.this.minecraft.setScreen(new RealmsBackupInfoScreen(RealmsBackupScreen.this, this.backup))).width(8 + RealmsBackupScreen.this.font.width((FormattedText)HAS_CHANGES_TOOLTIP)).createNarration(this::narrationForBackupEntry).build();
                this.children.add(this.changesButton);
            }
            if (!RealmsBackupScreen.this.serverData.expired) {
                this.restoreButton = Button.builder(RESTORE_TOOLTIP, button -> this.restoreClicked()).width(8 + RealmsBackupScreen.this.font.width((FormattedText)HAS_CHANGES_TOOLTIP)).createNarration(this::narrationForBackupEntry).build();
                this.children.add(this.restoreButton);
            }
        }

        private MutableComponent narrationForBackupEntry(Supplier<MutableComponent> supplier) {
            return CommonComponents.joinForNarration((Component[])new Component[]{Component.translatable((String)"mco.backup.narration", (Object[])new Object[]{SHORT_DATE_FORMAT.format(this.backup.lastModifiedDate())}), (Component)supplier.get()});
        }
        ...
        private void restoreClicked() {
            ...
            MutableComponent component2 = Component.translatable((String)"mco.configure.world.restore.question.line1", (Object[])new Object[]{string, component});
            RealmsBackupScreen.this.minecraft.setScreen(RealmsPopups.warningPopupScreen(RealmsBackupScreen.this, (Component)component2, popupScreen -> {
        ...
        public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
            ...
            guiGraphics.drawString(RealmsBackupScreen.this.font, (Component)Component.translatable((String)"mco.backup.entry", (Object[])new Object[]{RealmsUtil.convertToAgePresentationFromInstant(this.backup.lastModified)}), this.getContentX(), l, n);
