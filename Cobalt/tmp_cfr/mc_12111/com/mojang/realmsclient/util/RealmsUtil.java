...
public class RealmsUtil {
    ...
    public static Component convertToAgePresentation(long l) {
        ...
        long m = l / 1000L;
        if (m < 60L) {
            return Component.translatable((String)"mco.time.secondsAgo", (Object[])new Object[]{m});
        }
        if (m < 3600L) {
            long n = m / 60L;
            return Component.translatable((String)"mco.time.minutesAgo", (Object[])new Object[]{n});
        }
        if (m < 86400L) {
            long n = m / 3600L;
            return Component.translatable((String)"mco.time.hoursAgo", (Object[])new Object[]{n});
        }
        long n = m / 86400L;
        return Component.translatable((String)"mco.time.daysAgo", (Object[])new Object[]{n});
    }
    ...
    public static void renderPlayerFace(GuiGraphics guiGraphics, int i, int j, int k, UUID uUID) {
        PlayerSkinRenderCache.RenderInfo renderInfo = Minecraft.getInstance().playerSkinRenderCache().getOrDefault(ResolvableProfile.createUnresolved((UUID)uUID));
