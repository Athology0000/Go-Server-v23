...
public class GameNarrator {
    ...
    public void updateNarratorStatus(NarratorStatus narratorStatus) {
        this.clear();
        this.narrateMessage(Component.translatable((String)"options.narrator").append(" : ").append(narratorStatus.getName()).getString(), true);
        ...
        if (this.narrator.active()) {
            if (narratorStatus == NarratorStatus.OFF) {
                ...
                SystemToast.addOrUpdate(toastManager, SystemToast.SystemToastId.NARRATOR_TOGGLE, (Component)Component.translatable((String)"narrator.toast.enabled"), narratorStatus.getName());
            }
        } else {
