...
implements Comparable<KeyMapping> {
    ...
    public int compareTo(KeyMapping keyMapping) {
        ...
        return Integer.compare(Category.SORT_ORDER.indexOf(this.category), Category.SORT_ORDER.indexOf(keyMapping.category));
    }
    ...
    public record Category(Identifier id) {
        ...
        private static Category register(String string) {
            return Category.register(Identifier.withDefaultNamespace((String)string));
        }
