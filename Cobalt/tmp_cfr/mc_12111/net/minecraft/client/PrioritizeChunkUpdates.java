...
public enum PrioritizeChunkUpdates {
    ...
    private PrioritizeChunkUpdates(int j, String string2) {
        this.id = j;
        this.caption = Component.translatable((String)string2);
    }
    ...
    static {
        BY_ID = ByIdMap.continuous(prioritizeChunkUpdates -> prioritizeChunkUpdates.id, (Object[])PrioritizeChunkUpdates.values(), (ByIdMap.OutOfBoundsStrategy)ByIdMap.OutOfBoundsStrategy.WRAP);
