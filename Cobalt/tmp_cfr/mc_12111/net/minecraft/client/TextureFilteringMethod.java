...
public enum TextureFilteringMethod {
    ...
    static {
        BY_ID = ByIdMap.continuous(textureFilteringMethod -> textureFilteringMethod.id, (Object[])TextureFilteringMethod.values(), (ByIdMap.OutOfBoundsStrategy)ByIdMap.OutOfBoundsStrategy.WRAP);
