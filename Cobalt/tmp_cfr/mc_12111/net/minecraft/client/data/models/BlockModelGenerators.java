...
public class BlockModelGenerators {
    ...
    private static final Function<ConditionBuilder, ConditionBuilder> FLOWER_BED_MODEL_2_SEGMENT_CONDITION = conditionBuilder -> conditionBuilder.term((Property)BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(2), new Integer[]{3, 4});
    private static final Function<ConditionBuilder, ConditionBuilder> FLOWER_BED_MODEL_3_SEGMENT_CONDITION = conditionBuilder -> conditionBuilder.term((Property)BlockStateProperties.FLOWER_AMOUNT, Integer.valueOf(3), new Integer[]{4});
    ...
    private static final Function<ConditionBuilder, ConditionBuilder> LEAF_LITTER_MODEL_2_SEGMENT_CONDITION = conditionBuilder -> conditionBuilder.term((Property)BlockStateProperties.SEGMENT_AMOUNT, Integer.valueOf(2), new Integer[]{3});
    ...
    private static MultiVariant variants(Variant ... variants) {
        return new MultiVariant((WeightedList<Variant>)WeightedList.of(Arrays.stream(variants).map(variant -> new Weighted(variant, 1)).toList()));
    }
    ...
    private static <T extends Enum<T>> ConditionBuilder condition(EnumProperty<T> enumProperty, T enum_, T ... enums) {
        return BlockModelGenerators.condition().term((Property)enumProperty, (Comparable)((Object)enum_), (Comparable[])enums);
    }
    ...
    private static MultiVariant createBambooModels(int i2) {
        ...
        return new MultiVariant((WeightedList<Variant>)WeightedList.of(IntStream.range(1, 5).mapToObj(i -> new Weighted((Object)BlockModelGenerators.plainModel(ModelLocationUtils.getModelLocation(Blocks.BAMBOO, i + string)), 1)).collect(Collectors.toList())));
    }
    ...
    private void createBeeNest(Block block, Function<Block, TextureMapping> function) {
        ...
        this.itemModelOutput.accept(block.asItem(), ItemModelUtils.selectBlockItemProperty(BeehiveBlock.HONEY_LEVEL, ItemModelUtils.plainModel(identifier), Map.of(5, ItemModelUtils.plainModel(identifier2))));
    ...
    private void createRepeater() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.dispatch(Blocks.REPEATER).with(PropertyDispatch.initial(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED).generate((integer, boolean_, boolean2) -> {
    ...
    private static Condition shelfCondition(Direction direction, @Nullable Boolean boolean_, @Nullable SideChainPart sideChainPart) {
        ConditionBuilder conditionBuilder = BlockModelGenerators.condition((EnumProperty)BlockStateProperties.HORIZONTAL_FACING, (Enum)direction, (Enum[])new Direction[0]);
        if (boolean_ == null) {
            return conditionBuilder.build();
        }
        ConditionBuilder conditionBuilder2 = BlockModelGenerators.condition(BlockStateProperties.POWERED, boolean_);
        return sideChainPart != null ? BlockModelGenerators.and(conditionBuilder, conditionBuilder2, BlockModelGenerators.condition((EnumProperty)BlockStateProperties.SIDE_CHAIN_PART, (Enum)sideChainPart, (Enum[])new SideChainPart[0])) : BlockModelGenerators.and(conditionBuilder, conditionBuilder2);
    }
    ...
    private void createHeads() {
        ...
        this.createHead(Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, (SkullBlock.Type)SkullBlock.Types.CREEPER, identifier);
        this.createHead(Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, (SkullBlock.Type)SkullBlock.Types.PLAYER, identifier);
        this.createHead(Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, (SkullBlock.Type)SkullBlock.Types.ZOMBIE, identifier);
        this.createHead(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, (SkullBlock.Type)SkullBlock.Types.SKELETON, identifier);
        this.createHead(Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, (SkullBlock.Type)SkullBlock.Types.WITHER_SKELETON, identifier);
        this.createHead(Blocks.PIGLIN_HEAD, Blocks.PIGLIN_WALL_HEAD, (SkullBlock.Type)SkullBlock.Types.PIGLIN, identifier);
    ...
    private void createCopperGolemStatue(Block block, Block block2, WeatheringCopper.WeatherState weatherState) {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(block, multiVariant));
        this.itemModelOutput.accept(block.asItem(), ItemModelUtils.selectBlockItemProperty(CopperGolemStatueBlock.POSE, ItemModelUtils.specialModel(identifier, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.STANDING)), Map.of(CopperGolemStatueBlock.Pose.SITTING, ItemModelUtils.specialModel(identifier, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.SITTING)), CopperGolemStatueBlock.Pose.STAR, ItemModelUtils.specialModel(identifier, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.STAR)), CopperGolemStatueBlock.Pose.RUNNING, ItemModelUtils.specialModel(identifier, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.RUNNING)))));
    }
