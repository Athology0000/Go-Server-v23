...
public class ItemModelGenerators {
    ...
    public static Identifier prefixForSlotTrim(String string) {
        return Identifier.withDefaultNamespace((String)("trims/items/" + string + "_trim"));
    }
    ...
    private List<RangeSelectItemModel.Entry> createCompassModels(Item item) {
        ...
        for (int i = 1; i < 32; ++i) {
            int j = Mth.positiveModulo((int)(i - 16), (int)32);
    ...
    private static ItemModel.Unbaked createFlatModelDispatch(ItemModel.Unbaked unbaked, ItemModel.Unbaked unbaked2) {
        return ItemModelUtils.select(new DisplayContext(), unbaked2, ItemModelUtils.when(List.of(ItemDisplayContext.GUI, ItemDisplayContext.GROUND, ItemDisplayContext.FIXED, ItemDisplayContext.ON_SHELF), unbaked));
    }
