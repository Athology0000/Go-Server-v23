        ...
        return new MultiLineLabel(){
            ...
            private List<TextAndWidth> getSplitMessage() {
                ...
                for (Component component : components) {
                    list.addAll(font.splitIgnoringLanguage((FormattedText)component, i));
                }
                ...
                for (int j2 = 0; j2 < list2.size(); ++j2) {
                    ...
                    if (j2 == list2.size() - 1 && i2 == j && i2 != list.size()) {
                        FormattedText formattedText2 = font.substrByWidth(formattedText, font.width(formattedText) - font.width((FormattedText)CommonComponents.ELLIPSIS));
                        FormattedText formattedText3 = FormattedText.composite((FormattedText[])new FormattedText[]{formattedText2, CommonComponents.ELLIPSIS.copy().withStyle(components[components.length - 1].getStyle())});
