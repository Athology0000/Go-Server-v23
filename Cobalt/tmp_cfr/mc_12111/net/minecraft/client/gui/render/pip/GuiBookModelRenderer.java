...
extends PictureInPictureRenderer<GuiBookModelRenderState> {
    ...
    protected void renderToTexture(GuiBookModelRenderState guiBookModelRenderState, PoseStack poseStack) {
        ...
        float h = Mth.clamp((float)(Mth.frac((float)(g + 0.25f)) * 1.6f - 0.3f), (float)0.0f, (float)1.0f);
        float i = Mth.clamp((float)(Mth.frac((float)(g + 0.75f)) * 1.6f - 0.3f), (float)0.0f, (float)1.0f);
