...
extends Screen {
    ...
    protected void init() {
        ...
        this.eraseCache = Checkbox.builder((Component)Component.translatable((String)"selectWorld.backupEraseCache").withColor(-2039584), this.font).pos(this.width / 2 - 155 + 80, 76 + i).build();
