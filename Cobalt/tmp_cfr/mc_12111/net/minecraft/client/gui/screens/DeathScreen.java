...
extends Screen {
    ...
    public DeathScreen(@Nullable Component component, boolean bl, LocalPlayer localPlayer) {
        super((Component)Component.translatable((String)(bl ? "deathScreen.title.hardcore" : "deathScreen.title")));
        this.causeOfDeath = component;
        this.hardcore = bl;
        this.player = localPlayer;
        MutableComponent component2 = Component.literal((String)Integer.toString(localPlayer.getScore())).withStyle(ChatFormatting.YELLOW);
        this.deathScore = Component.translatable((String)"deathScreen.score.value", (Object[])new Object[]{component2});
    }
    ...
    protected void init() {
        ...
        this.exitButtons.add(this.addRenderableWidget(Button.builder((Component)component, button -> {
            this.player.respawn();
            button.active = false;
