...
extends Screen {
    ...
    private static final Object2IntMap<ChunkStatus> COLORS = (Object2IntMap)Util.make((Object)new Object2IntOpenHashMap(), object2IntOpenHashMap -> {
    ...
    protected void updateNarratedWidget(NarrationElementOutput narrationElementOutput) {
        if (this.loadTracker.hasProgress()) {
            narrationElementOutput.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"loading.progress", (Object[])new Object[]{Mth.floor((float)(this.loadTracker.serverProgress() * 100.0f))}));
        }
    }
    ...
    public static void renderChunks(GuiGraphics guiGraphics, int i, int j, int k, int l, ChunkLoadStatusView chunkLoadStatusView) {
        ...
        for (r = 0; r < n; ++r) {
            for (int s = 0; s < n; ++s) {
                ...
                int t = p + r * m;
                int u = q + s * m;
                guiGraphics.fill(t, u, t + k, u + k, ARGB.opaque((int)COLORS.getInt((Object)chunkStatus)));
            }
        }
    }
