...
extends Screen {
    ...
    public RecoverWorldDataScreen(Minecraft minecraft, BooleanConsumer booleanConsumer, LevelStorageSource.LevelStorageAccess levelStorageAccess) {
        ...
        this.message = Component.translatable((String)"recover_world.message", (Object[])new Object[]{Component.literal((String)levelStorageAccess.getLevelId()).withStyle(ChatFormatting.GRAY)});
        ...
        this.issuesWidget = new MultiLineTextWidget((Component)component, minecraft.font);
    ...
    private Component buildInfo(LevelStorageSource.LevelStorageAccess levelStorageAccess, boolean bl, @Nullable Exception exception) {
        ...
        MutableComponent mutableComponent2 = instant != null ? Component.literal((String)WorldSelectionList.DATE_FORMAT.format(ZonedDateTime.ofInstant(instant, ZoneId.systemDefault()))) : Component.translatable((String)"recover_world.state_entry.unknown");
        mutableComponent.append((Component)Component.translatable((String)"recover_world.state_entry", (Object[])new Object[]{mutableComponent2.withStyle(ChatFormatting.GRAY)}));
        if (exception == null) {
            ...
            mutableComponent.append((Component)Component.literal((String)exception.getCause().toString()).withStyle(ChatFormatting.RED));
        } else {
            mutableComponent.append((Component)Component.literal((String)exception.toString()).withStyle(ChatFormatting.RED));
        }
