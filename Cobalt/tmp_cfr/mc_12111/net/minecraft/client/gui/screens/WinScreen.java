...
extends Screen {
    ...
    private void addCreditsFile(Reader reader) {
        JsonArray jsonArray = GsonHelper.parseArray((Reader)reader);
        for (JsonElement jsonElement : jsonArray) {
            JsonObject jsonObject = jsonElement.getAsJsonObject();
            String string = jsonObject.get("section").getAsString();
            this.addCreditsLine(SECTION_HEADING, true, false);
            this.addCreditsLine((Component)Component.literal((String)string).withStyle(ChatFormatting.YELLOW), true, true);
            this.addCreditsLine(SECTION_HEADING, true, false);
            this.addEmptyLine();
            this.addEmptyLine();
            ...
            for (JsonElement jsonElement2 : jsonArray2) {
                ...
                if (StringUtils.isNotEmpty((CharSequence)string2)) {
                    this.addCreditsLine((Component)Component.literal((String)string2).withStyle(ChatFormatting.YELLOW), true, true);
                    this.addEmptyLine();
                    this.addEmptyLine();
                }
                ...
                for (JsonElement jsonElement3 : jsonArray3) {
                    ...
                    this.addCreditsLine((Component)Component.literal((String)string3).withStyle(ChatFormatting.GRAY), false, true);
                    for (JsonElement jsonElement4 : jsonArray4) {
                        String string4 = jsonElement4.getAsString();
                        this.addCreditsLine((Component)Component.literal((String)NAME_PREFIX).append(string4).withStyle(ChatFormatting.WHITE), false, true);
                    }
                    this.addEmptyLine();
                    this.addEmptyLine();
                }
    ...
    private void addPoemLines(String string) {
        MutableComponent component = Component.literal((String)string);
