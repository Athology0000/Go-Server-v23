...
extends ItemCombinerScreen<AnvilMenu> {
    ...
    protected void subInit() {
        ...
        this.name = new EditBox(this.font, i + 62, j + 24, 103, 12, (Component)Component.translatable((String)"container.repair"));
    ...
    private void onNameChanged(String string) {
        ...
        if (((AnvilMenu)this.menu).setItemName(string2)) {
            this.minecraft.player.connection.send((Packet<?>)new ServerboundRenameItemPacket(string2));
        }
    }
