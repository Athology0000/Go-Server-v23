...
extends AbstractContainerScreen<BeaconMenu> {
    ...
    static final Identifier BUTTON_DISABLED_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/button_disabled");
    static final Identifier BUTTON_SELECTED_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/button_selected");
    static final Identifier BUTTON_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/button_highlighted");
    static final Identifier BUTTON_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/button");
    static final Identifier CONFIRM_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/confirm");
    static final Identifier CANCEL_SPRITE = Identifier.withDefaultNamespace((String)"container/beacon/cancel");
    ...
    protected void init() {
        ...
        for (i = 0; i <= 2; ++i) {
            ...
            for (l = 0; l < j; ++l) {
                ...
                beaconPowerButton = new BeaconPowerButton(this.leftPos + 76 + l * 24 - k / 2, this.topPos + 22 + i * 25, (Holder<MobEffect>)holder, true, i);
        ...
        for (l = 0; l < j - 1; ++l) {
            ...
            beaconPowerButton = new BeaconPowerButton(this.leftPos + 167 + l * 24 - k / 2, this.topPos + 47, (Holder<MobEffect>)holder, false, 3);
            beaconPowerButton.active = false;
            this.addBeaconButton(beaconPowerButton);
        }
        Holder holder2 = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(0)).get(0);
        BeaconUpgradePowerButton beaconPowerButton2 = new BeaconUpgradePowerButton(this.leftPos + 167 + (j - 1) * 24 - k / 2, this.topPos + 47, (Holder<MobEffect>)holder2);
    ...
    protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
        ...
        guiGraphics.renderItem(new ItemStack((ItemLike)Items.NETHERITE_INGOT), k + 20, l + 109);
        guiGraphics.renderItem(new ItemStack((ItemLike)Items.EMERALD), k + 41, l + 109);
        guiGraphics.renderItem(new ItemStack((ItemLike)Items.DIAMOND), k + 41 + 22, l + 109);
        guiGraphics.renderItem(new ItemStack((ItemLike)Items.GOLD_INGOT), k + 42 + 44, l + 109);
        guiGraphics.renderItem(new ItemStack((ItemLike)Items.IRON_INGOT), k + 42 + 66, l + 109);
    }
    ...
    extends BeaconScreenButton {
        ...
        protected void setEffect(Holder<MobEffect> holder) {
            ...
            this.setTooltip(Tooltip.create((Component)this.createEffectDescription(holder), null));
        }

        protected MutableComponent createEffectDescription(Holder<MobEffect> holder) {
            return Component.translatable((String)((MobEffect)holder.value()).getDescriptionId());
        }
    ...
    extends BeaconPowerButton {
        ...
        @Override
        protected MutableComponent createEffectDescription(Holder<MobEffect> holder) {
            return Component.translatable((String)((MobEffect)holder.value()).getDescriptionId()).append(" II");
        }
