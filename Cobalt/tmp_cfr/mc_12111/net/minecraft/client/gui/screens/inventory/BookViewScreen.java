...
extends Screen {
    ...
    public boolean setPage(int i) {
        int j = Mth.clamp((int)i, (int)0, (int)(this.bookAccess.getPageCount() - 1));
    ...
    private void visitText(ActiveTextCollector activeTextCollector, boolean bl) {
        if (this.cachedPage != this.currentPage) {
            Component formattedText = ComponentUtils.mergeStyles((Component)this.bookAccess.getPage(this.currentPage), (Style)PAGE_TEXT_STYLE);
            this.cachedPageComponents = this.font.split((FormattedText)formattedText, 114);
