...
extends Screen {
    ...
    protected void init() {
        ...
        this.jointButton.active = bl = JigsawBlock.getFrontFacing((BlockState)this.jigsawEntity.getBlockState()).getAxis().isVertical();
        ...
        this.addRenderableWidget(new AbstractSliderButton(this.width / 2 - 154, 185, 100, 20, CommonComponents.EMPTY, 0.0){
            ...
            protected void updateMessage() {
                this.setMessage((Component)Component.translatable((String)"jigsaw_block.levels", (Object[])new Object[]{JigsawBlockEditScreen.this.levels}));
            }

            @Override
            protected void applyValue() {
                JigsawBlockEditScreen.this.levels = Mth.floor((double)Mth.clampedLerp((double)this.value, (double)0.0, (double)20.0));
            }
        });
        this.addRenderableWidget(CycleButton.onOffBuilder(this.keepJigsaws).create(this.width / 2 - 50, 185, 100, 20, (Component)Component.translatable((String)"jigsaw_block.keep_jigsaws"), (cycleButton, boolean_) -> {
    ...
    public static boolean isValidIdentifier(String string) {
        return Identifier.tryParse((String)string) != null;
    }
