...
extends ObjectSelectionList<Entry> {
    static final Identifier INCOMPATIBLE_SPRITE = Identifier.withDefaultNamespace((String)"server_list/incompatible");
    static final Identifier UNREACHABLE_SPRITE = Identifier.withDefaultNamespace((String)"server_list/unreachable");
    static final Identifier PING_1_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_1");
    static final Identifier PING_2_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_2");
    static final Identifier PING_3_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_3");
    static final Identifier PING_4_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_4");
    static final Identifier PING_5_SPRITE = Identifier.withDefaultNamespace((String)"server_list/ping_5");
    static final Identifier PINGING_1_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_1");
    static final Identifier PINGING_2_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_2");
    static final Identifier PINGING_3_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_3");
    static final Identifier PINGING_4_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_4");
    static final Identifier PINGING_5_SPRITE = Identifier.withDefaultNamespace((String)"server_list/pinging_5");
    static final Identifier JOIN_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"server_list/join_highlighted");
    static final Identifier JOIN_SPRITE = Identifier.withDefaultNamespace((String)"server_list/join");
    static final Identifier MOVE_UP_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"server_list/move_up_highlighted");
    static final Identifier MOVE_UP_SPRITE = Identifier.withDefaultNamespace((String)"server_list/move_up");
    static final Identifier MOVE_DOWN_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"server_list/move_down_highlighted");
    static final Identifier MOVE_DOWN_SPRITE = Identifier.withDefaultNamespace((String)"server_list/move_down");
    ...
    public void updateNetworkServers(List<LanServer> list) {
        ...
        for (int j = this.networkServers.size() - i; j < this.networkServers.size(); ++j) {
            ...
            this.minecraft.getNarrator().saySystemQueued((Component)Component.translatable((String)"multiplayer.lan.server_found", (Object[])new Object[]{networkServerEntry.getServerNarration()}));
        }
    }
    ...
    implements SelectableEntry {
        ...
        public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
            ...
            List<FormattedCharSequence> list = this.minecraft.font.split((FormattedText)this.serverData.motd, this.getContentWidth() - 32 - 2);
        ...
        public Component getNarration() {
            ...
            mutableComponent.append((Component)Component.translatable((String)"narrator.select", (Object[])new Object[]{this.serverData.name}));
            mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
            switch (this.serverData.state()) {
                case INCOMPATIBLE: {
                    mutableComponent.append(INCOMPATIBLE_STATUS);
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append((Component)Component.translatable((String)"multiplayer.status.version.narration", (Object[])new Object[]{this.serverData.version}));
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append((Component)Component.translatable((String)"multiplayer.status.motd.narration", (Object[])new Object[]{this.serverData.motd}));
                    break;
                }
                case UNREACHABLE: {
                ...
                default: {
                    ...
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append((Component)Component.translatable((String)"multiplayer.status.ping.narration", (Object[])new Object[]{this.serverData.ping}));
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append((Component)Component.translatable((String)"multiplayer.status.motd.narration", (Object[])new Object[]{this.serverData.motd}));
                    if (this.serverData.players == null) break;
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append((Component)Component.translatable((String)"multiplayer.status.player_count.narration", (Object[])new Object[]{this.serverData.players.online(), this.serverData.players.max()}));
                    mutableComponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutableComponent.append(ComponentUtils.formatList(this.serverData.playerList, (Component)Component.literal((String)", ")));
                }
            }
