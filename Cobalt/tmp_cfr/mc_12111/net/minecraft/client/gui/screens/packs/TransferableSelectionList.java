...
extends ObjectSelectionList<Entry> {
    static final Identifier SELECT_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/select_highlighted");
    static final Identifier SELECT_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/select");
    static final Identifier UNSELECT_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/unselect_highlighted");
    static final Identifier UNSELECT_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/unselect");
    static final Identifier MOVE_UP_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_up_highlighted");
    static final Identifier MOVE_UP_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_up");
    static final Identifier MOVE_DOWN_HIGHLIGHTED_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_down_highlighted");
    static final Identifier MOVE_DOWN_SPRITE = Identifier.withDefaultNamespace((String)"transferable_list/move_down");
    static final Component INCOMPATIBLE_TITLE = Component.translatable((String)"pack.incompatible");
    static final Component INCOMPATIBLE_CONFIRM_TITLE = Component.translatable((String)"pack.incompatible.confirm.title");
    ...
    public void updateList(Stream<PackSelectionModel.Entry> stream, @Nullable PackSelectionModel.EntryBase entryBase) {
        this.clearEntries();
        MutableComponent component = Component.empty().append(this.title).withStyle(new ChatFormatting[]{ChatFormatting.UNDERLINE, ChatFormatting.BOLD});
        HeaderEntry headerEntry = new HeaderEntry(this, this.minecraft.font, (Component)component);
    ...
    implements SelectableEntry {
        ...
        public PackEntry(Minecraft minecraft, TransferableSelectionList transferableSelectionList2, PackSelectionModel.Entry entry) {
            ...
            this.descriptionWidget = new MultiLineTextWidget(ComponentUtils.mergeStyles((Component)entry.getExtendedDescription(), (Style)Style.EMPTY.withColor(-8355712)), minecraft.font);
