...
extends Screen {
    ...
    protected void init() {
        ...
        ReasonSelectionList.Entry entry = (ReasonSelectionList.Entry)Optionull.map((Object)((Object)this.currentlySelectedReason), this.reasonSelectionList::findEntry);
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        if (entry != null) {
            ...
            guiGraphics.drawWordWrap(this.font, (FormattedText)entry.reason.description(), k, m + (p - q) / 2, o, -1);
        }
    }
