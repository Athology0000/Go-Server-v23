...
extends Screen {
    ...
    static final Component EMPTY_SEARCH = Component.translatable((String)"gui.socialInteractions.search_empty").withStyle(ChatFormatting.GRAY);
    ...
    private void updateServerLabel(Minecraft minecraft) {
        ...
        if (this.playerCount != i) {
            ...
            this.serverLabel = i > 1 ? Component.translatable((String)"gui.socialInteractions.server_label.multiple", (Object[])new Object[]{string, i}) : Component.translatable((String)"gui.socialInteractions.server_label.single", (Object[])new Object[]{string, i});
            this.playerCount = i;
        }
    }
