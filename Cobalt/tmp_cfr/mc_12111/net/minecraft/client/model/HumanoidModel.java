...
HeadedModel {
    ...
    public void setupAnim(T humanoidRenderState) {
        ...
        this.rightArm.xRot = Mth.cos((double)(g * 0.6662f + (float)Math.PI)) * 2.0f * h * 0.5f / ((HumanoidRenderState)humanoidRenderState).speedValue;
        this.leftArm.xRot = Mth.cos((double)(g * 0.6662f)) * 2.0f * h * 0.5f / ((HumanoidRenderState)humanoidRenderState).speedValue;
        this.rightLeg.xRot = Mth.cos((double)(g * 0.6662f)) * 1.4f * h / ((HumanoidRenderState)humanoidRenderState).speedValue;
        this.leftLeg.xRot = Mth.cos((double)(g * 0.6662f + (float)Math.PI)) * 1.4f * h / ((HumanoidRenderState)humanoidRenderState).speedValue;
        ...
        if (f > 0.0f) {
            ...
            if (!((HumanoidRenderState)humanoidRenderState).isUsingItem) {
                if (i < 14.0f) {
                    this.leftArm.xRot = Mth.rotLerpRad((float)k, (float)this.leftArm.xRot, (float)0.0f);
                    this.rightArm.xRot = Mth.lerp((float)j, (float)this.rightArm.xRot, (float)0.0f);
                    this.leftArm.yRot = Mth.rotLerpRad((float)k, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)j, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)k, (float)this.leftArm.zRot, (float)((float)Math.PI + 1.8707964f * this.quadraticArmUpdate(i) / this.quadraticArmUpdate(14.0f)));
                    this.rightArm.zRot = Mth.lerp((float)j, (float)this.rightArm.zRot, (float)((float)Math.PI - 1.8707964f * this.quadraticArmUpdate(i) / this.quadraticArmUpdate(14.0f)));
                } else if (i >= 14.0f && i < 22.0f) {
                    l = (i - 14.0f) / 8.0f;
                    this.leftArm.xRot = Mth.rotLerpRad((float)k, (float)this.leftArm.xRot, (float)(1.5707964f * l));
                    this.rightArm.xRot = Mth.lerp((float)j, (float)this.rightArm.xRot, (float)(1.5707964f * l));
                    this.leftArm.yRot = Mth.rotLerpRad((float)k, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)j, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)k, (float)this.leftArm.zRot, (float)(5.012389f - 1.8707964f * l));
                    this.rightArm.zRot = Mth.lerp((float)j, (float)this.rightArm.zRot, (float)(1.2707963f + 1.8707964f * l));
                } else if (i >= 22.0f && i < 26.0f) {
                    l = (i - 22.0f) / 4.0f;
                    this.leftArm.xRot = Mth.rotLerpRad((float)k, (float)this.leftArm.xRot, (float)(1.5707964f - 1.5707964f * l));
                    this.rightArm.xRot = Mth.lerp((float)j, (float)this.rightArm.xRot, (float)(1.5707964f - 1.5707964f * l));
                    this.leftArm.yRot = Mth.rotLerpRad((float)k, (float)this.leftArm.yRot, (float)((float)Math.PI));
                    this.rightArm.yRot = Mth.lerp((float)j, (float)this.rightArm.yRot, (float)((float)Math.PI));
                    this.leftArm.zRot = Mth.rotLerpRad((float)k, (float)this.leftArm.zRot, (float)((float)Math.PI));
                    this.rightArm.zRot = Mth.lerp((float)j, (float)this.rightArm.zRot, (float)((float)Math.PI));
                }
            }
            l = 0.3f;
            float m = 0.33333334f;
            this.leftLeg.xRot = Mth.lerp((float)f, (float)this.leftLeg.xRot, (float)(0.3f * Mth.cos((double)(g * 0.33333334f + (float)Math.PI))));
            this.rightLeg.xRot = Mth.lerp((float)f, (float)this.rightLeg.xRot, (float)(0.3f * Mth.cos((double)(g * 0.33333334f))));
        }
    }
    ...
    private void poseRightArm(T humanoidRenderState) {
        switch (((HumanoidRenderState)humanoidRenderState).rightArmPose.ordinal()) {
            ...
            case 7: {
                this.rightArm.xRot = Mth.clamp((float)(this.head.xRot - 1.9198622f - (((HumanoidRenderState)humanoidRenderState).isCrouching ? 0.2617994f : 0.0f)), (float)-2.4f, (float)3.3f);
    ...
    private void poseLeftArm(T humanoidRenderState) {
        switch (((HumanoidRenderState)humanoidRenderState).leftArmPose.ordinal()) {
            ...
            case 7: {
                this.leftArm.xRot = Mth.clamp((float)(this.head.xRot - 1.9198622f - (((HumanoidRenderState)humanoidRenderState).isCrouching ? 0.2617994f : 0.0f)), (float)-2.4f, (float)3.3f);
    ...
    private void poseBlockingArm(ModelPart modelPart, boolean bl) {
        modelPart.xRot = modelPart.xRot * 0.5f - 0.9424779f + Mth.clamp((float)this.head.xRot, (float)-1.3962634f, (float)0.43633232f);
        modelPart.yRot = (bl ? -30.0f : 30.0f) * ((float)Math.PI / 180) + Mth.clamp((float)this.head.yRot, (float)-0.5235988f, (float)0.5235988f);
    }
    ...
    protected void setupAttackAnimation(T humanoidRenderState) {
        ...
        this.body.yRot = Mth.sin((double)(Mth.sqrt((float)f) * ((float)Math.PI * 2))) * 0.2f;
        ...
        this.rightArm.z = Mth.sin((double)this.body.yRot) * 5.0f * g;
        this.rightArm.x = -Mth.cos((double)this.body.yRot) * 5.0f * g;
        this.leftArm.z = -Mth.sin((double)this.body.yRot) * 5.0f * g;
        this.leftArm.x = Mth.cos((double)this.body.yRot) * 5.0f * g;
        this.rightArm.yRot += this.body.yRot;
        this.leftArm.yRot += this.body.yRot;
        this.leftArm.xRot += this.body.yRot;
        switch (((HumanoidRenderState)humanoidRenderState).swingAnimationType) {
            case WHACK: {
                float h = Ease.outQuart((float)f);
                float i = Mth.sin((double)(h * (float)Math.PI));
                float j = Mth.sin((double)(f * (float)Math.PI)) * -(this.head.xRot - 0.7f) * 0.75f;
                ModelPart modelPart = this.getArm(((HumanoidRenderState)humanoidRenderState).attackArm);
                modelPart.xRot -= i * 1.2f + j;
                modelPart.yRot += this.body.yRot * 2.0f;
                modelPart.zRot += Mth.sin((double)(f * (float)Math.PI)) * -0.4f;
                break;
            }
            case NONE: {
                break;
