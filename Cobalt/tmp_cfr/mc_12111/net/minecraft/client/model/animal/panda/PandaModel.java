...
extends QuadrupedModel<PandaRenderState> {
    ...
    public void setupAnim(PandaRenderState pandaRenderState) {
        ...
        if (pandaRenderState.isUnhappy) {
            this.head.yRot = 0.35f * Mth.sin((double)(0.6f * pandaRenderState.ageInTicks));
            this.head.zRot = 0.35f * Mth.sin((double)(0.6f * pandaRenderState.ageInTicks));
            this.rightFrontLeg.xRot = -0.75f * Mth.sin((double)(0.3f * pandaRenderState.ageInTicks));
            this.leftFrontLeg.xRot = 0.75f * Mth.sin((double)(0.3f * pandaRenderState.ageInTicks));
        } else {
            this.head.zRot = 0.0f;
        }
        ...
        if (pandaRenderState.sitAmount > 0.0f) {
            this.body.xRot = Mth.rotLerpRad((float)pandaRenderState.sitAmount, (float)this.body.xRot, (float)1.7407963f);
            this.head.xRot = Mth.rotLerpRad((float)pandaRenderState.sitAmount, (float)this.head.xRot, (float)1.5707964f);
            ...
            if (pandaRenderState.isEating) {
                this.head.xRot = 1.5707964f + 0.2f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.6f));
                this.rightFrontLeg.xRot = -0.4f - 0.2f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.6f));
                this.leftFrontLeg.xRot = -0.4f - 0.2f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.6f));
            }
        ...
        if (pandaRenderState.lieOnBackAmount > 0.0f) {
            this.rightHindLeg.xRot = -0.6f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.15f));
            this.leftHindLeg.xRot = 0.6f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.15f));
            this.rightFrontLeg.xRot = 0.3f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.25f));
            this.leftFrontLeg.xRot = -0.3f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.25f));
            this.head.xRot = Mth.rotLerpRad((float)pandaRenderState.lieOnBackAmount, (float)this.head.xRot, (float)1.5707964f);
        }
        if (pandaRenderState.rollAmount > 0.0f) {
            this.head.xRot = Mth.rotLerpRad((float)pandaRenderState.rollAmount, (float)this.head.xRot, (float)2.0561945f);
            this.rightHindLeg.xRot = -0.5f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.5f));
            this.leftHindLeg.xRot = 0.5f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.5f));
            this.rightFrontLeg.xRot = 0.5f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.5f));
            this.leftFrontLeg.xRot = -0.5f * Mth.sin((double)(pandaRenderState.ageInTicks * 0.5f));
        }
    }
}
