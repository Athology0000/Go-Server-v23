...
extends EntityModel<ParrotRenderState> {
    ...
    public void setupAnim(ParrotRenderState parrotRenderState) {
        ...
        switch (parrotRenderState.pose.ordinal()) {
            ...
            case 3: {
                float f = Mth.cos((double)parrotRenderState.ageInTicks);
                float g = Mth.sin((double)parrotRenderState.ageInTicks);
                this.head.x += f;
                this.head.y += g;
                this.head.xRot = 0.0f;
                this.head.yRot = 0.0f;
                this.head.zRot = Mth.sin((double)parrotRenderState.ageInTicks) * 0.4f;
                this.body.x += f;
                this.body.y += g;
            ...
            case 1: {
                this.leftLeg.xRot += Mth.cos((double)(parrotRenderState.walkAnimationPos * 0.6662f)) * 1.4f * parrotRenderState.walkAnimationSpeed;
                this.rightLeg.xRot += Mth.cos((double)(parrotRenderState.walkAnimationPos * 0.6662f + (float)Math.PI)) * 1.4f * parrotRenderState.walkAnimationSpeed;
            }
            default: {
                float h = parrotRenderState.flapAngle * 0.3f;
                this.head.y += h;
                this.tail.xRot += Mth.cos((double)(parrotRenderState.walkAnimationPos * 0.6662f)) * 0.3f * parrotRenderState.walkAnimationSpeed;
                this.tail.y += h;
                this.body.y += h;
                this.leftWing.zRot = -0.0873f - parrotRenderState.flapAngle;
                this.leftWing.y += h;
