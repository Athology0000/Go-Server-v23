...
extends EntityModel<StriderRenderState> {
    ...
    public void setupAnim(StriderRenderState striderRenderState) {
        ...
        float h = 1.5f;
        this.body.zRot = 0.1f * Mth.sin((double)(f * 1.5f)) * 4.0f * g;
        this.body.y = 2.0f;
        this.body.y -= 2.0f * Mth.cos((double)(f * 1.5f)) * 2.0f * g;
        this.leftLeg.xRot = Mth.sin((double)(f * 1.5f * 0.5f)) * 2.0f * g;
        this.rightLeg.xRot = Mth.sin((double)(f * 1.5f * 0.5f + (float)Math.PI)) * 2.0f * g;
        this.leftLeg.zRot = 0.17453292f * Mth.cos((double)(f * 1.5f * 0.5f)) * g;
        this.rightLeg.zRot = 0.17453292f * Mth.cos((double)(f * 1.5f * 0.5f + (float)Math.PI)) * g;
        this.leftLeg.y = 8.0f + 2.0f * Mth.sin((double)(f * 1.5f * 0.5f + (float)Math.PI)) * 2.0f * g;
        this.rightLeg.y = 8.0f + 2.0f * Mth.sin((double)(f * 1.5f * 0.5f)) * 2.0f * g;
        ...
        float i = Mth.cos((double)(f * 1.5f + (float)Math.PI)) * g;
        ...
        float j = 1.0f;
        float k = 1.0f;
        this.rightBottomBristle.zRot += 0.05f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * -0.4f));
        this.rightMiddleBristle.zRot += 0.1f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * 0.2f));
        this.rightTopBristle.zRot += 0.1f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * 0.4f));
        this.leftTopBristle.zRot += 0.1f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * 0.4f));
        this.leftMiddleBristle.zRot += 0.1f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * 0.2f));
        this.leftBottomBristle.zRot += 0.05f * Mth.sin((double)(striderRenderState.ageInTicks * 1.0f * -0.4f));
    }
}
