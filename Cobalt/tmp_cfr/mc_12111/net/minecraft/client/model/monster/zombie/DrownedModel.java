...
extends ZombieModel<ZombieRenderState> {
    ...
    public void setupAnim(ZombieRenderState zombieRenderState) {
        ...
        if ((f = zombieRenderState.swimAmount) > 0.0f) {
            this.rightArm.xRot = Mth.rotLerpRad((float)f, (float)this.rightArm.xRot, (float)-2.5132742f) + f * 0.35f * Mth.sin((double)(0.1f * zombieRenderState.ageInTicks));
            this.leftArm.xRot = Mth.rotLerpRad((float)f, (float)this.leftArm.xRot, (float)-2.5132742f) - f * 0.35f * Mth.sin((double)(0.1f * zombieRenderState.ageInTicks));
            this.rightArm.zRot = Mth.rotLerpRad((float)f, (float)this.rightArm.zRot, (float)-0.15f);
            this.leftArm.zRot = Mth.rotLerpRad((float)f, (float)this.leftArm.zRot, (float)0.15f);
            this.leftLeg.xRot -= f * 0.55f * Mth.sin((double)(0.1f * zombieRenderState.ageInTicks));
            this.rightLeg.xRot += f * 0.55f * Mth.sin((double)(0.1f * zombieRenderState.ageInTicks));
            this.head.xRot = 0.0f;
        }
    }
}
