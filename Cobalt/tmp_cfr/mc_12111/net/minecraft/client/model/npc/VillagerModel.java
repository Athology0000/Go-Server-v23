...
VillagerLikeModel<VillagerRenderState> {
    ...
    public void setupAnim(VillagerRenderState villagerRenderState) {
        ...
        if (villagerRenderState.isUnhappy) {
            this.head.zRot = 0.3f * Mth.sin((double)(0.45f * villagerRenderState.ageInTicks));
            this.head.xRot = 0.4f;
        } else {
            this.head.zRot = 0.0f;
        }
        this.rightLeg.xRot = Mth.cos((double)(villagerRenderState.walkAnimationPos * 0.6662f)) * 1.4f * villagerRenderState.walkAnimationSpeed * 0.5f;
        this.leftLeg.xRot = Mth.cos((double)(villagerRenderState.walkAnimationPos * 0.6662f + (float)Math.PI)) * 1.4f * villagerRenderState.walkAnimationSpeed * 0.5f;
