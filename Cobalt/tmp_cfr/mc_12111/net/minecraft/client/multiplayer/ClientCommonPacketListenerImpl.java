...
implements ClientCommonPacketListener {
    ...
    public void onPacketError(Packet packet, Exception exception) {
        ...
        this.connection.disconnect(new DisconnectionDetails((Component)Component.translatable((String)"disconnect.packetError"), optional, optional2));
    }
    ...
    private Optional<Path> storeDisconnectionReport(@Nullable Packet packet, Throwable throwable) {
        CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"Packet handling error");
        PacketUtils.fillCrashReport((CrashReport)crashReport, (PacketListener)this, (Packet)packet);
        ...
        Optional optional = this.serverLinks.findKnownType(ServerLinks.KnownLinkType.BUG_REPORT);
        List list = optional.map(entry -> List.of("Server bug reporting link: " + String.valueOf(entry.link()))).orElse(List.of());
    ...
    public void handleKeepAlive(ClientboundKeepAlivePacket clientboundKeepAlivePacket) {
        this.sendWhen((Packet<? extends ServerboundPacketListener>)new ServerboundKeepAlivePacket(clientboundKeepAlivePacket.getId()), () -> !RenderSystem.isFrozenAtPollEvents(), Duration.ofMinutes(1L));
    }

    public void handlePing(ClientboundPingPacket clientboundPingPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundPingPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
    ...
    public void handleCustomPayload(ClientboundCustomPayloadPacket clientboundCustomPayloadPacket) {
        ...
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundCustomPayloadPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
    ...
    public void handleResourcePackPush(ClientboundResourcePackPushPacket clientboundResourcePackPushPacket) {
        ...
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundResourcePackPushPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        ...
        if (uRL == null) {
            this.connection.send((Packet)new ServerboundResourcePackPacket(uUID, ServerboundResourcePackPacket.Action.INVALID_URL));
            return;
        }
    ...
    public void handleResourcePackPop(ClientboundResourcePackPopPacket clientboundResourcePackPopPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundResourcePackPopPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
    ...
    public void handleRequestCookie(ClientboundCookieRequestPacket clientboundCookieRequestPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundCookieRequestPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        this.connection.send((Packet)new ServerboundCookieResponsePacket(clientboundCookieRequestPacket.key(), this.serverCookies.get(clientboundCookieRequestPacket.key())));
    }

    public void handleStoreCookie(ClientboundStoreCookiePacket clientboundStoreCookiePacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundStoreCookiePacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
    ...
    public void handleCustomReportDetails(ClientboundCustomReportDetailsPacket clientboundCustomReportDetailsPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundCustomReportDetailsPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
    ...
    public void handleServerLinks(ClientboundServerLinksPacket clientboundServerLinksPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundServerLinksPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        List list = clientboundServerLinksPacket.links();
        ...
        for (ServerLinks.UntrustedEntry untrustedEntry : list) {
            try {
                URI uRI = Util.parseAndValidateUntrustedUri((String)untrustedEntry.link());
    ...
    public void handleShowDialog(ClientboundShowDialogPacket clientboundShowDialogPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundShowDialogPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        this.showDialog((Holder<Dialog>)clientboundShowDialogPacket.dialog(), this.minecraft.screen);
    }
    ...
    protected void showDialog(Holder<Dialog> holder, DialogConnectionAccess dialogConnectionAccess, @Nullable Screen screen) {
        ...
        if (screen instanceof DialogScreen.WarningScreen) {
            ...
            dialogScreen = DialogScreens.createFromData((Dialog)holder.value(), screen3, dialogConnectionAccess);
        ...
        DialogScreen<Dialog> screen2 = DialogScreens.createFromData((Dialog)holder.value(), screen4, dialogConnectionAccess);
        if (screen2 != null) {
    ...
    public void handleClearDialog(ClientboundClearDialogPacket clientboundClearDialogPacket) {
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundClearDialogPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        this.clearDialog();
    }
    ...
    public void handleTransfer(ClientboundTransferPacket clientboundTransferPacket) {
        ...
        PacketUtils.ensureRunningOnSameThread((Packet)clientboundTransferPacket, (PacketListener)this, (PacketProcessor)this.minecraft.packetProcessor());
        ...
        ConnectScreen.startConnecting(Objects.requireNonNullElseGet(this.postDisconnectScreen, TitleScreen::new), this.minecraft, serverAddress, this.serverData, false, new TransferState(this.serverCookies, this.seenPlayers, this.seenInsecureChatWarning));
    }
    ...
    public void fillListenerSpecificCrashDetails(CrashReport crashReport, CrashReportCategory crashReportCategory) {
        ...
        if (!this.customReportDetails.isEmpty()) {
            ...
            this.customReportDetails.forEach((arg_0, arg_1) -> ((CrashReportCategory)crashReportCategory2).setDetail(arg_0, arg_1));
        }
    }

    protected Screen createDisconnectScreen(DisconnectionDetails disconnectionDetails) {
        Screen screen = Objects.requireNonNullElseGet(this.postDisconnectScreen, () -> this.serverData != null ? new JoinMultiplayerScreen(new TitleScreen()) : new TitleScreen());
        ...
        PackConfirmScreen(@Nullable Minecraft minecraft, Screen screen, List<PendingRequest> list, @Nullable boolean bl, Component component) {
            super(bl2 -> {
                ...
                if (bl2) {
                    ...
                    if (bl) {
                        clientCommonPacketListenerImpl.connection.disconnect((Component)Component.translatable((String)"multiplayer.requiredTexturePrompt.disconnect"));
            ...
            }, (Component)(bl ? Component.translatable((String)"multiplayer.requiredTexturePrompt.line1") : Component.translatable((String)"multiplayer.texturePrompt.line1")), ClientCommonPacketListenerImpl.preparePackPrompt((Component)(bl ? Component.translatable((String)"multiplayer.requiredTexturePrompt.line2").withStyle(new ChatFormatting[]{ChatFormatting.YELLOW, ChatFormatting.BOLD}) : Component.translatable((String)"multiplayer.texturePrompt.line2")), component), bl ? CommonComponents.GUI_PROCEED : CommonComponents.GUI_YES, bl ? CommonComponents.GUI_DISCONNECT : CommonComponents.GUI_NO);
            this.requests = list;
    ...
    implements DialogConnectionAccess {
        ...
        public void sendCustomAction(Identifier identifier, Optional<Tag> optional) {
            ClientCommonPacketListenerImpl.this.send((Packet<?>)new ServerboundCustomClickActionPacket(identifier, optional));
        }
