...
public final class ReportingContext {
    ...
    public void draftReportHandled(Minecraft minecraft, Screen screen, Runnable runnable, boolean bl2) {
        if (this.draftReport != null) {
            ...
            }, (Component)Component.translatable((String)(bl2 ? "gui.abuseReport.draft.quittotitle.title" : "gui.abuseReport.draft.title")), (Component)Component.translatable((String)(bl2 ? "gui.abuseReport.draft.quittotitle.content" : "gui.abuseReport.draft.content")), (Component)Component.translatable((String)"gui.abuseReport.draft.edit"), (Component)Component.translatable((String)"gui.abuseReport.draft.discard")));
        } else {
            runnable.run();
        }
    }
