...
extends SingleQuadParticle {
    ...
    protected BreakingItemParticle(ClientLevel clientLevel, double d, double e, double f, TextureAtlasSprite textureAtlasSprite) {
        ...
        this.layer = textureAtlasSprite.atlasLocation().equals((Object)TextureAtlas.LOCATION_BLOCKS) ? SingleQuadParticle.Layer.TERRAIN : SingleQuadParticle.Layer.ITEMS;
    }
    ...
    extends ItemParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            return new BreakingItemParticle(clientLevel, d, e, f, this.getSprite(new ItemStack((ItemLike)Items.SNOWBALL), clientLevel, randomSource));
        }
    }
    ...
    extends ItemParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            return new BreakingItemParticle(clientLevel, d, e, f, this.getSprite(new ItemStack((ItemLike)Items.COBWEB), clientLevel, randomSource));
        }
    }
    ...
    extends ItemParticleProvider<SimpleParticleType> {
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            return new BreakingItemParticle(clientLevel, d, e, f, this.getSprite(new ItemStack((ItemLike)Items.SLIME_BALL), clientLevel, randomSource));
        }
    }
