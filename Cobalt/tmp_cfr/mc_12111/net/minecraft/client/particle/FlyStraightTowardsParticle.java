...
extends SingleQuadParticle {
    ...
    public void tick() {
        ...
        int i = ARGB.srgbLerp((float)f, (int)this.startColor, (int)this.endColor);
        this.setColor((float)ARGB.red((int)i) / 255.0f, (float)ARGB.green((int)i) / 255.0f, (float)ARGB.blue((int)i) / 255.0f);
        this.setAlpha((float)ARGB.alpha((int)i) / 255.0f);
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            ...
            flyStraightTowardsParticle.scale(Mth.randomBetween((RandomSource)clientLevel.getRandom(), (float)3.0f, (float)5.0f));
