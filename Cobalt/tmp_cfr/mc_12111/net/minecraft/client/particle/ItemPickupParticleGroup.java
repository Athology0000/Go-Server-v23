...
extends ParticleGroup<ItemPickupParticle> {
    ...
    extends Record {
        ...
        public static ParticleInstance fromParticle(ItemPickupParticle itemPickupParticle, Camera camera, float f) {
            ...
            g *= g;
            double d = Mth.lerp((double)f, (double)itemPickupParticle.targetXOld, (double)itemPickupParticle.targetX);
            double e = Mth.lerp((double)f, (double)itemPickupParticle.targetYOld, (double)itemPickupParticle.targetY);
            double h = Mth.lerp((double)f, (double)itemPickupParticle.targetZOld, (double)itemPickupParticle.targetZ);
            double i = Mth.lerp((double)g, (double)itemPickupParticle.itemRenderState.x, (double)d);
            double j = Mth.lerp((double)g, (double)itemPickupParticle.itemRenderState.y, (double)e);
            double k = Mth.lerp((double)g, (double)itemPickupParticle.itemRenderState.z, (double)h);
