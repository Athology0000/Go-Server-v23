...
extends Particle {
    ...
    public void extract(QuadParticleRenderState quadParticleRenderState, Camera camera, float f) {
        ...
        if (this.roll != 0.0f) {
            quaternionf.rotateZ(Mth.lerp((float)f, (float)this.oRoll, (float)this.roll));
        }
    ...
    protected void extractRotatedQuad(QuadParticleRenderState quadParticleRenderState, Camera camera, Quaternionf quaternionf, float f) {
        ...
        float h = (float)(Mth.lerp((double)f, (double)this.yo, (double)this.y) - vec3.y());
    ...
    protected void extractRotatedQuad(QuadParticleRenderState quadParticleRenderState, Quaternionf quaternionf, float f, float g, float h, float i) {
        quadParticleRenderState.add(this.getLayer(), f, g, h, quaternionf.x, quaternionf.y, quaternionf.z, quaternionf.w, this.getQuadSize(i), this.getU0(), this.getU1(), this.getV0(), this.getV1(), ARGB.colorFromFloat((float)this.alpha, (float)this.rCol, (float)this.gCol, (float)this.bCol), this.getLightColor(i));
    }
