...
extends SingleQuadParticle {
    ...
    public TerrainParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, BlockState blockState) {
        this(clientLevel, d, e, f, g, h, i, blockState, BlockPos.containing((double)d, (double)e, (double)f));
    }
    ...
    public TerrainParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, BlockState blockState, BlockPos blockPos) {
        ...
        if (!blockState.is(Blocks.GRASS_BLOCK)) {
            int j = Minecraft.getInstance().getBlockColors().getColor(blockState, (BlockAndTintGetter)clientLevel, blockPos, 0);
        ...
        this.layer = this.sprite.atlasLocation().equals((Object)TextureAtlas.LOCATION_BLOCKS) ? SingleQuadParticle.Layer.TERRAIN : SingleQuadParticle.Layer.ITEMS;
    }
    ...
    public int getLightColor(float f) {
        ...
        if (i == 0 && this.level.hasChunkAt(this.pos)) {
            return LevelRenderer.getLightColor((BlockAndTintGetter)this.level, this.pos);
        }
        return i;
    }
