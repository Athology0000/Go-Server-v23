...
public class QuickPlay {
    ...
    private static @Nullable String getLatestSingleplayerWorld(LevelStorageSource levelStorageSource) {
        try {
            List list = (List)levelStorageSource.loadLevelSummaries(levelStorageSource.findLevelCandidates()).get();
            if (list.isEmpty()) {
    ...
    private static void joinSingleplayerWorld(Minecraft minecraft, @Nullable String string) {
        if (StringUtil.isBlank((String)string) || !minecraft.getLevelSource().levelExists(string)) {
