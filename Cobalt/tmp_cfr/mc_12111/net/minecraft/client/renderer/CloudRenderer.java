...
implements AutoCloseable {
    ...
    public void render(int i, CloudStatus cloudStatus, float f, Vec3 vec3, long l, float g) {
        ...
        int k = Mth.ceil((float)((float)j / 12.0f));
        ...
        d -= (double)Mth.floor((double)(d / p)) * p;
        e -= (double)Mth.floor((double)(e / q)) * q;
        int r = Mth.floor((double)(d / 12.0));
        int s = Mth.floor((double)(e / 12.0));
        ...
        try {
            Std140Builder.intoBuffer(mappedView.data()).putVec4((Vector4fc)ARGB.vector4fFromARGB32((int)i)).putVec3(-t, h, -u).putVec3(12.0f, 4.0f, 12.0f);
        }
        finally {
            if (mappedView != null) {
                mappedView.close();
