...
public class ItemBlockRenderTypes {
    private static final Map<Block, ChunkSectionLayer> TYPE_BY_BLOCK = (Map)Util.make((Object)Maps.newHashMap(), hashMap -> {
    ...
    private static final Map<Fluid, ChunkSectionLayer> LAYER_BY_FLUID = (Map)Util.make((Object)Maps.newHashMap(), hashMap -> {
