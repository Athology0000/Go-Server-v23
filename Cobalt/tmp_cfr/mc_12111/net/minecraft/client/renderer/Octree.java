...
public class Octree {
    ...
    public Octree(SectionPos sectionPos, int i, int j, int k) {
        int l = i * 2 + 1;
        int m = Mth.smallestEncompassingPowerOfTwo((int)l);
        int n = i * 16;
    ...
    implements Node {
        ...
        public boolean add(SectionRenderDispatcher.RenderSection renderSection) {
            ...
            boolean bl = SectionPos.sectionToBlockCoord((int)SectionPos.x((long)l)) - this.bbCenterX < 0;
            boolean bl2 = SectionPos.sectionToBlockCoord((int)SectionPos.y((long)l)) - this.bbCenterY < 0;
            boolean bl3 = SectionPos.sectionToBlockCoord((int)SectionPos.z((long)l)) - this.bbCenterZ < 0;
