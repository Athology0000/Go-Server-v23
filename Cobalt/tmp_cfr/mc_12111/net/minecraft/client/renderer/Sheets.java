...
public class Sheets {
    ...
    public static final Identifier BED_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/beds.png");
    ...
    public static final Identifier SIGN_SHEET = Identifier.withDefaultNamespace((String)"textures/atlas/signs.png");
    ...
    public static Identifier colorToResourceMaterial(DyeColor dyeColor) {
        return Identifier.withDefaultNamespace((String)dyeColor.getName());
    }
    ...
    public static Identifier colorToShulkerMaterial(DyeColor dyeColor) {
        return Identifier.withDefaultNamespace((String)("shulker_" + dyeColor.getName()));
    }
    ...
    public static Material getBannerMaterial(Holder<BannerPattern> holder) {
        return BANNER_MATERIALS.computeIfAbsent(((BannerPattern)holder.value()).assetId(), BANNER_MAPPER::apply);
    }

    public static Material getShieldMaterial(Holder<BannerPattern> holder) {
        return SHIELD_MATERIALS.computeIfAbsent(((BannerPattern)holder.value()).assetId(), SHIELD_MAPPER::apply);
    }
