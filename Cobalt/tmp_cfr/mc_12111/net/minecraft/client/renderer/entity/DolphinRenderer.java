...
extends AgeableMobRenderer<Dolphin, DolphinRenderState, DolphinModel> {
    private static final Identifier DOLPHIN_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/dolphin.png");
    ...
    public void extractRenderState(Dolphin dolphin, DolphinRenderState dolphinRenderState, float f) {
        ...
        HoldingEntityRenderState.extractHoldingEntityRenderState((LivingEntity)dolphin, dolphinRenderState, this.itemModelResolver);
