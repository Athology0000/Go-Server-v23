...
extends MobRenderer<Guardian, GuardianRenderState, GuardianModel> {
    private static final Identifier GUARDIAN_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/guardian.png");
    private static final Identifier GUARDIAN_BEAM_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/guardian_beam.png");
    ...
    public boolean shouldRender(Guardian guardian, Frustum frustum, double d, double e, double f) {
        ...
        if (guardian.hasActiveAttackTarget() && (livingEntity = guardian.getActiveAttackTarget()) != null) {
            ...
            Vec3 vec32 = this.getPosition((LivingEntity)guardian, guardian.getEyeHeight(), 1.0f);
    ...
    private Vec3 getPosition(LivingEntity livingEntity, double d, float f) {
        double e = Mth.lerp((double)f, (double)livingEntity.xOld, (double)livingEntity.getX());
        double g = Mth.lerp((double)f, (double)livingEntity.yOld, (double)livingEntity.getY()) + d;
        double h = Mth.lerp((double)f, (double)livingEntity.zOld, (double)livingEntity.getZ());
    ...
    private static void renderBeam(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, Vec3 vec3, float f, float g, float h) {
        ...
        float q = 0.2f;
        float r = 0.282f;
        float s = Mth.cos((double)(l + 2.3561945f)) * 0.282f;
        float t = Mth.sin((double)(l + 2.3561945f)) * 0.282f;
        float u = Mth.cos((double)(l + 0.7853982f)) * 0.282f;
        float v = Mth.sin((double)(l + 0.7853982f)) * 0.282f;
        float w = Mth.cos((double)(l + 3.926991f)) * 0.282f;
        float x = Mth.sin((double)(l + 3.926991f)) * 0.282f;
        float y = Mth.cos((double)(l + 5.4977875f)) * 0.282f;
        float z = Mth.sin((double)(l + 5.4977875f)) * 0.282f;
        float aa = Mth.cos((double)(l + (float)Math.PI)) * 0.2f;
        float ab = Mth.sin((double)(l + (float)Math.PI)) * 0.2f;
        float ac = Mth.cos((double)(l + 0.0f)) * 0.2f;
        float ad = Mth.sin((double)(l + 0.0f)) * 0.2f;
        float ae = Mth.cos((double)(l + 1.5707964f)) * 0.2f;
        float af = Mth.sin((double)(l + 1.5707964f)) * 0.2f;
        float ag = Mth.cos((double)(l + 4.712389f)) * 0.2f;
        float ah = Mth.sin((double)(l + 4.712389f)) * 0.2f;
        float ai = i;
        float aj = 0.0f;
        float ak = 0.4999f;
        float al = -1.0f + h;
        ...
        submitNodeCollector.submitCustomGeometry(poseStack, BEAM_RENDER_TYPE, (pose, vertexConsumer) -> {
            ...
            float ac = Mth.floor((float)f) % 2 == 0 ? 0.5f : 0.0f;
