...
extends AgeableMobRenderer<Rabbit, RabbitRenderState, RabbitModel> {
    private static final Identifier RABBIT_BROWN_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/brown.png");
    private static final Identifier RABBIT_WHITE_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/white.png");
    private static final Identifier RABBIT_BLACK_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/black.png");
    private static final Identifier RABBIT_GOLD_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/gold.png");
    private static final Identifier RABBIT_SALT_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/salt.png");
    private static final Identifier RABBIT_WHITE_SPLOTCHED_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/white_splotched.png");
    private static final Identifier RABBIT_TOAST_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/toast.png");
    private static final Identifier RABBIT_EVIL_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/rabbit/caerbannog.png");
    ...
    public void extractRenderState(Rabbit rabbit, RabbitRenderState rabbitRenderState, float f) {
        ...
        rabbitRenderState.isToast = RabbitRenderer.checkMagicName((Entity)rabbit, "Toast");
