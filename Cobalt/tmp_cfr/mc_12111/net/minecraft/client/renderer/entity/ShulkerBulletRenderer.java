...
extends EntityRenderer<ShulkerBullet, ShulkerBulletRenderState> {
    ...
    public void submit(ShulkerBulletRenderState shulkerBulletRenderState, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState cameraRenderState) {
        ...
        poseStack.mulPose((Quaternionfc)Axis.YP.rotationDegrees(Mth.sin((double)(f * 0.1f)) * 180.0f));
        poseStack.mulPose((Quaternionfc)Axis.XP.rotationDegrees(Mth.cos((double)(f * 0.1f)) * 180.0f));
        poseStack.mulPose((Quaternionfc)Axis.ZP.rotationDegrees(Mth.sin((double)(f * 0.15f)) * 360.0f));
