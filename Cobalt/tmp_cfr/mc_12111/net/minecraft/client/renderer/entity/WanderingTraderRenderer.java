...
extends MobRenderer<WanderingTrader, VillagerRenderState, VillagerModel> {
    private static final Identifier VILLAGER_BASE_SKIN = Identifier.withDefaultNamespace((String)"textures/entity/wandering_trader.png");
    ...
    public void extractRenderState(WanderingTrader wanderingTrader, VillagerRenderState villagerRenderState, float f) {
        ...
        HoldingEntityRenderState.extractHoldingEntityRenderState((LivingEntity)wanderingTrader, villagerRenderState, this.itemModelResolver);
