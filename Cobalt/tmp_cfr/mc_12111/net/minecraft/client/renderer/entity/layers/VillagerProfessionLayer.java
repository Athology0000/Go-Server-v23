...
extends RenderLayer<S, M> {
    private static final Int2ObjectMap<Identifier> LEVEL_LOCATIONS = (Int2ObjectMap)Util.make((Object)new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        int2ObjectOpenHashMap.put(1, (Object)Identifier.withDefaultNamespace((String)"stone"));
        int2ObjectOpenHashMap.put(2, (Object)Identifier.withDefaultNamespace((String)"iron"));
        int2ObjectOpenHashMap.put(3, (Object)Identifier.withDefaultNamespace((String)"gold"));
        int2ObjectOpenHashMap.put(4, (Object)Identifier.withDefaultNamespace((String)"emerald"));
        int2ObjectOpenHashMap.put(5, (Object)Identifier.withDefaultNamespace((String)"diamond"));
    });
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, S livingEntityRenderState, float f, float g) {
        ...
        Holder holder2 = villagerData.profession();
        ...
        if (!holder2.is(VillagerProfession.NONE) && !((LivingEntityRenderState)livingEntityRenderState).isBaby) {
            ...
            if (!holder2.is(VillagerProfession.NITWIT)) {
                Identifier identifier3 = this.getIdentifier("profession_level", (Identifier)LEVEL_LOCATIONS.get(Mth.clamp((int)villagerData.level(), (int)1, (int)LEVEL_LOCATIONS.size())));
    ...
    public <K> VillagerMetadataSection.Hat getHatData(Object2ObjectMap<ResourceKey<K>, VillagerMetadataSection.Hat> object2ObjectMap, String string, Holder<K> holder) {
        ...
        return (VillagerMetadataSection.Hat)((Object)object2ObjectMap.computeIfAbsent((Object)resourceKey, object -> this.resourceManager.getResource(this.getIdentifier(string, resourceKey.identifier())).flatMap(resource -> {
            try {
