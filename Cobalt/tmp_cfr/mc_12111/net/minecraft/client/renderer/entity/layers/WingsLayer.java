...
extends RenderLayer<S, M> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, S humanoidRenderState, float f, float g) {
        ...
        this.equipmentRenderer.renderLayers(EquipmentClientInfo.LayerType.WINGS, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().get()), elytraModel, humanoidRenderState, itemStack, poseStack, submitNodeCollector, i, identifier, ((HumanoidRenderState)humanoidRenderState).outlineColor, 0);
        poseStack.popPose();
    }
