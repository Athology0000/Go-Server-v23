...
public class EntityRenderState {
    ...
    public void fillCrashReportCategory(CrashReportCategory crashReportCategory) {
        crashReportCategory.setDetail("EntityRenderState", (Object)this.getClass().getCanonicalName());
        crashReportCategory.setDetail("Entity's Exact location", (Object)String.format(Locale.ROOT, "%.2f, %.2f, %.2f", this.x, this.y, this.z));
    }
