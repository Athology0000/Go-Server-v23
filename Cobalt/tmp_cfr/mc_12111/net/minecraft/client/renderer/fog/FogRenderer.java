...
implements AutoCloseable {
    ...
    private Vector4f computeFogColor(Camera camera, float f, ClientLevel clientLevel, int i, float g) {
        ...
        float k = Mth.clamp((float)((h + (float)clientLevel.getMinY() - (float)camera.position().y) / h), (float)0.0f, (float)1.0f);
        if (fogEnvironment2 != null) {
            LivingEntity livingEntity = (LivingEntity)entity;
            k = fogEnvironment2.getModifiedDarkness(livingEntity, k, f);
        }
        float l = ARGB.redFloat((int)j);
        float m = ARGB.greenFloat((int)j);
        float n = ARGB.blueFloat((int)j);
        if (k > 0.0f && fogType != FogType.LAVA && fogType != FogType.POWDER_SNOW) {
            o = Mth.square((float)(1.0f - k));
            l *= o;
            m *= o;
            n *= o;
        }
        if (g > 0.0f) {
            l = Mth.lerp((float)g, (float)l, (float)(l * 0.7f));
            m = Mth.lerp((float)g, (float)m, (float)(m * 0.6f));
            n = Mth.lerp((float)g, (float)n, (float)(n * 0.6f));
        }
        ...
        if (l != 0.0f && m != 0.0f && n != 0.0f) {
            ...
            l = Mth.lerp((float)o, (float)l, (float)(l * p));
            m = Mth.lerp((float)o, (float)m, (float)(m * p));
            n = Mth.lerp((float)o, (float)n, (float)(n * p));
        }
    ...
    public Vector4f setupFog(Camera camera, int i, DeltaTracker deltaTracker, float f, ClientLevel clientLevel) {
        ...
        float j = Mth.clamp((float)(h / 10.0f), (float)4.0f, (float)64.0f);
