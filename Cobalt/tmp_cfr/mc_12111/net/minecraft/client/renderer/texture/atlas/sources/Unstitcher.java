...
public record Unstitcher(Identifier resource, List<Region> regions, double xDivisor, double yDivisor) implements SpriteSource
{
    ...
    public void run(ResourceManager resourceManager, SpriteSource.Output output) {
        ...
        if (optional.isPresent()) {
            LazyLoadedImage lazyLoadedImage = new LazyLoadedImage(identifier, (Resource)optional.get(), this.regions.size());
    ...
    implements SpriteSource.DiscardableLoader {
        ...
        public SpriteContents get(SpriteResourceLoader spriteResourceLoader) {
            try {
                ...
                int i = Mth.floor((double)(this.region.x * d));
                int j = Mth.floor((double)(this.region.y * e));
                int k = Mth.floor((double)(this.region.width * d));
                int l = Mth.floor((double)(this.region.height * e));
