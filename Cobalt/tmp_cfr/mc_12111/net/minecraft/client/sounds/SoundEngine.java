...
public class SoundEngine {
    ...
    private final Object2FloatMap<SoundSource> gainBySource = (Object2FloatMap)Util.make((Object)new Object2FloatOpenHashMap(), object2FloatOpenHashMap -> object2FloatOpenHashMap.defaultReturnValue(1.0f));
    ...
    public void reload() {
        ...
        for (SoundEvent soundEvent : BuiltInRegistries.SOUND_EVENT) {
            ...
            LOGGER.warn("Missing sound for event: {}", (Object)BuiltInRegistries.SOUND_EVENT.getKey((Object)soundEvent));
    ...
    public void updateCategoryVolume(SoundSource soundSource, float f) {
        this.gainBySource.put((Object)soundSource, Mth.clamp((float)f, (float)0.0f, (float)1.0f));
    ...
    private float calculatePitch(SoundInstance soundInstance) {
        return Mth.clamp((float)soundInstance.getPitch(), (float)0.5f, (float)2.0f);
    }
    ...
    private float calculateVolume(float f, SoundSource soundSource) {
        return Mth.clamp((float)f, (float)0.0f, (float)1.0f) * Mth.clamp((float)this.options.getFinalSoundSourceVolume(soundSource), (float)0.0f, (float)1.0f) * this.gainBySource.getFloat((Object)soundSource);
    }
    ...
    public void pauseAllExcept(SoundSource ... soundSources) {
        ...
        for (Map.Entry<SoundInstance, ChannelAccess.ChannelHandle> entry : this.instanceToChannel.entrySet()) {
            if (List.of(soundSources).contains(entry.getKey().getSource())) continue;
    ...
    public void stop(@Nullable Identifier identifier, @Nullable SoundSource soundSource) {
        if (soundSource != null) {
            for (SoundInstance soundInstance : this.instanceBySource.get((Object)soundSource)) {
                if (identifier != null && !soundInstance.getIdentifier().equals((Object)identifier)) continue;
            ...
            for (SoundInstance soundInstance : this.instanceToChannel.keySet()) {
                if (!soundInstance.getIdentifier().equals((Object)identifier)) continue;
                this.stop(soundInstance);
            }
        }
    }
