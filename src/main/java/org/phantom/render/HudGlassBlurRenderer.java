...
public class HudGlassBlurRenderer {
  ...
  private static final org.phantom.render.rise.RenderTarget sourceTarget = new org.phantom.render.rise.RenderTarget();
  ...
  private static boolean copyFramebufferToTarget(
    int sourceFramebuffer,
    org.phantom.render.rise.RenderTarget target,
    int width,
    int height
  ) {
