...
public final class MainMenuBackgroundPass {
    ...
    private final ShaderProgram backgroundProgram =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/main_menu/background.frag");
    private final ShaderProgram filterProgram =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/main_menu/filter.glsl");
