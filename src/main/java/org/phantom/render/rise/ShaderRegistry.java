...
public final class ShaderRegistry {
    ...
    public static final BlurPass BLOOM_A = new BlurPass("/assets/phantom/shaders/rise/post/bloom.frag", 23, 24);
    public static final BlurPass BLOOM_B = new BlurPass("/assets/phantom/shaders/rise/post/bloom.frag", 23, 24);
    ...
    public static final ShaderProgram ROUNDED_RECT =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/rq.frag");
    public static final ShaderProgram GRADIENT_ROUNDED_RECT =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/rgq.glsl");
    public static final ShaderProgram ANIMATED_GRADIENT_ROUNDED_RECT =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/rgqtest.glsl");
    public static final ShaderProgram TRI_GRADIENT_ROUNDED_RECT =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/trirgq.glsl");
    public static final ShaderProgram ROUNDED_OUTLINE =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/roq.glsl");
    public static final ShaderProgram GRADIENT_OUTLINE =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/minecraft/rise/shader/rogq.frag");
    public static final ShaderProgram BLUE_COMPOSITE_ROUNDED_RECT =
        ShaderProgram.fromResources("/assets/phantom/shaders/rise/quad.vert", "/assets/phantom/shaders/rise/ui/blue_composite_rounded_rect.frag");
