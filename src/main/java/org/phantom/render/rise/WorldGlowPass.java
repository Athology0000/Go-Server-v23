...
public final class WorldGlowPass {
    ...
    private final BlurPass           blurH      = new BlurPass("/assets/phantom/shaders/rise/post/bloom.frag", 23, 24);
    private final BlurPass           blurV      = new BlurPass("/assets/phantom/shaders/rise/post/bloom.frag", 23, 24);
