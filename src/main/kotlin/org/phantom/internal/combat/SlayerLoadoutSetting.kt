...
internal enum class SpiderSwordCard(
  ...
  SCORPION_FOIL(
    "Scorpion Foil",
    "/assets/phantom/textures/loadout/spider/scorpion_foil.png",
    arrayOf("scorpion foil")
  ),
  THE_STING(
    "The Sting",
    "/assets/phantom/textures/loadout/spider/the_sting.png",
    arrayOf("the sting", "sting")
  ),
  TARANTULA_FANG(
    "Tarantula Fang",
    "/assets/phantom/textures/loadout/spider/tarantula_fang.png",
    arrayOf("tarantula fang")
  ),
  AUTODETECT(
    "Autodetect Sword",
    "/assets/phantom/textures/loadout/common/autodetect_sword.png",
...
internal enum class SpiderBowCard(
  ...
  MOSQUITO_SHORTBOW(
    "Mosquito Shortbow",
    "/assets/phantom/textures/loadout/spider/mosquito_shortbow.png",
    arrayOf("mosquito")
  ),
  SPIDER_SHORTBOW(
    "Spider Shortbow",
    "/assets/phantom/textures/loadout/spider/spider_shortbow.png",
    arrayOf("spider shortbow", "spider bow")
  ),
  AUTODETECT(
    "Autodetect Bow",
    "/assets/phantom/textures/loadout/common/autodetect_bow.png",
...
internal enum class PowerOrbCard(
  ...
  OVERFLUX(
    "Overflux Power Orb",
    "/assets/phantom/textures/loadout/common/overflux_power_orb.png",
    arrayOf("overflux")
  ),
  PLASMAFLUX(
    "Plasmaflux Power Orb",
    "/assets/phantom/textures/loadout/common/plasmaflux_power_orb.png",
    arrayOf("plasmaflux")
  ),
  SOS_FLARE(
    "SOS Flare",
    "/assets/phantom/textures/loadout/common/sos_flare.png",
    arrayOf("sos flare", "flare")
  ),
  MANA_FLUX(
    "Mana Flux Power Orb",
    "/assets/phantom/textures/loadout/common/manaflux_power_orb.png",
...
internal enum class UtilityCard(
  ...
  WAND_OF_ATONEMENT(
    "Wand Of Atonement",
    "/assets/phantom/textures/loadout/common/wand_of_atonement.png",
    arrayOf("wand of atonement")
  ),
  RAGNAROK(
    "Ragnarok",
    "/assets/phantom/textures/loadout/common/ragnarok.png",
    arrayOf("ragnarok", "ragnorak")
  ),
  SWORD_OF_BAD_HEALTH(
    "Sword Of Bad Health",
    "/assets/phantom/textures/loadout/common/sword_of_bad_health.png",
    arrayOf("sword of bad health")
  ),
  WITHER_CLOAK(
    "Wither Cloak",
    "/assets/phantom/textures/loadout/common/wither_cloak.png",
    arrayOf("wither cloak", "withercloak"),
    interactive = false
  ),
  ZOMBIE_SWORD(
    "Zombie Sword",
    "/assets/phantom/textures/loadout/common/zombie_sword.png",
    arrayOf("zombie sword")
  ),
  HYPERION(
    "Hyperion",
    "/assets/phantom/textures/loadout/common/hyperion.png",
