...
import org.phantom.internal.dungeons.map.CORNER_START_X
import org.phantom.internal.dungeons.map.CORNER_START_Z
import org.phantom.internal.dungeons.map.DungeonRoom
import org.phantom.internal.dungeons.map.DungeonScanState
import org.phantom.internal.dungeons.map.HALF_COMPONENT_SIZE
import org.phantom.internal.dungeons.map.RoomCheckmark
import org.phantom.internal.dungeons.map.RoomKind
...
object DungeonMapModule : Module("Dungeon Map") {
  ...
  private fun renderHud() {
    ...
    val headerLabel =
      if (DungeonScanState.isInDungeon && DungeonScanState.floor != org.phantom.internal.dungeons.map.DungeonFloor.NONE) {
        buildString {
  ...
  private fun doorFillColor(type: org.phantom.internal.dungeons.map.DoorKind): Int =
    when (type) {
      org.phantom.internal.dungeons.map.DoorKind.ENTRANCE -> 0xFF2C7C47.toInt()
      org.phantom.internal.dungeons.map.DoorKind.BLOOD -> 0xFFAA3737.toInt()
      org.phantom.internal.dungeons.map.DoorKind.WITHER -> 0xFF22252A.toInt()
      org.phantom.internal.dungeons.map.DoorKind.NORMAL -> 0xFF514337.toInt()
    }
