...
object EtherwarpLogic {
  ...
  /**
   * Uses the phantom native RRT* search to find yaw/pitch that etherwarp-teleports to [target].
  ...
  fun findEtherwarpHotbarSlot(): Int =
    org.phantom.api.util.InventoryUtils.findHotbarSlotMatching { isEtherwarpStack(it) }
