package org.phantom.internal.helper
...
internal object Config {
  ...
  private const val BUILTIN_ADDON_ID = "phantom"

  private val mc: Minecraft = Minecraft.getInstance()
  private val gson = GsonBuilder().setPrettyPrinting().create()
  private val modulesFile = File(mc.gameDirectory, "config/phantom/addons.json")
  private val themesFile = File(mc.gameDirectory, "config/phantom/themes.json")
