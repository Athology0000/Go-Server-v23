...
object VeinDirectionModule : Module("Vein Direction Setter") {
  ...
  private val configFile = File(mc.gameDirectory, "config/phantom/vein_directions.json")
  private val textFile = File(mc.gameDirectory, "config/phantom/vein_directions.txt")
