...
object PathRouteQuickAssignCommand {
  ...
  private fun assign(
    ...
    ChatUtils.sendMessage("PathRoute: assigned $cleanKey â†’ $cleanRoute")
  }
  ...
  private fun check(slotKey: String) {
    ...
    if (assigned.isNullOrBlank()) {
      ChatUtils.sendMessage("PathRoute: $cleanKey â†’ none")
    } else {
      ChatUtils.sendMessage("PathRoute: $cleanKey â†’ $assigned")
    }
  }
