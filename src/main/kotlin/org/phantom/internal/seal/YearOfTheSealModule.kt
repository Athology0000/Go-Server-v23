...
import org.phantom.api.pathfinder.jni.PathCommand
import org.phantom.api.pathfinder.jni.PathfinderRotationStrategy
...
object YearOfTheSealModule : Module("Year of the Seal") {
    ...
    // Entity ID of the ball locked onto when the macro was enabled â€” only this ball is tracked
    ...
    fun onTick(@Suppress("UNUSED_PARAMETER") event: TickEvent.Start) {
        ...
        // Lock onto the first beach ball seen after enabling â€” never switch to a different ball.
