...
import org.phantom.internal.routes.SubRouteKey
...
internal class UIRoutesPanel : UIPanel(
    ...
    // â”€â”€ Type filter tabs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Card hit areas (rebuilt each render) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    private fun renderCard(
        ...
        // Buttons: [â–¶ Load] [â–¼/â–²] (âœ• on hover)
        val toggleLabel = if (expanded) "â–²" else "â–¼"
        val loadLabel   = "â–¶ Load"
        ...
        if (hovering || isHoveringOver(deleteX, btnY, deleteW, BTN_H)) {
            ...
            NVGRenderer.text("âœ•", deleteX + 5F, btnY + 5F, 11F, if (deleteHover) 0xFFFF6B6BL.toInt() else theme.textSecondary)
        }
    ...
    private fun renderEmptyState(ex: Float, ey: Float) {
        ...
        NVGRenderer.text("Routes are stored in config/phantom/routes2/", ex + 16F, ey + 38F, 10F, theme.textSecondary)
    }
    ...
    private fun buildPointSummary(route: SavedRoute): String {
        ...
        return parts.joinToString("  Â·  ").ifEmpty { "0 pts" }
    }
