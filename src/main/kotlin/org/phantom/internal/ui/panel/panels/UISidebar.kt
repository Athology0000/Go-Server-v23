...
import org.phantom.internal.ui.components.tooltips.TooltipPosition
import org.phantom.internal.ui.components.tooltips.UITooltip
import org.phantom.internal.ui.components.tooltips.impl.UITextTooltip
...
internal class UISidebar : UIPanel(
  ...
  private val moduleButton = UIButton("/assets/phantom/textures/ui/box.svg", "Modules") {
    UIConfig.swapBodyPanel(UIAddonList())
  }

  private val hudButton = UIButton("/assets/phantom/textures/ui/palette.svg", "HUD Editor") {
    UIHudEditor().openUI()
  }

  private val designButton = UIButton("/assets/phantom/textures/ui/interface.svg", "Design") {
  ...
  private val macrosButton = UIButton("/assets/phantom/textures/ui/macros.svg", "Macros") {
    openQuickModules(
      "phantom-quick-macros",
      "Macros",
  ...
  private val steveIcon = NVGRenderer.createImage("/assets/phantom/textures/steve.png")
