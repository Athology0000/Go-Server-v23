...
import org.phantom.api.ui.theme.impl.CustomTheme
...
import org.phantom.internal.ui.theme.ThemeSerializer
...
internal class UIThemeSelector : UIPanel(
  ...
  private class UICreateThemeButton : UIComponent(
    ...
    companion object {
      private val plusIcon = NVGRenderer.createImage("/assets/phantom/textures/ui/plus.svg")
    }
  }
  ...
  private class UIImportThemeButton : UIComponent(
    ...
    companion object {
      private val importIcon = NVGRenderer.createImage("/assets/phantom/textures/ui/import.svg")
    }
  }
