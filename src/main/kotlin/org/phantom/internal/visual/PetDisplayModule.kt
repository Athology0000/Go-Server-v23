...
object PetDisplayModule : Module("Pet Display") {
    ...
    private fun ensureGhostLoaded() {
        ...
        ghostImage = runCatching {
            NVGRenderer.createImage("/assets/phantom/textures/ui/ghost.svg")
        }.getOrNull()
    }
    ...
    private fun tryStartHeadLoad(petName: String, skullUrl: String) {
        ...
        Thread({
            try {
                ...
                val tmp = java.io.File(System.getProperty("java.io.tmpdir"), "phantom_pet_head_${petName.replace(" ", "_")}.png")
