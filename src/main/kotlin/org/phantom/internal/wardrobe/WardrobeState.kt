...
data class WardrobeSet(
    ...
    val inventorySlot: Int,  // slot index in container to click to equip (36â€“44)
...
object WardrobeState {
     ...
     * [favorites] is intentionally preserved â€” it persists until explicitly cleared.
     */
    fun reset() {
        isOpen = false
    ...
    /**
     * Update the [sets] entries for the given vanilla [page] (1â€“3) with parsed armor,
