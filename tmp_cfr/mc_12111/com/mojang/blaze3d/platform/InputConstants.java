...
public class InputConstants {
    ...
    public static enum Type {
        KEYSYM("key.keyboard", (integer, string) -> {
            ...
            return string2 != null ? Component.literal((String)string2.toUpperCase(Locale.ROOT)) : Component.translatable((String)string);
        }),
        SCANCODE("scancode", (integer, string) -> {
            String string2 = GLFW.glfwGetKeyName((int)-1, (int)integer);
            return string2 != null ? Component.literal((String)string2) : Component.translatable((String)string);
        }),
        MOUSE("key.mouse", (integer, string) -> Language.getInstance().has(string) ? Component.translatable((String)string) : Component.translatable((String)"key.mouse", (Object[])new Object[]{integer + 1}));
