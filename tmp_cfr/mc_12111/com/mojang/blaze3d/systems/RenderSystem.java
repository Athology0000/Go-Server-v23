...
public class RenderSystem {
    ...
    public static void queueFencedTask(Runnable runnable) {
        PENDING_FENCES.addLast((Object)new GpuAsyncTask(runnable, RenderSystem.getDevice().createCommandEncoder().createFence()));
    }

    public static void executePendingTasks() {
        GpuAsyncTask gpuAsyncTask = (GpuAsyncTask)PENDING_FENCES.peekFirst();
    ...
    public static final class AutoStorageIndexBuffer {
        ...
        private void ensureStorage(int i) {
            ...
            i = Mth.roundToward((int)(i * 2), (int)this.indexStride);
            ...
            int l = Mth.roundToward((int)(i * indexType.bytes), (int)4);
