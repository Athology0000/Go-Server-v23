...
public interface RealmsError {
    ...
    public static RealmsError parse(int i, String string) {
        ...
        try {
            JsonObject jsonObject = LenientJsonParser.parse((String)string).getAsJsonObject();
            String string2 = GsonHelper.getAsString((JsonObject)jsonObject, (String)"reason", null);
            String string3 = GsonHelper.getAsString((JsonObject)jsonObject, (String)"errorMsg", null);
            int j = GsonHelper.getAsInt((JsonObject)jsonObject, (String)"errorCode", (int)-1);
    ...
    public record CustomError(int httpCode, @Nullable Component payload) implements RealmsError
    {
        ...
        public static CustomError unknownCompatibilityResponse(String string) {
            return new CustomError(500, (Component)Component.translatable((String)"mco.errorMessage.realmsService.unknownCompatibility", (Object[])new Object[]{string}));
        }
        ...
        public static CustomError connectivityError(RealmsHttpException realmsHttpException) {
            return new CustomError(500, (Component)Component.translatable((String)"mco.errorMessage.realmsService.connectivity", (Object[])new Object[]{realmsHttpException.getMessage()}));
        }
        ...
        public static CustomError htmlPayload(int i, String string) {
            ...
            if (j >= 0 && k > j) {
                return new CustomError(i, (Component)Component.literal((String)string.substring(j + BODY_TAG.length(), k).trim()));
            }
