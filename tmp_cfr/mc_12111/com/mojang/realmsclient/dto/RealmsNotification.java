...
public class RealmsNotification {
    ...
    static final Component BUTTON_TEXT_FALLBACK = Component.translatable((String)"mco.notification.visitUrl.buttonText.default");
    final UUID uuid;
    ...
    public static List<RealmsNotification> parseList(String string) {
        ...
        try {
            JsonArray jsonArray = LenientJsonParser.parse((String)string).getAsJsonObject().get("notifications").getAsJsonArray();
    ...
    extends RealmsNotification {
        ...
        public static InfoPopup parse(RealmsNotification realmsNotification, JsonObject jsonObject) {
            ...
            RealmsText realmsText2 = JsonUtils.getRequired(MESSAGE, jsonObject, RealmsText::parse);
            Identifier identifier = Identifier.parse((String)JsonUtils.getRequiredString(IMAGE, jsonObject));
