...
extends RealmsScreen {
    ...
    private void createWorld(RealmsServer realmsServer2, boolean bl) {
        if (!realmsServer2.isSnapshotRealm() && bl) {
            ...
            ((CompletableFuture)CompletableFuture.supplyAsync(() -> RealmsCreateRealmScreen.createSnapshotRealm(realmsServer2), (Executor)Util.backgroundExecutor()).thenAcceptAsync(realmsServer -> {
                if (!atomicBoolean.get()) {
                    this.showResetWorldScreen((RealmsServer)realmsServer);
                }
            }, (Executor)((Object)this.minecraft))).exceptionallyAsync(throwable -> {
                ...
                if (throwable2 instanceof RealmsServiceException) {
                    ...
                    component = Component.translatable((String)"mco.errorMessage.initialize.failed");
                }
                this.minecraft.setScreen(new RealmsGenericErrorScreen((Component)component, (Screen)this.lastScreen));
                return null;
