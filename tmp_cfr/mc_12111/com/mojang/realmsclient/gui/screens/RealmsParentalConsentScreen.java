...
extends RealmsScreen {
    ...
    public void init() {
        ...
        MutableComponent component = Component.translatable((String)"mco.account.privacy.info.button");
        linearLayout.addChild(Button.builder((Component)component, ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.GDPR)).build());
