...
extends RealmsScreen {
    ...
    extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        Entry(PendingInvite pendingInvite) {
            ...
            this.realmName = new StringWidget((Component)Component.literal((String)pendingInvite.realmName()), RealmsPendingInvitesScreen.this.font).setMaxWidth(i);
            this.realmOwnerName = new StringWidget((Component)Component.literal((String)pendingInvite.realmOwnerName()).withColor(-6250336), RealmsPendingInvitesScreen.this.font).setMaxWidth(i);
            this.inviteDate = new StringWidget(ComponentUtils.mergeStyles((Component)RealmsUtil.convertToAgePresentationFromInstant(pendingInvite.date()), (Style)Style.EMPTY.withColor(-6250336)), RealmsPendingInvitesScreen.this.font).setMaxWidth(i);
        ...
        private Button.CreateNarration getCreateNarration(PendingInvite pendingInvite) {
            return supplier -> {
                MutableComponent mutableComponent = CommonComponents.joinForNarration((Component[])new Component[]{(Component)supplier.get(), Component.literal((String)pendingInvite.realmName()), Component.literal((String)pendingInvite.realmOwnerName()), RealmsUtil.convertToAgePresentationFromInstant(pendingInvite.date())});
                return Component.translatable((String)"narrator.select", (Object[])new Object[]{mutableComponent});
            };
        }
        ...
        private void handleInvitation(boolean bl) {
            ...
            }, (Executor)Util.ioPool()).thenAcceptAsync(boolean_ -> {
