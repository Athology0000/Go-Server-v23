...
extends RealmsScreen {
    ...
    static final Identifier SLOT_FRAME_SPRITE = Identifier.withDefaultNamespace((String)"widget/slot_frame");
        ...
        for (int k = 0; k < list.size(); ++k) {
            ...
            for (TextRenderingUtils.LineSegment lineSegment2 : line.segments) {
                ...
                if (lineSegment2.isLink() && i > n && i < p && j > l - 3 && j < l + 8) {
                    guiGraphics.setTooltipForNextFrame((Component)Component.literal((String)lineSegment2.getLinkUrl()), i, j);
