...
implements RealmsConfigurationTab {
    ...
    RealmsSettingsTab(RealmsConfigureWorldScreen realmsConfigureWorldScreen, Minecraft minecraft, RealmsServer realmsServer, Map<RealmsRegion, ServiceQuality> map) {
        ...
        this.selectedRegionStringWidget = equalSpacingLayout.addChild(new StringWidget(192, realmsConfigureWorldScreen.getFont().lineHeight, (Component)Component.empty(), realmsConfigureWorldScreen.getFont()));
        ...
        rowHelper.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.buttons.region_preference"), button -> this.openPreferenceSelector()).bounds(0, 0, 212, 20).build());
        rowHelper.addChild(SpacerElement.height(2));
        this.closeOpenButton = rowHelper.addChild(Button.builder((Component)Component.empty(), button -> {
            if (realmsServer.state == RealmsServer.State.OPEN) {
                minecraft.setScreen(RealmsPopups.customPopupScreen(realmsConfigureWorldScreen, (Component)Component.translatable((String)"mco.configure.world.close.question.title"), (Component)Component.translatable((String)"mco.configure.world.close.question.line1"), popupScreen -> {
                    this.save();
    ...
    public void updateData(RealmsServer realmsServer) {
        ...
        this.closeOpenButton.setMessage((Component)Component.translatable((String)string));
