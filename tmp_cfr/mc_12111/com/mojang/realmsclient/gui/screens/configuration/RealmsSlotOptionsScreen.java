...
extends RealmsScreen {
    ...
    private static final Component NAME_LABEL = Component.translatable((String)"mco.configure.world.edit.slot.name");
    static final Component SPAWN_PROTECTION_TEXT = Component.translatable((String)"mco.configure.world.spawnProtection");
    ...
    public RealmsSlotOptionsScreen(RealmsConfigureWorldScreen realmsConfigureWorldScreen, RealmsSlot realmsSlot, RealmsServer.WorldType worldType, int i) {
        super((Component)Component.translatable((String)"mco.configure.world.buttons.options"));
    ...
    public void init() {
        ...
        if (this.worldType != RealmsServer.WorldType.NORMAL) {
            MutableComponent component = this.worldType == RealmsServer.WorldType.ADVENTUREMAP ? Component.translatable((String)"mco.configure.world.edit.subscreen.adventuremap") : (this.worldType == RealmsServer.WorldType.INSPIRATION ? Component.translatable((String)"mco.configure.world.edit.subscreen.inspiration") : Component.translatable((String)"mco.configure.world.edit.subscreen.experience"));
            this.addLabel(new RealmsLabel((Component)component, this.width / 2, 26, -65536));
        }
        this.nameEdit = this.addWidget(new EditBox(this.minecraft.font, this.column1X, RealmsSlotOptionsScreen.row(1), this.columnWidth, 20, null, (Component)Component.translatable((String)"mco.configure.world.edit.slot.name")));
        this.nameEdit.setValue(this.worldName);
        this.nameEdit.setResponder(this::setWorldName);
        CycleButton<Difficulty> cycleButton2 = this.addRenderableWidget(CycleButton.builder(Difficulty::getDisplayName, this.difficulty).withValues((Collection<Difficulty>)DIFFICULTIES).create(i, RealmsSlotOptionsScreen.row(1), this.columnWidth, 20, (Component)Component.translatable((String)"options.difficulty"), (cycleButton, difficulty) -> {
            this.difficulty = difficulty;
        }));
        CycleButton<GameType> cycleButton22 = this.addRenderableWidget(CycleButton.builder(GameType::getShortDisplayName, this.gameMode).withValues((Collection<GameType>)GAME_MODES).create(this.column1X, RealmsSlotOptionsScreen.row(3), this.columnWidth, 20, (Component)Component.translatable((String)"selectWorld.gameMode"), (cycleButton, gameType) -> {
            this.gameMode = gameType;
        }));
        CycleButton<Boolean> cycleButton3 = this.addRenderableWidget(CycleButton.onOffBuilder(this.forceGameMode).create(i, RealmsSlotOptionsScreen.row(3), this.columnWidth, 20, (Component)Component.translatable((String)"mco.configure.world.forceGameMode"), (cycleButton, boolean_) -> {
        ...
        this.addRenderableWidget(Button.builder((Component)Component.translatable((String)"mco.configure.world.buttons.done"), button -> this.saveSettings()).bounds(this.column1X, RealmsSlotOptionsScreen.row(13), this.columnWidth, 20).build());
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration((Component[])new Component[]{this.getTitle(), this.createLabelNarration()});
    }
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        guiGraphics.drawString(this.font, NAME_LABEL, this.column1X + this.columnWidth / 2 - this.font.width((FormattedText)NAME_LABEL) / 2, RealmsSlotOptionsScreen.row(0) - 5, -1);
    ...
    extends AbstractSliderButton {
        ...
        public SettingsSlider(int i, int j, int k, int l, float f, float g) {
            ...
            this.minValue = f;
            this.maxValue = g;
            this.value = (Mth.clamp((float)l, (float)f, (float)g) - f) / (g - f);
            this.updateMessage();
        }
        ...
        public void applyValue() {
            ...
            RealmsSlotOptionsScreen.this.spawnProtection = (int)Mth.lerp((double)Mth.clamp((double)this.value, (double)0.0, (double)1.0), (double)this.minValue, (double)this.maxValue);
        }

        @Override
        protected void updateMessage() {
            this.setMessage((Component)CommonComponents.optionNameValue((Component)SPAWN_PROTECTION_TEXT, (Component)(RealmsSlotOptionsScreen.this.spawnProtection == 0 ? CommonComponents.OPTION_OFF : Component.literal((String)String.valueOf(RealmsSlotOptionsScreen.this.spawnProtection)))));
        }
    }
}
