...
implements RealmsConfigurationTab {
    ...
    RealmsWorldsTab(RealmsConfigureWorldScreen realmsConfigureWorldScreen, Minecraft minecraft, RealmsServer realmsServer) {
        ...
        this.optionsButton = rowHelper3.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.buttons.options"), button -> minecraft.setScreen(new RealmsSlotOptionsScreen(realmsConfigureWorldScreen, realmsServer.slots.get(realmsServer.activeSlot).copy(), realmsServer.worldType, realmsServer.activeSlot))).bounds(0, 0, 150, 20).build());
        this.backupButton = rowHelper3.addChild(Button.builder((Component)Component.translatable((String)"mco.configure.world.backup"), button -> minecraft.setScreen(new RealmsBackupScreen(realmsConfigureWorldScreen, realmsServer.copy(), realmsServer.activeSlot))).bounds(0, 0, 150, 20).build());
        this.resetWorldButton = rowHelper3.addChild(Button.builder((Component)Component.empty(), button -> this.resetButtonPressed()).bounds(0, 0, 150, 20).build());
