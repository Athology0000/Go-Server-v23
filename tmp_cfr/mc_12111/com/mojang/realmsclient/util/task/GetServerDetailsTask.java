...
extends LongRunningTask {
    ...
    private PopupScreen resourcePackDownloadConfirmationScreen(RealmsJoinInformation realmsJoinInformation, UUID uUID, Function<RealmsJoinInformation, Screen> function) {
        MutableComponent component = Component.translatable((String)"mco.configure.world.resourcepack.question");
        return RealmsPopups.infoPopupScreen(this.lastScreen, (Component)component, popupScreen -> {
