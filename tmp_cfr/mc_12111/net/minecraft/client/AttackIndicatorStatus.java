...
public enum AttackIndicatorStatus {
    ...
    static {
        BY_ID = ByIdMap.continuous(attackIndicatorStatus -> attackIndicatorStatus.id, (Object[])AttackIndicatorStatus.values(), (ByIdMap.OutOfBoundsStrategy)ByIdMap.OutOfBoundsStrategy.WRAP);
