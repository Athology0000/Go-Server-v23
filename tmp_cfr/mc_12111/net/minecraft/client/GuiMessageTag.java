...
public record GuiMessageTag(int indicatorColor, @Nullable Icon icon, @Nullable Component text, @Nullable String logTag) {
    ...
    public static GuiMessageTag chatModified(String string) {
        ...
        MutableComponent component2 = Component.empty().append(CHAT_MODIFIED_TEXT).append(CommonComponents.NEW_LINE).append((Component)component);
        return new GuiMessageTag(0x606060, Icon.CHAT_MODIFIED, (Component)component2, "Modified");
    }
