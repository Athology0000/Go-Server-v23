...
public class KeyboardHandler {
    ...
    private static Component decorateDebugComponent(ChatFormatting chatFormatting, Component component) {
        return Component.empty().append((Component)Component.translatable((String)"debug.prefix").withStyle(new ChatFormatting[]{chatFormatting, ChatFormatting.BOLD})).append(CommonComponents.SPACE).append(component);
    }
    ...
    private void debugFeedbackTranslated(String string, Object ... objects) {
        this.debugFeedbackComponent((Component)Component.translatable((String)string, (Object[])objects));
    }

    private void debugFeedback(String string) {
        this.debugFeedbackComponent((Component)Component.literal((String)string));
    }
    ...
    private boolean handleDebugKeys(KeyEvent keyEvent) {
        ...
        if (options.keyDebugSpectate.matches(keyEvent)) {
            if (this.minecraft.player == null || !GameModeCommand.PERMISSION_CHECK.check(this.minecraft.player.permissions())) {
                ...
                this.minecraft.player.connection.send((Packet<?>)new ServerboundChangeGameModePacket(gameType));
            }
            bl = true;
        }
        ...
        if (options.keyDebugDumpDynamicTextures.matches(keyEvent)) {
            ...
            MutableComponent component = Component.literal((String)path.relativize(path2).toString()).withStyle(ChatFormatting.UNDERLINE).withStyle(style -> style.withClickEvent((ClickEvent)new ClickEvent.OpenFile(path2)));
            this.debugFeedbackComponent((Component)Component.translatable((String)"debug.dump_dynamic_textures", (Object[])new Object[]{component}));
            bl = true;
        }
    ...
    private void copyRecreateCommand(boolean bl, boolean bl2) {
        ...
        switch (hitResult.getType()) {
            case BLOCK: {
                ...
                CompoundTag compoundTag2 = blockEntity != null ? blockEntity.saveWithoutMetadata((HolderLookup.Provider)level.registryAccess()) : null;
            ...
            case ENTITY: {
                ...
                Identifier identifier = BuiltInRegistries.ENTITY_TYPE.getKey((Object)entity.getType());
                if (!bl) {
    ...
    private void copyCreateBlockCommand(BlockState blockState, BlockPos blockPos, @Nullable CompoundTag compoundTag) {
        StringBuilder stringBuilder = new StringBuilder(BlockStateParser.serialize((BlockState)blockState));
        if (compoundTag != null) {
    ...
    private void copyCreateEntityCommand(Identifier identifier, Vec3 vec3, @Nullable CompoundTag compoundTag) {
        ...
        if (compoundTag != null) {
            ...
            String string = NbtUtils.toPrettyComponent((Tag)compoundTag).getString();
    ...
    private void keyPress(long l, @KeyEvent.Action int i, KeyEvent keyEvent) {
        ...
        if (screen2 != null) {
            try {
                ...
                CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"keyPressed event handler");
                screen2.fillCrashDetails(crashReport);
                CrashReportCategory crashReportCategory = crashReport.addCategory("Key");
                crashReportCategory.setDetail("Key", (Object)keyEvent.key());
                crashReportCategory.setDetail("Scancode", (Object)keyEvent.scancode());
                crashReportCategory.setDetail("Mods", (Object)keyEvent.modifiers());
    ...
    private void charTyped(long l, CharacterEvent characterEvent) {
        ...
        try {
            ...
            CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"charTyped event handler");
            screen.fillCrashDetails(crashReport);
            CrashReportCategory crashReportCategory = crashReport.addCategory("Key");
            crashReportCategory.setDetail("Codepoint", (Object)characterEvent.codepoint());
            crashReportCategory.setDetail("Mods", (Object)characterEvent.modifiers());
            throw new ReportedException(crashReport);
        }
    }
        ...
        if (this.debugCrashKeyTime > 0L) {
            ...
            if (n >= 1000L) {
                if (this.debugCrashKeyReportedCount == 0L) {
                    ...
                    this.debugWarningComponent((Component)Component.translatable((String)"debug.crash.warning", (Object[])new Object[]{Mth.ceil((float)((float)m / 1000.0f))}));
                }
