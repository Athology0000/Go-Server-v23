                ...
                if (this.minecraft.screen == null) {
                    ...
                    if (bl) {
                        ...
                        try {
                            ...
                            CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"mouseClicked event handler");
                            ...
                            crashReportCategory.setDetail("Button", (Object)mouseButtonEvent.button());
                    ...
                    try {
                        ...
                        CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"mouseReleased event handler");
                        screen.fillCrashDetails(crashReport);
                        CrashReportCategory crashReportCategory = crashReport.addCategory("Mouse");
                        this.fillMousePositionDetails(crashReportCategory, window);
                        crashReportCategory.setDetail("Button", (Object)mouseButtonEvent.button());
                ...
                if (this.minecraft.screen != null) {
                    ...
                    if (this.minecraft.player.isSpectator()) {
                        if (this.minecraft.gui.getSpectatorGui().isMenuActive()) {
                            ...
                            float m = Mth.clamp((float)(this.minecraft.player.getAbilities().getFlyingSpeed() + (float)vector2i.y * 0.005f), (float)0.0f, (float)0.2f);
        ...
        if (this.minecraft.isWindowActive()) {
            ...
            if (screen != null && this.minecraft.getOverlay() == null && bl) {
                ...
                try {
                    ...
                    CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"mouseMoved event handler");
                    screen.fillCrashDetails(crashReport);
                    CrashReportCategory crashReportCategory = crashReport.addCategory("Mouse");
                    this.fillMousePositionDetails(crashReportCategory, window);
                    throw new ReportedException(crashReport);
                ...
                if (this.activeButton != null && this.mousePressedTime > 0.0) {
                    ...
                    try {
                        ...
                        CrashReport crashReport2 = CrashReport.forThrowable((Throwable)throwable2, (String)"mouseDragged event handler");
