...
public final class OptionInstance<T> {
    ...
    public record SliderableEnum<T>(List<T> values, Codec<T> codec) implements SliderableValueSet<T>
    {
        ...
        public double toSliderValue(T object) {
            ...
            return Mth.map((double)this.values.indexOf(object), (double)0.0, (double)(this.values.size() - 1), (double)0.0, (double)1.0);
        }

        @Override
        public Optional<T> next(T object) {
            int i = this.values.indexOf(object);
            int j = Mth.clamp((int)(i + 1), (int)0, (int)(this.values.size() - 1));
        ...
        public T fromSliderValue(double d) {
            ...
            int i = Mth.floor((double)Mth.map((double)d, (double)0.0, (double)1.0, (double)0.0, (double)this.values.size()));
            return this.values.get(Mth.clamp((int)i, (int)0, (int)(this.values.size() - 1)));
        }
    ...
    SliderableOrCyclableValueSet<Integer>
    {
        ...
        public Optional<Integer> validateValue(Integer integer) {
            return Optional.of(Mth.clamp((int)integer, (int)this.minInclusive(), (int)this.maxInclusive()));
        }
    ...
    extends SliderableValueSet<Integer> {
        ...
        default public double toSliderValue(Integer integer) {
            ...
            return Mth.map((double)((double)integer.intValue() + 0.5), (double)this.minInclusive(), (double)((double)this.maxInclusive() + 1.0), (double)0.0, (double)1.0);
        }
        ...
        default public Integer fromSliderValue(double d) {
            ...
            return Mth.floor((double)Mth.map((double)d, (double)0.0, (double)1.0, (double)this.minInclusive(), (double)((double)this.maxInclusive() + 1.0)));
        }
