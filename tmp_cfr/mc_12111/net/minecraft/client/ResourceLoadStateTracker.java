...
public class ResourceLoadStateTracker {
    ...
    public void fillCrashReport(CrashReport crashReport) {
        ...
        crashReportCategory.setDetail("Reload number", (Object)this.reloadCount);
        if (this.reloadState != null) {
    ...
    static class ReloadState {
        ...
        public void fillCrashInfo(CrashReportCategory crashReportCategory) {
            crashReportCategory.setDetail("Reload reason", (Object)this.reloadReason.name);
            crashReportCategory.setDetail("Finished", (Object)(this.finished ? "Yes" : "No"));
    ...
    static class RecoveryInfo {
        ...
        public void fillCrashInfo(CrashReportCategory crashReportCategory) {
            crashReportCategory.setDetail("Recovery", (Object)"Yes");
