        ...
        Screenshot.takeScreenshot(renderTarget, i, nativeImage -> {
            ...
            Util.ioPool().execute(() -> {
                try (NativeImage nativeImage2 = nativeImage;){
                    ...
                    MutableComponent component = Component.literal((String)file3.getName()).withStyle(ChatFormatting.UNDERLINE).withStyle(style -> style.withClickEvent((ClickEvent)new ClickEvent.OpenFile(file3.getAbsoluteFile())));
            ...
            try (GpuBuffer.MappedView mappedView = commandEncoder.mapBuffer(gpuBuffer, true, false);){
                ...
                for (int n = 0; n < l; ++n) {
                    for (int o = 0; o < m; ++o) {
                        ...
                        s = i * i;
                        nativeImage.setPixelABGR(o, l - n - 1, ARGB.color((int)255, (int)(p / s), (int)(q / s), (int)(r / s)));
                    }
                }
