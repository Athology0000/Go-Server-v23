...
implements DataProvider {
    ...
    private static final Map<String, Identifier> TRIM_PALETTE_VALUES = AtlasProvider.extractAllMaterialAssets().collect(Collectors.toMap(MaterialAssetGroup.AssetInfo::suffix, assetInfo -> Identifier.withDefaultNamespace((String)("trims/color_palettes/" + assetInfo.suffix()))));
    ...
    private CompletableFuture<?> storeAtlas(CachedOutput cachedOutput, Identifier identifier, List<SpriteSource> list) {
        return DataProvider.saveStable((CachedOutput)cachedOutput, SpriteSources.FILE_CODEC, list, (Path)this.pathProvider.json(identifier));
    }
