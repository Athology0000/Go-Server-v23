...
public class ClientAvatarState {
    ...
    public double getInterpolatedCloakX(float f) {
        return Mth.lerp((double)f, (double)this.xCloakO, (double)this.xCloak);
    }

    public double getInterpolatedCloakY(float f) {
        return Mth.lerp((double)f, (double)this.yCloakO, (double)this.yCloak);
    }

    public double getInterpolatedCloakZ(float f) {
        return Mth.lerp((double)f, (double)this.zCloakO, (double)this.zCloak);
    }
    ...
    public float getInterpolatedBob(float f) {
        return Mth.lerp((float)f, (float)this.bobO, (float)this.bob);
    }
    ...
    public float getInterpolatedWalkDistance(float f) {
        return Mth.lerp((float)f, (float)this.walkDistO, (float)this.walkDist);
    }
}
