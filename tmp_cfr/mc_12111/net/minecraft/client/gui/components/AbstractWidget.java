...
NarratableEntry {
    ...
    public static MutableComponent wrapDefaultNarrationMessage(Component component) {
        return Component.translatable((String)"gui.narrate.button", (Object[])new Object[]{component});
    }
    ...
    protected void defaultButtonNarrationText(NarrationElementOutput narrationElementOutput) {
        ...
        if (this.active) {
            if (this.isFocused()) {
                narrationElementOutput.add(NarratedElementType.USAGE, (Component)Component.translatable((String)"narration.button.usage.focused"));
            } else {
    ...
    extends AbstractWidget {
        ...
        public static Component defaultInactiveMessage(Component component) {
            return ComponentUtils.mergeStyles((Component)component, (Style)Style.EMPTY.withColor(-6250336));
        }
