...
public class ChatComponent {
    ...
    private void render(final ChatGraphicsAccess chatGraphicsAccess, int i, int j, boolean bl) {
        ...
        int l2 = Mth.ceil((float)((float)this.getWidth() / f));
        final int m = Mth.floor((float)((float)(i - 40) / f));
        ...
        this.forEachLine(alphaCalculator, (line, l, g) -> {
            int m = m - l * p;
            int n = m - p;
            chatGraphicsAccess.fill(-4, n, l2 + 4 + 4, m, ARGB.black((float)(g * h)));
        });
        if (r > 0L) {
            chatGraphicsAccess.fill(-2, m, l2 + 4, m + n, ARGB.black((float)h));
        }
        ...
        if (r > 0L) {
            t = m + n;
            MutableComponent component = Component.translatable((String)"chat.queue", (Object[])new Object[]{r}).setStyle(QUEUE_EXPAND_TEXT_STYLE);
        ...
        if (bl) {
            ...
            if (t != u) {
                ...
                int z = l2 + 4;
                chatGraphicsAccess.fill(z, -v, z + 2, -v - w, ARGB.color((int)x, (int)y));
                chatGraphicsAccess.fill(z + 2, -v, z + 1, -v - w, ARGB.color((int)x, (int)0xCCCCCC));
            }
        }
        profilerFiller.pop();
    }
    ...
    private void logChatMessage(GuiMessage guiMessage) {
        ...
        String string2 = (String)Optionull.map((Object)guiMessage.tag(), GuiMessageTag::logTag);
        if (string2 != null) {
    ...
    private void addMessageToDisplayQueue(GuiMessage guiMessage) {
        int i = Mth.floor((double)((double)this.getWidth() / this.getScale()));
    ...
    public void addRecentChat(String string) {
        if (!string.equals(this.recentChat.peekLast())) {
            ...
            this.recentChat.addLast((Object)string);
        }
    ...
    public static int getWidth(double d) {
        int i = 320;
        int j = 40;
        return Mth.floor((double)(d * 280.0 + 40.0));
    }

    public static int getHeight(double d) {
        int i = 180;
        int j = 20;
        return Mth.floor((double)(d * 160.0 + 20.0));
    }
    ...
    Consumer<Style> {
        ...
        public void handleTag(int i, int j, int k, int l, float f, GuiMessageTag guiMessageTag) {
            int m = ARGB.color((float)f, (int)guiMessageTag.indicatorColor());
            this.graphics.fill(i, j, k, l, m);
        ...
        private void showTooltip(GuiMessageTag guiMessageTag) {
            if (guiMessageTag.text() != null) {
                this.graphics.setTooltipForNextFrame(this.font, this.font.split((FormattedText)guiMessageTag.text(), 210), this.globalMouseX, this.globalMouseY);
            }
        }
