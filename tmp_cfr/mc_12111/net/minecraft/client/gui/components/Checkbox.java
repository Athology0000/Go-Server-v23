...
extends AbstractButton {
    ...
    static int getDefaultWidth(Component component, Font font) {
        return Checkbox.getBoxSize(font) + 4 + font.width((FormattedText)component);
    }
    ...
    public void updateWidgetNarration(NarrationElementOutput narrationElementOutput) {
        ...
        if (this.active) {
            if (this.isFocused()) {
                narrationElementOutput.add(NarratedElementType.USAGE, (Component)Component.translatable((String)(this.selected ? "narration.checkbox.usage.focused.uncheck" : "narration.checkbox.usage.focused.check")));
            } else {
                narrationElementOutput.add(NarratedElementType.USAGE, (Component)Component.translatable((String)(this.selected ? "narration.checkbox.usage.hovered.uncheck" : "narration.checkbox.usage.hovered.check")));
            }
        }
    }
    ...
    public void renderContents(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, identifier, this.getX(), this.getY(), k, k, ARGB.white((float)this.alpha));
        int l = this.getX() + k + 4;
