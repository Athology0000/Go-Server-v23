...
extends MultiLineTextWidget {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
        int k = this.alwaysShowBorder && !this.isFocused() ? ARGB.color((float)this.alpha, (int)-6250336) : ARGB.white((float)this.alpha);
        switch (this.backgroundFill.ordinal()) {
            case 0: {
                guiGraphics.fill(this.getX() + 1, this.getY(), this.getRight(), this.getBottom(), ARGB.black((float)this.alpha));
                break;
            }
            case 1: {
    ...
    public void updateHeight() {
        int i = this.getFont().lineHeight * this.getFont().split((FormattedText)this.getMessage(), super.getWidth()).size();
    ...
    public void setMessage(Component component) {
        ...
        int i = this.maxWidth != -1 ? this.maxWidth : this.getFont().width((FormattedText)component) + this.padding * 2;
        this.setWidth(i);
        this.updateHeight();
    }
