...
extends AbstractWidget {
    ...
    public LoadingDotsWidget(Font font, Component component) {
        super(0, 0, font.width((FormattedText)component), font.lineHeight * 3, component);
        this.font = font;
    }
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        guiGraphics.drawString(this.font, component, k - this.font.width((FormattedText)component) / 2, l - this.font.lineHeight, -1);
