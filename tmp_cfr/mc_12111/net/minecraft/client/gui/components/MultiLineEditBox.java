...
extends AbstractTextAreaWidget {
    ...
    public void updateWidgetNarration(NarrationElementOutput narrationElementOutput) {
        narrationElementOutput.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"gui.narrate.editBox", (Object[])new Object[]{this.getMessage(), this.getValue()}));
    }
    ...
    protected void renderContents(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        if (string.isEmpty() && !this.isFocused()) {
            guiGraphics.drawWordWrap(this.font, (FormattedText)this.placeholder, this.getInnerLeft(), this.getInnerTop(), this.width - this.totalInnerPadding(), PLACEHOLDER_TEXT_COLOR);
            return;
        }
    ...
    protected void renderDecorations(GuiGraphics guiGraphics) {
        ...
        if (this.textField.hasCharacterLimit()) {
            ...
            MutableComponent component = Component.translatable((String)"gui.multiLineEditBox.character_limit", (Object[])new Object[]{this.textField.value().length(), i});
            guiGraphics.drawString(this.font, (Component)component, this.getX() + this.width - this.font.width((FormattedText)component), this.getY() + this.height + 4, -6250336);
        }
    }
