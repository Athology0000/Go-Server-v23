...
public class MultilineTextField {
    ...
    public void insertText(String string) {
        ...
        String string2 = this.truncateInsertionText(StringUtil.filterText((String)string, (boolean)true));
    ...
    public StringView getLineView(int i) {
        return this.displayLines.get(Mth.clamp((int)i, (int)0, (int)(this.displayLines.size() - 1)));
    }
    ...
    public void seekCursorToPoint(double d, double e) {
        int i = Mth.floor((double)d);
        int j = Mth.floor((double)(e / (double)this.font.lineHeight));
        StringView stringView = this.displayLines.get(Mth.clamp((int)j, (int)0, (int)(this.displayLines.size() - 1)));
    ...
    private StringView getCursorLineView(int i) {
        ...
        return this.displayLines.get(Mth.clamp((int)(j + i), (int)0, (int)(this.displayLines.size() - 1)));
    }
    ...
    public StringView getNextWord() {
        ...
        for (i = Mth.clamp((int)this.cursor, (int)0, (int)(this.value.length() - 1)); i < this.value.length() && !Character.isWhitespace(this.value.charAt(i)); ++i) {
        }
    ...
    private String truncateFullText(String string) {
        if (this.hasCharacterLimit()) {
            return StringUtil.truncateStringIfNecessary((String)string, (int)this.characterLimit, (boolean)false);
        }
        return string;
    }
    ...
    private String truncateInsertionText(String string) {
        ...
        if (this.hasCharacterLimit()) {
            ...
            string2 = StringUtil.truncateStringIfNecessary((String)string, (int)i, (boolean)false);
        }
        return string2;
    }

    private boolean overflowsLineLimit(String string) {
        return this.hasLineLimit() && this.font.getSplitter().splitLines(string, this.width, Style.EMPTY).size() + (StringUtil.endsWithNewLine((String)string) ? 1 : 0) > this.lineLimit;
    }
