    ...
    extends AbstractEntry {
        ...
        public static Entry small(AbstractWidget abstractWidget, @Nullable AbstractWidget abstractWidget2, Screen screen) {
            if (abstractWidget2 == null) {
                return new Entry(List.of(new OptionInstanceWidget(abstractWidget)), screen);
            }
            return new Entry(List.of(new OptionInstanceWidget(abstractWidget), new OptionInstanceWidget(abstractWidget2)), screen);
        }
        ...
        public static Entry small(AbstractWidget abstractWidget, OptionInstance<?> optionInstance, @Nullable AbstractWidget abstractWidget2, Screen screen) {
            if (abstractWidget2 == null) {
                return new Entry(List.of(new OptionInstanceWidget(abstractWidget, optionInstance)), screen);
            }
            return new Entry(List.of(new OptionInstanceWidget(abstractWidget, optionInstance), new OptionInstanceWidget(abstractWidget2)), screen);
        }
        ...
        public static Entry small(Options options, OptionInstance<?> optionInstance, @Nullable OptionInstance<?> optionInstance2, OptionsSubScreen optionsSubScreen) {
            ...
            if (optionInstance2 == null) {
                return new Entry(List.of(new OptionInstanceWidget(abstractWidget, optionInstance)), optionsSubScreen);
            }
            return new Entry(List.of(new OptionInstanceWidget(abstractWidget, optionInstance), new OptionInstanceWidget(optionInstance2.createButton(options), optionInstance2)), optionsSubScreen);
        }
