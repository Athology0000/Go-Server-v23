...
extends AbstractStringWidget {
    ...
    public void visitLines(ActiveTextCollector activeTextCollector) {
        ...
        int j = font.width((FormattedText)component);
        int k = this.getX();
    ...
    public static FormattedCharSequence clipText(Component component, Font font, int i) {
        FormattedText formattedText = font.substrByWidth((FormattedText)component, i - font.width((FormattedText)CommonComponents.ELLIPSIS));
