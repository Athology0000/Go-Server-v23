...
implements DebugScreenEntry {
    ...
    public void display(DebugScreenDisplayer debugScreenDisplayer, @Nullable Level level, @Nullable LevelChunk levelChunk, @Nullable LevelChunk levelChunk2) {
        ...
        long o = m - n;
        debugScreenDisplayer.addToGroup(GROUP, List.of(String.format(Locale.ROOT, "Mem: %2d%% %03d/%03dMB", o * 100L / l, DebugEntryMemory.bytesToMegabytes(o), DebugEntryMemory.bytesToMegabytes(l)), String.format(Locale.ROOT, "Allocation rate: %03dMB/s", DebugEntryMemory.bytesToMegabytes(this.allocationRateCalculator.bytesAllocatedPerSecond(o))), String.format(Locale.ROOT, "Allocated: %2d%% %03dMB", m * 100L / l, DebugEntryMemory.bytesToMegabytes(m))));
    }
