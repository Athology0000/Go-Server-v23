...
public class DebugScreenEntryList {
    ...
    public void load() {
        try {
            ...
            Dynamic dynamic = new Dynamic((DynamicOps)JsonOps.INSTANCE, (Object)StrictJsonParser.parse((String)FileUtils.readFileToString((File)this.debugProfileFile, (Charset)StandardCharsets.UTF_8)));
            SerializedOptions serializedOptions = (SerializedOptions)this.codec.parse(dynamic).getOrThrow(string -> new IOException("Could not parse debug profile JSON: " + string));
    ...
    public void loadProfile(DebugScreenProfile debugScreenProfile) {
        ...
        Map<Identifier, DebugScreenEntryStatus> map = DebugScreenEntries.PROFILES.get((Object)debugScreenProfile);
    ...
    private void loadDefaultProfile() {
        ...
        this.allStatuses = new HashMap<Identifier, DebugScreenEntryStatus>(DebugScreenEntries.PROFILES.get((Object)DebugScreenProfile.DEFAULT));
    }
    ...
    public boolean toggleStatus(Identifier identifier) {
        ...
        int n = 0;
        switch (SwitchBootstraps.enumSwitch("enumSwitch", new Object[]{"ALWAYS_ON", "IN_OVERLAY", "NEVER"}, (DebugScreenEntryStatus)debugScreenEntryStatus2, n)) {
            case 0: {
