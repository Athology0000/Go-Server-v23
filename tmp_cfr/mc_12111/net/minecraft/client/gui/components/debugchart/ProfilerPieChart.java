...
public class ProfilerPieChart {
    ...
    public void render(GuiGraphics guiGraphics) {
        ...
        String string = ProfileResults.demanglePath((String)resultField.name);
        Object string2 = "";
    ...
    public void profilerPieChartKeyPress(int i) {
        ...
        } else if (--i < list.size() && !"unspecified".equals(((ResultField)list.get((int)i)).name)) {
            if (!this.profilerTreePath.isEmpty()) {
                this.profilerTreePath = this.profilerTreePath + "\u001e";
            }
            this.profilerTreePath = this.profilerTreePath + ((ResultField)list.get((int)i)).name;
        }
    }
}
