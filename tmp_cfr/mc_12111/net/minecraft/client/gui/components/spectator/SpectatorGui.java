...
implements SpectatorMenuListener {
    ...
    private float getHotbarAlpha() {
        ...
        return Mth.clamp((float)((float)l / 2000.0f), (float)0.0f, (float)1.0f);
    }
    ...
    public void renderHotbar(GuiGraphics guiGraphics) {
        ...
        int j = Mth.floor((float)((float)guiGraphics.guiHeight() - 22.0f * f));
    ...
    private void renderSlot(GuiGraphics guiGraphics, int i, int j, float f, float g, SpectatorMenuItem spectatorMenuItem) {
        if (spectatorMenuItem != SpectatorMenu.EMPTY_SLOT) {
            ...
            if (g > 0.0f && spectatorMenuItem.isEnabled()) {
                ...
                guiGraphics.drawString(this.minecraft.font, component, j + 19 - 2 - this.minecraft.font.width((FormattedText)component), (int)f + 6 + 3, ARGB.white((float)g));
            }
        }
    }
    ...
    public void renderAction(GuiGraphics guiGraphics) {
        ...
        if (f > 0.0f && this.menu != null) {
            ...
            guiGraphics.drawStringWithBackdrop(this.minecraft.font, component, j, k, i, ARGB.white((float)f));
        }
    }
