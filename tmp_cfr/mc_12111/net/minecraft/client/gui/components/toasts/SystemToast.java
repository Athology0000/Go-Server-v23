...
implements Toast {
    ...
    public SystemToast(SystemToastId systemToastId, Component component, @Nullable Component component2) {
        this(systemToastId, component, (List<FormattedCharSequence>)SystemToast.nullToEmpty(component2), Math.max(160, 30 + Math.max(Minecraft.getInstance().font.width((FormattedText)component), component2 == null ? 0 : Minecraft.getInstance().font.width((FormattedText)component2))));
    }
    ...
    public static SystemToast multiline(Minecraft minecraft, SystemToastId systemToastId, Component component, Component component2) {
        ...
        List<FormattedCharSequence> list = font.split((FormattedText)component2, 200);
    ...
    public static void onWorldAccessFailure(Minecraft minecraft, String string) {
        SystemToast.add(minecraft.getToastManager(), SystemToastId.WORLD_ACCESS_FAILURE, (Component)Component.translatable((String)"selectWorld.access_failure"), (Component)Component.literal((String)string));
    }

    public static void onWorldDeleteFailure(Minecraft minecraft, String string) {
        SystemToast.add(minecraft.getToastManager(), SystemToastId.WORLD_ACCESS_FAILURE, (Component)Component.translatable((String)"selectWorld.delete_failure"), (Component)Component.literal((String)string));
    }

    public static void onPackCopyFailure(Minecraft minecraft, String string) {
        SystemToast.add(minecraft.getToastManager(), SystemToastId.PACK_COPY_FAILURE, (Component)Component.translatable((String)"pack.copyFailure"), (Component)Component.literal((String)string));
    }

    public static void onFileDropFailure(Minecraft minecraft, int i) {
        SystemToast.add(minecraft.getToastManager(), SystemToastId.FILE_DROP_FAILURE, (Component)Component.translatable((String)"gui.fileDropFailure.title"), (Component)Component.translatable((String)"gui.fileDropFailure.detail", (Object[])new Object[]{i}));
    }

    public static void onLowDiskSpace(Minecraft minecraft) {
        SystemToast.addOrUpdate(minecraft.getToastManager(), SystemToastId.LOW_DISK_SPACE, (Component)Component.translatable((String)"chunk.toast.lowDiskSpace"), (Component)Component.translatable((String)"chunk.toast.lowDiskSpace.description"));
    }

    public static void onChunkLoadFailure(Minecraft minecraft, ChunkPos chunkPos) {
        SystemToast.addOrUpdate(minecraft.getToastManager(), SystemToastId.CHUNK_LOAD_FAILURE, (Component)Component.translatable((String)"chunk.toast.loadFailure", (Object[])new Object[]{Component.translationArg((ChunkPos)chunkPos)}).withStyle(ChatFormatting.RED), (Component)Component.translatable((String)"chunk.toast.checkLog"));
    }

    public static void onChunkSaveFailure(Minecraft minecraft, ChunkPos chunkPos) {
        SystemToast.addOrUpdate(minecraft.getToastManager(), SystemToastId.CHUNK_SAVE_FAILURE, (Component)Component.translatable((String)"chunk.toast.saveFailure", (Object[])new Object[]{Component.translationArg((ChunkPos)chunkPos)}).withStyle(ChatFormatting.RED), (Component)Component.translatable((String)"chunk.toast.checkLog"));
    }
