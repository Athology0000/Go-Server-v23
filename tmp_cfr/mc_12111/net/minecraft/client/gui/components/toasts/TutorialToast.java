...
implements Toast {
    ...
    public TutorialToast(Font font, Icons icons, Component component, @Nullable Component component2, boolean bl, int i) {
        ...
        this.lines.addAll(font.split((FormattedText)component.copy().withColor(-11534256), 126));
        if (component2 != null) {
            this.lines.addAll(font.split((FormattedText)component2, 126));
        }
    ...
    public void update(ToastManager toastManager, long l) {
        if (this.timeToDisplayMs > 0) {
            ...
            this.smoothedProgress = Mth.clampedLerp((float)((float)(l - this.lastSmoothingTime) / 100.0f), (float)this.smoothedProgress, (float)this.progress);
            this.lastSmoothingTime = l;
        }
    }
