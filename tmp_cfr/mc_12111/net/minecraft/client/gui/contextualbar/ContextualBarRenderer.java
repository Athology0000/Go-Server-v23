...
public interface ContextualBarRenderer {
    ...
    public static void renderExperienceLevel(GuiGraphics guiGraphics, Font font, int i) {
        MutableComponent component = Component.translatable((String)"gui.experience.level", (Object[])new Object[]{i});
        int j = (guiGraphics.guiWidth() - font.width((FormattedText)component)) / 2;
        int k = guiGraphics.guiHeight() - 24 - font.lineHeight - 2;
        guiGraphics.drawString(font, (Component)component, j + 1, k, -16777216, false);
        guiGraphics.drawString(font, (Component)component, j - 1, k, -16777216, false);
        guiGraphics.drawString(font, (Component)component, j, k + 1, -16777216, false);
        guiGraphics.drawString(font, (Component)component, j, k - 1, -16777216, false);
        guiGraphics.drawString(font, (Component)component, j, k, -8323296, false);
    }
}
