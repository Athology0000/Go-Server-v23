...
public class TextFieldHelper {
    ...
    private int clampToMsgLength(int i) {
        return Mth.clamp((int)i, (int)0, (int)this.getMessageFn.get().length());
    }
    ...
    private void insertText(String string, String string2) {
        ...
        this.cursorPos = Mth.clamp((int)this.cursorPos, (int)0, (int)string.length());
    ...
    public void moveByChars(int i, boolean bl) {
        this.cursorPos = Util.offsetByCodepoints((String)this.getMessageFn.get(), (int)this.cursorPos, (int)i);
    ...
    public void removeCharsFromCursor(int i) {
        ...
        if (!string.isEmpty()) {
            ...
            if (this.selectionPos != this.cursorPos) {
                ...
                int j = Util.offsetByCodepoints((String)string, (int)this.cursorPos, (int)i);
    ...
    public void setSelectionRange(int i, int j) {
        ...
        this.cursorPos = Mth.clamp((int)i, (int)0, (int)k);
        this.selectionPos = Mth.clamp((int)j, (int)0, (int)k);
    }
