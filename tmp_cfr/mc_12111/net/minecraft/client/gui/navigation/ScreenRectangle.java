...
public record ScreenRectangle(ScreenPosition position, int width, int height) {
    ...
    public ScreenRectangle transformAxisAligned(Matrix3x2fc matrix3x2fc) {
        ...
        return new ScreenRectangle(Mth.floor((float)vector2f.x), Mth.floor((float)vector2f.y), Mth.floor((float)(vector2f2.x - vector2f.x)), Mth.floor((float)(vector2f2.y - vector2f.y)));
    }
    ...
    public ScreenRectangle transformMaxBounds(Matrix3x2fc matrix3x2fc) {
        ...
        return new ScreenRectangle(Mth.floor((float)f), Mth.floor((float)h), Mth.ceil((float)(g - f)), Mth.ceil((float)(i - h)));
    }
}
