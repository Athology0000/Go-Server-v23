...
extends ConfirmScreen {
    ...
    public ConfirmLinkScreen(BooleanConsumer booleanConsumer, String string, boolean bl) {
        this(booleanConsumer, (Component)ConfirmLinkScreen.confirmMessage(bl), (Component)Component.literal((String)string), string, bl ? CommonComponents.GUI_CANCEL : CommonComponents.GUI_NO, bl);
    }
    ...
    protected static MutableComponent confirmMessage(boolean bl, String string) {
        return ConfirmLinkScreen.confirmMessage(bl).append(CommonComponents.SPACE).append((Component)Component.literal((String)string));
    }

    protected static MutableComponent confirmMessage(boolean bl) {
        return Component.translatable((String)(bl ? "chat.link.confirmTrusted" : "chat.link.confirm"));
    }
