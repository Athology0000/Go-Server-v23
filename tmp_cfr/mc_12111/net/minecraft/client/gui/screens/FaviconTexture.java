...
implements AutoCloseable {
    ...
    public static FaviconTexture forWorld(TextureManager textureManager, String string) {
        return new FaviconTexture(textureManager, Identifier.withDefaultNamespace((String)("worlds/" + Util.sanitizeName((String)string, Identifier::validPathChar) + "/" + String.valueOf(Hashing.sha1().hashUnencodedChars((CharSequence)string)) + "/icon")));
    }

    public static FaviconTexture forServer(TextureManager textureManager, String string) {
        return new FaviconTexture(textureManager, Identifier.withDefaultNamespace((String)("servers/" + String.valueOf(Hashing.sha1().hashUnencodedChars((CharSequence)string)) + "/icon")));
    }
