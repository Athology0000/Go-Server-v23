...
extends Overlay {
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        if (g >= 1.0f) {
            ...
            n = Mth.ceil((float)((1.0f - Mth.clamp((float)(g - 1.0f), (float)0.0f, (float)1.0f)) * 255.0f));
            guiGraphics.nextStratum();
            guiGraphics.fill(0, 0, k, l, LoadingOverlay.replaceAlpha(BRAND_BACKGROUND.getAsInt(), n));
            o = 1.0f - Mth.clamp((float)(g - 1.0f), (float)0.0f, (float)1.0f);
        } else if (this.fadeIn) {
            ...
            n = Mth.ceil((double)(Mth.clamp((double)h, (double)0.15, (double)1.0) * 255.0));
            guiGraphics.nextStratum();
            guiGraphics.fill(0, 0, k, l, LoadingOverlay.replaceAlpha(BRAND_BACKGROUND.getAsInt(), n));
            o = Mth.clamp((float)h, (float)0.0f, (float)1.0f);
        } else {
        ...
        this.currentProgress = Mth.clamp((float)(this.currentProgress * 0.95f + u * 0.050000012f), (float)0.0f, (float)1.0f);
        if (g < 1.0f) {
            this.drawProgressBar(guiGraphics, k / 2 - r, t - 5, k / 2 + r, t + 5, 1.0f - Mth.clamp((float)g, (float)0.0f, (float)1.0f));
        }
        if (g >= 2.0f) {
    ...
    private void drawProgressBar(GuiGraphics guiGraphics, int i, int j, int k, int l, float f) {
        int m = Mth.ceil((float)((float)(k - i - 2) * this.currentProgress));
        int n = Math.round(f * 255.0f);
        int o = ARGB.color((int)n, (int)255, (int)255, (int)255);
