...
public class AdvancementTab {
    ...
    public void drawContents(GuiGraphics guiGraphics, int i, int j) {
        ...
        int k = Mth.floor((double)this.scrollX);
        int l = Mth.floor((double)this.scrollY);
        int m = k % 16;
        int n = l % 16;
        for (int o = -1; o <= 15; ++o) {
            for (int p = -1; p <= 8; ++p) {
    ...
    public void drawTooltips(GuiGraphics guiGraphics, int i, int j, int k, int l) {
        guiGraphics.fill(0, 0, 234, 113, Mth.floor((float)(this.fade * 255.0f)) << 24);
        boolean bl = false;
        int m = Mth.floor((double)this.scrollX);
        int n = Mth.floor((double)this.scrollY);
        ...
        this.fade = bl ? Mth.clamp((float)(this.fade + 0.02f), (float)0.0f, (float)0.3f) : Mth.clamp((float)(this.fade - 0.04f), (float)0.0f, (float)1.0f);
    }
    ...
    public void scroll(double d, double e) {
        if (this.canScrollHorizontally()) {
            this.scrollX = Mth.clamp((double)(this.scrollX + d), (double)(-(this.maxX - 234)), (double)0.0);
        }
        if (this.canScrollVertically()) {
            this.scrollY = Mth.clamp((double)(this.scrollY + e), (double)(-(this.maxY - 113)), (double)0.0);
        }
    }
