...
extends Screen {
    ...
    static final Component ENABLED_TEXT = Component.translatable((String)"debug.entry.always");
    static final Component IN_OVERLAY_TEXT = Component.translatable((String)"debug.entry.overlay");
    static final Component DISABLED_TEXT = CommonComponents.OPTION_OFF;
    static final Component NOT_ALLOWED_TOOLTIP = Component.translatable((String)"debug.options.notAllowed.tooltip");
    ...
    private void addProfileButton(DebugScreenProfile debugScreenProfile, LinearLayout linearLayout) {
        Button button2 = Button.builder((Component)Component.translatable((String)debugScreenProfile.translationKey()), button -> {
    ...
    extends AbstractOptionEntry {
        ...
        private MutableComponent narrateButton(CycleButton<Boolean> cycleButton) {
            ...
            MutableComponent mutableComponent = Component.translatable((String)("debug.entry.currently." + debugScreenEntryStatus.getSerializedName()), (Object[])new Object[]{this.name});
            return CommonComponents.optionNameValue((Component)mutableComponent, (Component)cycleButton.getMessage());
        }
