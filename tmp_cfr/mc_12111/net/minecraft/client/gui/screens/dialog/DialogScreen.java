...
extends Screen {
    ...
    private Button createWarningButton() {
        ImageButton imageButton = new ImageButton(0, 0, 20, 20, WARNING_BUTTON_SPRITES, button -> this.minecraft.setScreen(WarningScreen.create(this.minecraft, this.connectionAccess, this)), (Component)Component.translatable((String)"menu.custom_screen_info.button_narration"));
        imageButton.setTooltip(Tooltip.create((Component)Component.translatable((String)"menu.custom_screen_info.tooltip")));
        return imageButton;
    }
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ClickEvent.RunCommand.class, ClickEvent.ShowDialog.class, ClickEvent.Custom.class}, (Object)clickEvent3, n)) {
            case 0: {
                ...
                try {
                    ...
                    this.connectionAccess.runCommand(Commands.trimOptionalPrefix((String)string2), screen);
                    return;
                }
            ...
            case 1: {
                ...
                this.connectionAccess.openDialog((Holder<Dialog>)showDialog.dialog(), screen);
                return;
            }
            case 2: {
