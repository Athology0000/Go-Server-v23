...
implements MenuAccess<T> {
    ...
    public void renderCarriedItem(GuiGraphics guiGraphics, int i, int j) {
        ItemStack itemStack;
        ItemStack itemStack2 = itemStack = this.draggingItem.isEmpty() ? this.menu.getCarried() : this.draggingItem;
    ...
    public void renderSnapbackItem(GuiGraphics guiGraphics) {
        if (this.snapbackData != null) {
            float f = Mth.clamp((float)((float)(Util.getMillis() - this.snapbackData.time) / 100.0f), (float)0.0f, (float)1.0f);
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int i, int j) {
        ...
        if (this.menu.getCarried().isEmpty() || this.showTooltipWithItemInHand(itemStack)) {
            guiGraphics.setTooltipForNextFrame(this.font, this.getTooltipFromContainerItem(itemStack), itemStack.getTooltipImage(), i, j, (Identifier)itemStack.get(DataComponents.TOOLTIP_STYLE));
        }
    }
    ...
    protected void renderSlot(GuiGraphics guiGraphics, Slot slot, int i, int j) {
        ...
        if (slot == this.clickedSlot && !this.draggingItem.isEmpty() && this.isSplittingStack && !itemStack.isEmpty()) {
            ...
            if (AbstractContainerMenu.canItemQuickReplace((Slot)slot, (ItemStack)itemStack2, (boolean)true) && this.menu.canDragTo(slot)) {
                ...
                int o = AbstractContainerMenu.getQuickCraftPlaceCount(this.quickCraftSlots, (int)this.quickCraftingType, (ItemStack)itemStack2) + n;
                if (o > m) {
                    o = m;
    ...
    private void recalculateQuickCraftRemaining() {
        ...
        for (Slot slot : this.quickCraftSlots) {
            ...
            int k = Math.min(AbstractContainerMenu.getQuickCraftPlaceCount(this.quickCraftSlots, (int)this.quickCraftingType, (ItemStack)itemStack) + i, j);
    ...
    public boolean mouseClicked(MouseButtonEvent mouseButtonEvent, boolean bl) {
        ...
        if (mouseButtonEvent.button() == 0 || mouseButtonEvent.button() == 1 || bl2) {
            ...
            if (this.minecraft.options.touchscreen().get().booleanValue() && bl3 && this.menu.getCarried().isEmpty()) {
                this.onClose();
                return true;
            }
            if (k != -1) {
    ...
    public boolean mouseDragged(MouseButtonEvent mouseButtonEvent, double d, double e) {
        ...
        if (this.clickedSlot != null && this.minecraft.options.touchscreen().get().booleanValue()) {
            if (mouseButtonEvent.button() == 0 || mouseButtonEvent.button() == 1) {
                ...
                } else if (this.draggingItem.getCount() > 1 && slot != null && AbstractContainerMenu.canItemQuickReplace((Slot)slot, (ItemStack)this.draggingItem, (boolean)false)) {
        ...
        if (this.isQuickCrafting && slot != null && !itemStack.isEmpty() && (itemStack.getCount() > this.quickCraftSlots.size() || this.quickCraftingType == 2) && AbstractContainerMenu.canItemQuickReplace((Slot)slot, (ItemStack)itemStack, (boolean)true) && slot.mayPlace(itemStack) && this.menu.canDragTo(slot)) {
        ...
        if (this.doubleclick && slot != null && mouseButtonEvent.button() == 0 && this.menu.canTakeItemForPickAll(ItemStack.EMPTY, slot)) {
            if (mouseButtonEvent.hasShiftDown()) {
                if (!this.lastQuickMoved.isEmpty()) {
                    for (Slot slot2 : ((AbstractContainerMenu)this.menu).slots) {
                        if (slot2 == null || !slot2.mayPickup((Player)this.minecraft.player) || !slot2.hasItem() || slot2.container != slot.container || !AbstractContainerMenu.canItemQuickReplace((Slot)slot2, (ItemStack)this.lastQuickMoved, (boolean)true)) continue;
            ...
            if (this.clickedSlot != null && this.minecraft.options.touchscreen().get().booleanValue()) {
                if (mouseButtonEvent.button() == 0 || mouseButtonEvent.button() == 1) {
                    ...
                    boolean bl2 = AbstractContainerMenu.canItemQuickReplace((Slot)slot, (ItemStack)this.draggingItem, (boolean)false);
                ...
                for (Slot slot2 : this.quickCraftSlots) {
                    this.slotClicked(slot2, slot2.index, AbstractContainerMenu.getQuickcraftMask((int)1, (int)this.quickCraftingType), ClickType.QUICK_CRAFT);
                }
