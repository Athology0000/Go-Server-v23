...
extends AbstractCommandBlockEditScreen {
    ...
    protected void addExtraControls() {
        ...
        }, this.mode).withValues((CommandBlockEntity.Mode[])CommandBlockEntity.Mode.values()).displayOnlyValue().create(this.width / 2 - 50 - 100 - 4, 165, 100, 20, (Component)Component.translatable((String)"advMode.mode"), (cycleButton, mode) -> {
            this.mode = mode;
        }));
        ...
        this.autoexecButton = this.addRenderableWidget(CycleButton.booleanBuilder((Component)Component.translatable((String)"advMode.mode.autoexec.bat"), (Component)Component.translatable((String)"advMode.mode.redstoneTriggered"), this.autoexec).displayOnlyValue().create(this.width / 2 + 50 + 4, 165, 100, 20, (Component)Component.translatable((String)"advMode.triggering"), (cycleButton, boolean_) -> {
