...
public class EnchantmentNames {
    ...
    public FormattedText getRandomName(Font font, int i) {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            stringBuilder.append((String)Util.getRandom((Object[])this.words, (RandomSource)this.random));
        }
        return font.getSplitter().headByWidth((FormattedText)Component.literal((String)stringBuilder.toString()).withStyle(ROOT_STYLE), i, Style.EMPTY);
    }
