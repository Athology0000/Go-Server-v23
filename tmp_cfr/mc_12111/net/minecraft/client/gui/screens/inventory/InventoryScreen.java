...
extends AbstractRecipeBookScreen<InventoryMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
        ...
        InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, k + 26, l + 8, k + 75, l + 78, 30, 0.0625f, this.xMouse, this.yMouse, (LivingEntity)this.minecraft.player);
    }
