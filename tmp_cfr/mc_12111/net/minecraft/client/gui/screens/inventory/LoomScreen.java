...
extends AbstractContainerScreen<LoomMenu> {
        ...
        if (this.displayPatterns) {
            ...
            block0: for (int s = 0; s < 4; ++s) {
                for (int t = 0; t < 4; ++t) {
                    ...
                    int w = r + t * 14;
                    int x = p + s * 14;
                    Holder holder = (Holder)list.get(v);
                    ...
                    if (v == ((LoomMenu)this.menu).getSelectedBannerPatternIndex()) {
                        ...
                        guiGraphics.setTooltipForNextFrame((Component)Component.translatable((String)(((BannerPattern)holder.value()).translationKey() + "." + dyeColor2.getName())), i, j);
                        guiGraphics.requestCursor(CursorTypes.POINTING_HAND);
                    } else {
                        identifier2 = PATTERN_SPRITE;
                    }
                    guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, identifier2, w, x, 14, 14);
                    TextureAtlasSprite textureAtlasSprite = guiGraphics.getSprite(Sheets.getBannerMaterial((Holder<BannerPattern>)holder));
        ...
        if (this.displayPatterns) {
            ...
            for (int k = 0; k < 4; ++k) {
                for (int l = 0; l < 4; ++l) {
                    ...
                    int n = m * 4 + l;
                    if (!(d >= 0.0) || !(e >= 0.0) || !(d < 14.0) || !(e < 14.0) || !((LoomMenu)this.menu).clickMenuButton((Player)this.minecraft.player, n)) continue;
    ...
    public boolean mouseScrolled(double d, double e, double f, double g) {
        ...
        if (this.displayPatterns && i > 0) {
            ...
            this.scrollOffs = Mth.clamp((float)(this.scrollOffs - h), (float)0.0f, (float)1.0f);
    ...
    private void containerChanged() {
        ...
        this.resultBannerPatterns = itemStack.isEmpty() ? null : (BannerPatternLayers)itemStack.getOrDefault(DataComponents.BANNER_PATTERNS, (Object)BannerPatternLayers.EMPTY);
        ...
        BannerPatternLayers bannerPatternLayers = (BannerPatternLayers)itemStack2.getOrDefault(DataComponents.BANNER_PATTERNS, (Object)BannerPatternLayers.EMPTY);
        boolean bl = this.hasMaxPatterns = bannerPatternLayers.layers().size() >= 6;
        if (this.hasMaxPatterns) {
            this.resultBannerPatterns = null;
        }
        if (!(ItemStack.matches((ItemStack)itemStack2, (ItemStack)this.bannerStack) && ItemStack.matches((ItemStack)itemStack3, (ItemStack)this.dyeStack) && ItemStack.matches((ItemStack)itemStack4, (ItemStack)this.patternStack))) {
