...
extends AbstractContainerScreen<StonecutterMenu> {
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int i, int j) {
        ...
        if (this.displayRecipes) {
            ...
            SelectableRecipe.SingleInputSet singleInputSet = ((StonecutterMenu)this.menu).getVisibleRecipes();
    ...
    public boolean mouseClicked(MouseButtonEvent mouseButtonEvent, boolean bl) {
        if (this.displayRecipes) {
            ...
            for (int l = this.startIndex; l < k; ++l) {
                ...
                if (!(d >= 0.0) || !(e >= 0.0) || !(d < 16.0) || !(e < 18.0) || !((StonecutterMenu)this.menu).clickMenuButton((Player)this.minecraft.player, l)) continue;
