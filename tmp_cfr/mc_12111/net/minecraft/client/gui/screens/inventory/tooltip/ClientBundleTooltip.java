...
implements ClientTooltipComponent {
    ...
    private void drawSelectedItemTooltip(Font font, GuiGraphics guiGraphics, int i, int j, int k) {
        if (this.contents.hasSelectedItem()) {
            ...
            guiGraphics.renderTooltip(font, List.of(clientTooltipComponent), m - l / 2, j - 15, DefaultTooltipPositioner.INSTANCE, (Identifier)itemStack.get(DataComponents.TOOLTIP_STYLE));
        }
    }
    ...
    private static void drawEmptyBundleDescriptionText(int i, int j, Font font, GuiGraphics guiGraphics) {
        guiGraphics.drawWordWrap(font, (FormattedText)BUNDLE_EMPTY_DESCRIPTION, i, j, 96, -5592406);
    }
    ...
    private int getProgressBarFill() {
        return Mth.clamp((int)Mth.mulAndTruncate((Fraction)this.contents.weight(), (int)94), (int)0, (int)94);
    }
