...
extends Screen {
    ...
    protected void init() {
        ...
        this.selectButton = linearLayout2.addChild(Button.builder((Component)Component.translatable((String)"selectServer.select"), button -> {
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry != null) {
                entry.join();
            }
        }).width(100).build());
        linearLayout2.addChild(Button.builder((Component)Component.translatable((String)"selectServer.direct"), button -> {
        ...
        linearLayout2.addChild(Button.builder((Component)Component.translatable((String)"selectServer.add"), button -> {
            this.editingServer = new ServerData("", "", ServerData.Type.OTHER);
            this.minecraft.setScreen(new ManageServerScreen(this, (Component)Component.translatable((String)"manageServer.add.title"), this::addServerCallback, this.editingServer));
        }).width(100).build());
        this.editButton = linearLayout3.addChild(Button.builder((Component)Component.translatable((String)"selectServer.edit"), button -> {
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry instanceof ServerSelectionList.OnlineServerEntry) {
                ...
                this.minecraft.setScreen(new ManageServerScreen(this, (Component)Component.translatable((String)"manageServer.edit.title"), this::editServerCallback, this.editingServer));
            }
        }).width(74).build());
        this.deleteButton = linearLayout3.addChild(Button.builder((Component)Component.translatable((String)"selectServer.delete"), button -> {
            String string;
            ServerSelectionList.Entry entry = (ServerSelectionList.Entry)this.serverSelectionList.getSelected();
            if (entry instanceof ServerSelectionList.OnlineServerEntry && (string = ((ServerSelectionList.OnlineServerEntry)entry).getServerData().name) != null) {
                MutableComponent component = Component.translatable((String)"selectServer.deleteQuestion");
                MutableComponent component2 = Component.translatable((String)"selectServer.deleteWarning", (Object[])new Object[]{string});
                MutableComponent component3 = Component.translatable((String)"selectServer.deleteButton");
                Component component4 = CommonComponents.GUI_CANCEL;
                this.minecraft.setScreen(new ConfirmScreen(this::deleteCallback, (Component)component, (Component)component2, (Component)component3, component4));
            }
        }).width(74).build());
        linearLayout3.addChild(Button.builder((Component)Component.translatable((String)"selectServer.refresh"), button -> this.refreshServerList()).width(74).build());
