...
extends OptionsSubScreen {
    ...
    protected void init() {
        ...
        if (abstractWidget != null && !this.minecraft.getResourcePackRepository().getAvailableIds().contains("high_contrast")) {
            ...
            abstractWidget.setTooltip(Tooltip.create((Component)Component.translatable((String)"options.accessibility.high_contrast.error.tooltip")));
        }
    ...
    protected void addFooter() {
        ...
        linearLayout.addChild(Button.builder((Component)Component.translatable((String)"options.accessibility.link"), ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.ACCESSIBILITY_HELP)).build());
