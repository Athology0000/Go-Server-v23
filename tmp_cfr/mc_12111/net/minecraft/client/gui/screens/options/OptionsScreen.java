...
extends Screen {
    ...
    protected void init() {
        ...
        rowHelper.addChild(this.openScreenButton(RESOURCEPACK, () -> new PackSelectionScreen(this.minecraft.getResourcePackRepository(), this::applyPacks, this.minecraft.getResourcePackDirectory(), (Component)Component.translatable((String)"resourcePack.title"))));
    ...
    private LayoutElement createOnlineButton() {
        if (this.minecraft.level != null && this.minecraft.hasSingleplayerServer()) {
            ...
            if (!this.minecraft.level.getLevelData().isHardcore()) {
                this.lockButton = new LockIconButton(0, 0, button -> this.minecraft.setScreen(new ConfirmScreen(this::lockCallback, (Component)Component.translatable((String)"difficulty.lock.title"), (Component)Component.translatable((String)"difficulty.lock.question", (Object[])new Object[]{this.minecraft.level.getLevelData().getDifficulty().getDisplayName()}))));
        ...
        return Button.builder((Component)Component.translatable((String)"options.online"), button -> this.minecraft.setScreen(new OnlineOptionsScreen(this, this.options))).bounds(this.width / 2 + 5, this.height / 6 - 12 + 24, 150, 20).build();
    }

    public static CycleButton<Difficulty> createDifficultyButton(int i, int j, String string, Minecraft minecraft) {
        return CycleButton.builder(Difficulty::getDisplayName, minecraft.level.getDifficulty()).withValues((Difficulty[])Difficulty.values()).create(i, j, 150, 20, (Component)Component.translatable((String)string), (cycleButton, difficulty) -> minecraft.getConnection().send((Packet<?>)new ServerboundChangeDifficultyPacket(difficulty)));
    }
