...
extends Screen {
    ...
    protected UnsupportedGraphicsWarningScreen(Component component, List<Component> list, ImmutableList<ButtonOption> immutableList) {
        super(component);
        this.message = list;
        this.narrationMessage = CommonComponents.joinForNarration((Component[])new Component[]{component, ComponentUtils.formatList(list, (Component)CommonComponents.EMPTY)});
