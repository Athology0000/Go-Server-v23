...
extends OptionsSubScreen {
    ...
    protected void addOptions() {
        ...
        OptionInstance<Integer> optionInstance = new OptionInstance<Integer>("options.fullscreen.resolution", OptionInstance.noTooltip(), (component, integer) -> {
            ...
            if (integer == -1) {
                return Options.genericValueLabel(component, (Component)Component.translatable((String)"options.fullscreen.current"));
            }
            VideoMode videoMode = monitor.getMode((int)integer);
            return Options.genericValueLabel(component, (Component)Component.translatable((String)"options.fullscreen.entry", (Object[])new Object[]{videoMode.getWidth(), videoMode.getHeight(), videoMode.getRefreshRate(), videoMode.getRedBits() + videoMode.getGreenBits() + videoMode.getBlueBits()}));
        ...
        if (super.mouseClicked(mouseButtonEvent, bl)) {
            if (this.gpuWarnlistManager.isShowingWarning()) {
                ...
                if (string != null) {
                    ...
                    list.add(Component.translatable((String)"options.graphics.warning.renderer", (Object[])new Object[]{string}).withStyle(ChatFormatting.GRAY));
                }
                if ((string2 = this.gpuWarnlistManager.getVendorWarnings()) != null) {
                    list.add(CommonComponents.NEW_LINE);
                    list.add(Component.translatable((String)"options.graphics.warning.vendor", (Object[])new Object[]{string2}).withStyle(ChatFormatting.GRAY));
                }
                if ((string3 = this.gpuWarnlistManager.getVersionWarnings()) != null) {
                    list.add(CommonComponents.NEW_LINE);
                    list.add(Component.translatable((String)"options.graphics.warning.version", (Object[])new Object[]{string3}).withStyle(ChatFormatting.GRAY));
                }
