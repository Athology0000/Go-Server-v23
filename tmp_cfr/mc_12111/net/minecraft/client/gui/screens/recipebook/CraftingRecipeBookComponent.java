...
extends RecipeBookComponent<AbstractCraftingMenu> {
    ...
    protected void fillGhostRecipe(GhostSlots ghostSlots, RecipeDisplay recipeDisplay, ContextMap contextMap) {
        ...
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ShapedCraftingRecipeDisplay.class, ShapelessCraftingRecipeDisplay.class}, (Object)recipeDisplay3, n)) {
            case 0: {
                ShapedCraftingRecipeDisplay shapedCraftingRecipeDisplay = (ShapedCraftingRecipeDisplay)recipeDisplay3;
                List list = ((AbstractCraftingMenu)this.menu).getInputGridSlots();
                PlaceRecipeHelper.placeRecipe((int)((AbstractCraftingMenu)this.menu).getGridWidth(), (int)((AbstractCraftingMenu)this.menu).getGridHeight(), (int)shapedCraftingRecipeDisplay.width(), (int)shapedCraftingRecipeDisplay.height(), (Iterable)shapedCraftingRecipeDisplay.ingredients(), (slotDisplay, i, j, k) -> {
            ...
            case 1: {
                ShapelessCraftingRecipeDisplay shapelessCraftingRecipeDisplay = (ShapelessCraftingRecipeDisplay)recipeDisplay3;
                List list2 = ((AbstractCraftingMenu)this.menu).getInputGridSlots();
                int i2 = Math.min(shapelessCraftingRecipeDisplay.ingredients().size(), list2.size());
                for (int j2 = 0; j2 < i2; ++j2) {
                    ghostSlots.setInput((Slot)list2.get(j2), contextMap, (SlotDisplay)shapelessCraftingRecipeDisplay.ingredients().get(j2));
                }
                break;
            }
        }
