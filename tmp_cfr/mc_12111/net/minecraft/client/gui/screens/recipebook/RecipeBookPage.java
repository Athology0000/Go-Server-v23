...
public class RecipeBookPage {
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, int k, int l, float f) {
        if (this.totalPages > 1) {
            ...
            guiGraphics.drawString(this.minecraft.font, (Component)component, i - m / 2 + 73, j + 141, -1);
        }
    ...
    public void renderTooltip(GuiGraphics guiGraphics, int i, int j) {
        if (this.minecraft.screen != null && this.hoveredButton != null && !this.overlay.isVisible()) {
            ...
            Identifier identifier = (Identifier)itemStack.get(DataComponents.TOOLTIP_STYLE);
