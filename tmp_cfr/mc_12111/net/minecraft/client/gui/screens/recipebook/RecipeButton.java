...
extends AbstractWidget {
    ...
    private static boolean allRecipesHaveSameResultDisplay(List<ResolvedEntry> list) {
        ...
        while (iterator.hasNext()) {
            ...
            if (ItemStack.isSameItemSameComponents((ItemStack)itemStack, (ItemStack)itemStack2)) continue;
            return false;
        }
        return true;
    }
    ...
    public void updateWidgetNarration(NarrationElementOutput narrationElementOutput) {
        narrationElementOutput.add(NarratedElementType.TITLE, (Component)Component.translatable((String)"narration.recipe", (Object[])new Object[]{this.getDisplayStack().getHoverName()}));
        if (this.hasMultipleRecipes()) {
            narrationElementOutput.add(NarratedElementType.USAGE, new Component[]{Component.translatable((String)"narration.button.usage.hovered"), Component.translatable((String)"narration.recipe.usage.more")});
        } else {
            narrationElementOutput.add(NarratedElementType.USAGE, (Component)Component.translatable((String)"narration.button.usage.hovered"));
        }
    }
