...
extends Screen {
    ...
    private void displayReportSendError(Component component) {
        ...
        this.minecraft.setScreen(GenericWaitingScreen.createCompleted(REPORT_ERROR_TITLE, (Component)component2, CommonComponents.GUI_BACK, () -> this.minecraft.setScreen(this)));
    }
