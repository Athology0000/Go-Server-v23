...
extends Screen {
    static final Identifier CHECKMARK_SPRITE = Identifier.withDefaultNamespace((String)"icon/checkmark");
    ...
    public void render(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        MutableComponent component = Component.translatable((String)"gui.chatSelection.selected", (Object[])new Object[]{k, l});
        guiGraphics.drawCenteredString(this.font, (Component)component, this.width / 2, 26, -1);
    ...
    implements ChatSelectionLogFiller.Output {
        ...
        public void setScrollAmount(double d) {
            ...
            if ((float)this.maxScrollAmount() > 1.0E-5f && d <= (double)1.0E-5f && !Mth.equal((double)d, (double)e)) {
        ...
        extends Entry {
            ...
            public MessageEntry(int i, Component component, @Nullable Component component2, GuiMessageTag guiMessageTag, boolean bl, boolean bl2) {
                this.chatId = i;
                this.tagIcon = (GuiMessageTag.Icon)((Object)Optionull.map((Object)guiMessageTag, GuiMessageTag::icon));
                this.tagHoverText = guiMessageTag != null && guiMessageTag.text() != null ? ChatSelectionScreen.this.font.split((FormattedText)guiMessageTag.text(), ChatSelectionList.this.getRowWidth()) : null;
                this.canReport = bl;
                this.playerMessage = bl2;
                FormattedText formattedText = ChatSelectionScreen.this.font.substrByWidth((FormattedText)component, this.getMaximumTextWidth() - ChatSelectionScreen.this.font.width((FormattedText)CommonComponents.ELLIPSIS));
                if (component != formattedText) {
                    this.text = FormattedText.composite((FormattedText[])new FormattedText[]{formattedText, CommonComponents.ELLIPSIS});
                    this.hoverText = ChatSelectionScreen.this.font.split((FormattedText)component, ChatSelectionList.this.getRowWidth());
                } else {
                    this.text = component;
                    this.hoverText = null;
                }
        ...
        extends Entry {
            ...
            public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
                ...
                int m = ChatSelectionScreen.this.font.width((FormattedText)this.text);
