...
extends AbstractReportScreen<NameReport.Builder> {
    ...
    protected void addContent() {
        MutableComponent component = Component.literal((String)((NameReport)((NameReport.Builder)this.reportBuilder).report()).getReportedName()).withStyle(ChatFormatting.YELLOW);
        this.layout.addChild(new StringWidget((Component)Component.translatable((String)"gui.abuseReport.name.reporting", (Object[])new Object[]{component}), this.font), layoutSettings -> layoutSettings.alignHorizontallyCenter().padding(0, 8));
