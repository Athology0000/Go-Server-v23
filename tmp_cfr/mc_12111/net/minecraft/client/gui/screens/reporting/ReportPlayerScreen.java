...
extends Screen {
    ...
    protected void init() {
        ...
        if (!this.player.isChatReportable()) {
            ...
            button2.setTooltip(Tooltip.create((Component)Component.translatable((String)"gui.socialInteractions.tooltip.report.not_reportable")));
        } else if (!this.player.hasRecentMessages()) {
            button2.active = false;
            button2.setTooltip(Tooltip.create((Component)Component.translatable((String)"gui.socialInteractions.tooltip.report.no_messages", (Object[])new Object[]{this.player.getPlayerName()})));
        }
