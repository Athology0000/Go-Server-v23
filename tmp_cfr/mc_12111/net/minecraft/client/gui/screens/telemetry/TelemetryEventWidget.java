...
extends AbstractTextAreaWidget {
    ...
    private void addEventType(ContentBuilder contentBuilder, TelemetryEventType telemetryEventType, boolean bl) {
        ...
        contentBuilder.addHeader(this.font, this.grayOutIfDisabled((Component)Component.translatable((String)string, (Object[])new Object[]{telemetryEventType.title()}), bl));
        contentBuilder.addHeader(this.font, (Component)telemetryEventType.description().withStyle(ChatFormatting.GRAY));
    ...
    private void addEventTypeProperties(TelemetryEventType telemetryEventType, ContentBuilder contentBuilder, boolean bl) {
        for (TelemetryProperty<?> telemetryProperty : telemetryEventType.properties()) {
            contentBuilder.addLine(this.font, this.grayOutIfDisabled((Component)telemetryProperty.title(), bl));
        }
    }
