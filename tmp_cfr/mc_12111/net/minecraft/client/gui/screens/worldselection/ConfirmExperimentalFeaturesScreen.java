        ...
        extends ObjectSelectionList<PackListEntry> {
            public PackList(DetailsScreen detailsScreen, Minecraft minecraft, Collection<Pack> collection) {
                ...
                for (Pack pack : collection) {
                    String string = FeatureFlags.printMissingFlags((FeatureFlagSet)FeatureFlags.VANILLA_SET, (FeatureFlagSet)pack.getRequestedFeatures());
                    if (string.isEmpty()) continue;
                    Component component = ComponentUtils.mergeStyles((Component)pack.getTitle(), (Style)Style.EMPTY.withBold(Boolean.valueOf(true)));
                    MutableComponent component2 = Component.translatable((String)"selectWorld.experimental.details.entry", (Object[])new Object[]{string});
                    this.addEntry(detailsScreen.new PackListEntry(component, (Component)component2, MultiLineLabel.create(detailsScreen.font, (Component)component2, this.getRowWidth())));
                }
            }
