...
extends Screen {
    private static final Component TITLE = Component.translatable((String)"editGamerule.title");
        ...
        public RuleList(GameRules gameRules) {
            ...
            gameRules.visitGameRuleTypes(new GameRuleTypeVisitor(){
                ...
                public void visitBoolean(GameRule<Boolean> gameRule2) {
                    this.addEntry(gameRule2, (component, list, string, gameRule) -> new BooleanRuleEntry(component, list, string, (GameRule<Boolean>)gameRule));
                }

                public void visitInteger(GameRule<Integer> gameRule2) {
                    this.addEntry(gameRule2, (component, list, string, gameRule) -> new IntegerRuleEntry(component, list, string, (GameRule<Integer>)gameRule));
                }

                private <T> void addEntry(GameRule<T> gameRule, EntryFactory<T> entryFactory) {
                    Object string2;
                    ImmutableList list;
                    MutableComponent component = Component.translatable((String)gameRule.getDescriptionId());
                    MutableComponent component2 = Component.literal((String)gameRule.id()).withStyle(ChatFormatting.YELLOW);
                    MutableComponent component3 = Component.translatable((String)"editGamerule.default", (Object[])new Object[]{Component.literal((String)gameRule.serialize(gameRule.defaultValue()))}).withStyle(ChatFormatting.GRAY);
                    ...
                    if (I18n.exists(string)) {
                        ...
                        MutableComponent component4 = Component.translatable((String)string);
                        EditGameRulesScreen.this.font.split((FormattedText)component4, 150).forEach(arg_0 -> ((ImmutableList.Builder)builder).add(arg_0));
                    ...
                    map.computeIfAbsent(gameRule.category(), gameRuleCategory -> Maps.newHashMap()).put(gameRule, entryFactory.create((Component)component, (List<FormattedCharSequence>)list, (String)string2, gameRule));
                }
            });
            map.entrySet().stream().sorted(Map.Entry.comparingByKey(Comparator.comparing(GameRuleCategory::getDescriptionId))).forEach(entry2 -> {
                this.addEntry(new CategoryRuleEntry((Component)((GameRuleCategory)entry2.getKey()).label().withStyle(new ChatFormatting[]{ChatFormatting.BOLD, ChatFormatting.YELLOW})));
    ...
    extends GameRuleEntry {
        ...
        public IntegerRuleEntry(Component component, List<FormattedCharSequence> list, String string2, GameRule<Integer> gameRule) {
            ...
            this.input = new EditBox(((EditGameRulesScreen)EditGameRulesScreen.this).minecraft.font, 10, 5, 44, 20, (Component)component.copy().append("\n").append(string2).append("\n"));
            this.input.setValue(EditGameRulesScreen.this.gameRules.getAsString(gameRule));
            this.input.setResponder(string -> {
                DataResult dataResult = gameRule.deserialize(string);
                if (dataResult.isSuccess()) {
                    this.input.setTextColor(-2039584);
                    EditGameRulesScreen.this.clearInvalid(this);
                    EditGameRulesScreen.this.gameRules.set(gameRule, (Object)((Integer)dataResult.getOrThrow()), null);
                } else {
    ...
    extends GameRuleEntry {
        ...
        public BooleanRuleEntry(Component component, List<FormattedCharSequence> list, String string, GameRule<Boolean> gameRule) {
            super(list, component);
            this.checkbox = CycleButton.onOffBuilder((Boolean)EditGameRulesScreen.this.gameRules.get(gameRule)).displayOnlyValue().withCustomNarration(cycleButton -> cycleButton.createDefaultNarrationMessage().append("\n").append(string)).create(10, 5, 44, 20, component, (cycleButton, boolean_) -> EditGameRulesScreen.this.gameRules.set(gameRule, boolean_, null));
    ...
    extends RuleEntry {
        ...
        public GameRuleEntry(List<FormattedCharSequence> list, Component component) {
            ...
            this.label = ((EditGameRulesScreen)EditGameRulesScreen.this).minecraft.font.split((FormattedText)component, 175);
        }
