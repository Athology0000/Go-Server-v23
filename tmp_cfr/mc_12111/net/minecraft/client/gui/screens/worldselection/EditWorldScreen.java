...
extends Screen {
    ...
    private static final Component OPTIMIIZE_DESCRIPTION = Component.translatable((String)"optimizeWorld.confirm.description");
    private static final Component OPTIMIIZE_CONFIRMATION = Component.translatable((String)"optimizeWorld.confirm.proceed");
    ...
    private EditWorldScreen(Minecraft minecraft, LevelStorageSource.LevelStorageAccess levelStorageAccess, String string2, BooleanConsumer booleanConsumer) {
        ...
        this.nameEdit.setResponder(string -> {
            button.active = !StringUtil.isBlank((String)string);
        });
    ...
    public static boolean makeBackupAndShowToast(LevelStorageSource.LevelStorageAccess levelStorageAccess) {
        ...
        if (iOException != null) {
            MutableComponent component = Component.translatable((String)"selectWorld.edit.backupFailed");
            MutableComponent component2 = Component.literal((String)iOException.getMessage());
            Minecraft.getInstance().getToastManager().addToast(new SystemToast(SystemToast.SystemToastId.WORLD_BACKUP, (Component)component, (Component)component2));
            return false;
        }
        MutableComponent component = Component.translatable((String)"selectWorld.edit.backupCreated", (Object[])new Object[]{levelStorageAccess.getLevelId()});
        MutableComponent component2 = Component.translatable((String)"selectWorld.edit.backupSize", (Object[])new Object[]{Mth.ceil((double)((double)l / 1048576.0))});
        Minecraft.getInstance().getToastManager().addToast(new SystemToast(SystemToast.SystemToastId.WORLD_BACKUP, (Component)component, (Component)component2));
        return true;
    }
