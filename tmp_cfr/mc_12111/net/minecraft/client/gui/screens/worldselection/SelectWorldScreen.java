...
extends Screen {
    ...
    protected void init() {
        ...
        this.searchBox = linearLayout2.addChild(new EditBox(this.font, this.width / 2 - 100, 22, 200, 20, this.searchBox, (Component)Component.translatable((String)"selectWorld.search")));
    ...
    private void createFooterButtons(Consumer<WorldSelectionList.WorldListEntry> consumer, WorldSelectionList worldSelectionList) {
        ...
        rowHelper.addChild(Button.builder((Component)Component.translatable((String)"selectWorld.create"), button -> CreateWorldScreen.openFresh(this.minecraft, worldSelectionList::returnToScreen)).build(), 2);
        this.renameButton = rowHelper.addChild(Button.builder((Component)Component.translatable((String)"selectWorld.edit"), button -> worldSelectionList.getSelectedOpt().ifPresent(WorldSelectionList.WorldListEntry::editWorld)).width(71).build());
        this.deleteButton = rowHelper.addChild(Button.builder((Component)Component.translatable((String)"selectWorld.delete"), button -> worldSelectionList.getSelectedOpt().ifPresent(WorldSelectionList.WorldListEntry::deleteWorld)).width(71).build());
        this.copyButton = rowHelper.addChild(Button.builder((Component)Component.translatable((String)"selectWorld.recreate"), button -> worldSelectionList.getSelectedOpt().ifPresent(WorldSelectionList.WorldListEntry::recreateWorld)).width(71).build());
    ...
    private Button createDebugWorldRecreateButton() {
        return Button.builder((Component)Component.literal((String)"DEBUG recreate"), button -> {
            try {
                ...
                String string2 = FileUtil.findAvailableName((Path)this.minecraft.getLevelSource().getBaseDir(), (String)"DEBUG world", (String)"");
