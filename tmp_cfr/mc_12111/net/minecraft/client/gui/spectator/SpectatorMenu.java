...
public class SpectatorMenu {
    static final Identifier CLOSE_SPRITE = Identifier.withDefaultNamespace((String)"spectator/close");
    static final Identifier SCROLL_LEFT_SPRITE = Identifier.withDefaultNamespace((String)"spectator/scroll_left");
    static final Identifier SCROLL_RIGHT_SPRITE = Identifier.withDefaultNamespace((String)"spectator/scroll_right");
    ...
    static final Component CLOSE_MENU_TEXT = Component.translatable((String)"spectatorMenu.close");
    static final Component PREVIOUS_PAGE_TEXT = Component.translatable((String)"spectatorMenu.previous_page");
    static final Component NEXT_PAGE_TEXT = Component.translatable((String)"spectatorMenu.next_page");
    ...
    implements SpectatorMenuItem {
        ...
        @Override
        public void renderIcon(GuiGraphics guiGraphics, float f, float g) {
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, CLOSE_SPRITE, 0, 0, 16, 16, ARGB.colorFromFloat((float)g, (float)f, (float)f, (float)f));
        }
    ...
    implements SpectatorMenuItem {
        ...
        @Override
        public void renderIcon(GuiGraphics guiGraphics, float f, float g) {
            int i = ARGB.colorFromFloat((float)g, (float)f, (float)f, (float)f);
            if (this.direction < 0) {
