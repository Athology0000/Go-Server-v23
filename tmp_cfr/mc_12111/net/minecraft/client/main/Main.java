...
public class Main {
    ...
    public static void main(String[] strings) {
        ...
        try {
            ...
            CompletableFuture completableFuture = DataFixers.optimize((Set)DataFixTypes.TYPES_FOR_LEVEL_LIST);
            CrashReport.preload();
            ...
            UUID uUID = Main.hasValidUuid((OptionSpec<String>)optionSpec18, optionSet, logger) ? UndashedUuid.fromStringLenient((String)((String)optionSpec18.value(optionSet))) : UUIDUtil.createOfflinePlayerUUID((String)((String)optionSpec16.value(optionSet)));
            ...
            CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)string2);
        ...
        try {
            ...
            CrashReport crashReport2 = CrashReport.forThrowable((Throwable)throwable2, (String)"Initializing game");
    ...
    private static GameConfig.QuickPlayVariant getQuickPlayVariant(OptionSet optionSet, OptionSpec<String> optionSpec, OptionSpec<String> optionSpec2, OptionSpec<String> optionSpec3) {
        ...
        if (optionSet.has(optionSpec2)) {
            ...
            return (GameConfig.QuickPlayVariant)Optionull.mapOrDefault((Object)string, GameConfig.QuickPlayMultiplayerData::new, (Object)GameConfig.QuickPlayVariant.DISABLED);
        }
        if (optionSet.has(optionSpec3)) {
            String string = Main.unescapeJavaArgument(Main.parseArgument(optionSet, optionSpec3));
            return (GameConfig.QuickPlayVariant)Optionull.mapOrDefault((Object)string, GameConfig.QuickPlayRealmsData::new, (Object)GameConfig.QuickPlayVariant.DISABLED);
        }
        return GameConfig.QuickPlayVariant.DISABLED;
    }
