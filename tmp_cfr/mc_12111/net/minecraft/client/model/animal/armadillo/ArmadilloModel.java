...
extends EntityModel<ArmadilloRenderState> {
    ...
    public void setupAnim(ArmadilloRenderState armadilloRenderState) {
        ...
        if (armadilloRenderState.isHidingInShell) {
            ...
            this.head.xRot = Mth.clamp((float)armadilloRenderState.xRot, (float)-22.5f, (float)25.0f) * ((float)Math.PI / 180);
            this.head.yRot = Mth.clamp((float)armadilloRenderState.yRot, (float)-32.5f, (float)32.5f) * ((float)Math.PI / 180);
        }
