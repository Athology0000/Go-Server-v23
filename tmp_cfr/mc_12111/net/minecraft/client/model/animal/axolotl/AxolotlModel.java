...
extends EntityModel<AxolotlRenderState> {
    ...
    private void setupLayStillOnGroundAnimation(float f, float g) {
        ...
        float h = f * 0.09f;
        float i = Mth.sin((double)h);
        float j = Mth.cos((double)h);
        float k = i * i - 2.0f * i;
        float l = j * j - 3.0f * i;
    ...
    private void setupGroundCrawlingAnimation(float f, float g) {
        ...
        float h = f * 0.11f;
        float i = Mth.cos((double)h);
        float j = (i * i - 2.0f * i) / 5.0f;
        float k = 0.7f * i;
        float l = 0.09f * i * g;
        this.head.yRot += l;
        this.tail.yRot += l;
        float m = (0.6f - 0.08f * (i * i + 2.0f * Mth.sin((double)h))) * g;
        this.topGills.xRot += m;
        this.leftGills.yRot -= m;
        this.rightGills.yRot += m;
    ...
    private void setupWaterHoveringAnimation(float f, float g) {
        ...
        float h = f * 0.075f;
        float i = Mth.cos((double)h);
        float j = Mth.sin((double)h) * 0.15f;
    ...
    private void setupSwimmingAnimation(float f, float g, float h) {
        ...
        float i = f * 0.33f;
        float j = Mth.sin((double)i);
        float k = Mth.cos((double)i);
        float l = 0.13f * j;
        ...
        this.leftGills.yRot += m;
        this.rightGills.yRot -= m;
        this.tail.yRot += 0.3f * Mth.cos((double)(i * 0.9f)) * h;
