...
extends EntityModel<BeeRenderState> {
    ...
    public void setupAnim(BeeRenderState beeRenderState) {
        ...
        if (!beeRenderState.isOnGround) {
            ...
            this.rightWing.zRot = Mth.cos((double)f) * (float)Math.PI * 0.15f;
        ...
        if (!beeRenderState.isAngry && !beeRenderState.isOnGround) {
            f = Mth.cos((double)(beeRenderState.ageInTicks * 0.18f));
            ...
            this.bone.y -= Mth.cos((double)(beeRenderState.ageInTicks * 0.18f)) * 0.9f;
        }
        if (this.rollAmount > 0.0f) {
            this.bone.xRot = Mth.rotLerpRad((float)this.rollAmount, (float)this.bone.xRot, (float)3.0915928f);
        }
    }
}
