...
extends EntityModel<DolphinRenderState> {
    ...
    public void setupAnim(DolphinRenderState dolphinRenderState) {
        ...
        if (dolphinRenderState.isMoving) {
            this.body.xRot += -0.05f - 0.05f * Mth.cos((double)(dolphinRenderState.ageInTicks * 0.3f));
            this.tail.xRot = -0.1f * Mth.cos((double)(dolphinRenderState.ageInTicks * 0.3f));
            this.tailFin.xRot = -0.2f * Mth.cos((double)(dolphinRenderState.ageInTicks * 0.3f));
        }
    }
}
