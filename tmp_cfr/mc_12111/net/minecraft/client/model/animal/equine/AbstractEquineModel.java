...
extends EntityModel<T> {
    ...
    public void setupAnim(T equineRenderState) {
        ...
        float f = Mth.clamp((float)((EquineRenderState)equineRenderState).yRot, (float)-20.0f, (float)20.0f);
        ...
        if (h > 0.2f) {
            g += Mth.cos((double)(i * 0.8f)) * 0.15f * h;
        }
        ...
        float o = Mth.cos((double)(n * i * 0.6662f + (float)Math.PI));
        float p = o * 0.8f * h;
        float q = (1.0f - Math.max(k, j)) * (0.5235988f + g + m * Mth.sin((double)((EquineRenderState)equineRenderState).ageInTicks) * 0.05f);
        this.headParts.xRot = k * (0.2617994f + g) + j * (2.1816616f + Mth.sin((double)((EquineRenderState)equineRenderState).ageInTicks) * 0.05f) + q;
        ...
        this.headParts.y += Mth.lerp((float)j, (float)Mth.lerp((float)k, (float)0.0f, (float)(-8.0f * r)), (float)(7.0f * r));
        this.headParts.z = Mth.lerp((float)k, (float)this.headParts.z, (float)(-4.0f * r));
        this.body.xRot = k * -0.7853982f + l * this.body.xRot;
        float s = 0.2617994f * k;
        float t = Mth.cos((double)(((EquineRenderState)equineRenderState).ageInTicks * 0.6f + (float)Math.PI));
        ...
        this.tail.yRot = bl ? Mth.cos((double)(((EquineRenderState)equineRenderState).ageInTicks * 0.7f)) : 0.0f;
    }
}
