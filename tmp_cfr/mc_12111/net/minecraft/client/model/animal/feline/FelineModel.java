    ...
    public void setupAnim(T felineRenderState) {
        ...
        if (!((FelineRenderState)felineRenderState).isSitting) {
            ...
            if (((FelineRenderState)felineRenderState).isSprinting) {
                this.leftHindLeg.xRot = Mth.cos((double)(h * 0.6662f)) * g;
                this.rightHindLeg.xRot = Mth.cos((double)(h * 0.6662f + 0.3f)) * g;
                this.leftFrontLeg.xRot = Mth.cos((double)(h * 0.6662f + (float)Math.PI + 0.3f)) * g;
                this.rightFrontLeg.xRot = Mth.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.tail2.xRot = 1.7278761f + 0.31415927f * Mth.cos((double)h) * g;
            } else {
                this.leftHindLeg.xRot = Mth.cos((double)(h * 0.6662f)) * g;
                this.rightHindLeg.xRot = Mth.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.leftFrontLeg.xRot = Mth.cos((double)(h * 0.6662f + (float)Math.PI)) * g;
                this.rightFrontLeg.xRot = Mth.cos((double)(h * 0.6662f)) * g;
                this.tail2.xRot = !((FelineRenderState)felineRenderState).isCrouching ? 1.7278761f + 0.7853982f * Mth.cos((double)h) * g : 1.7278761f + 0.47123894f * Mth.cos((double)h) * g;
            }
        }
        if (((FelineRenderState)felineRenderState).isSitting) {
        ...
        if (((FelineRenderState)felineRenderState).lieDownAmount > 0.0f) {
            this.head.zRot = Mth.rotLerp((float)((FelineRenderState)felineRenderState).lieDownAmount, (float)this.head.zRot, (float)-1.2707963f);
            this.head.yRot = Mth.rotLerp((float)((FelineRenderState)felineRenderState).lieDownAmount, (float)this.head.yRot, (float)1.2707963f);
            ...
            this.tail1.xRot = Mth.rotLerp((float)((FelineRenderState)felineRenderState).lieDownAmountTail, (float)this.tail1.xRot, (float)0.8f);
            this.tail2.xRot = Mth.rotLerp((float)((FelineRenderState)felineRenderState).lieDownAmountTail, (float)this.tail2.xRot, (float)-0.4f);
        }
        if (((FelineRenderState)felineRenderState).relaxStateOneAmount > 0.0f) {
            this.head.xRot = Mth.rotLerp((float)((FelineRenderState)felineRenderState).relaxStateOneAmount, (float)this.head.xRot, (float)-0.58177644f);
        }
    }
}
