...
extends EntityModel<EntityRenderState> {
    ...
    public void setupAnim(EntityRenderState entityRenderState) {
        ...
        this.rightFin.zRot = -0.2f + 0.4f * Mth.sin((double)(entityRenderState.ageInTicks * 0.2f));
        this.leftFin.zRot = 0.2f - 0.4f * Mth.sin((double)(entityRenderState.ageInTicks * 0.2f));
    }
}
