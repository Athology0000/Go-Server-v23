...
extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState livingEntityRenderState) {
        ...
        float h = -(Mth.cos((double)(f * 2.0f + 0.0f)) * 0.4f) * g;
        float i = -(Mth.cos((double)(f * 2.0f + (float)Math.PI)) * 0.4f) * g;
        float j = -(Mth.cos((double)(f * 2.0f + 1.5707964f)) * 0.4f) * g;
        float k = -(Mth.cos((double)(f * 2.0f + 4.712389f)) * 0.4f) * g;
        float l = Math.abs(Mth.sin((double)(f + 0.0f)) * 0.4f) * g;
        float m = Math.abs(Mth.sin((double)(f + (float)Math.PI)) * 0.4f) * g;
        float n = Math.abs(Mth.sin((double)(f + 1.5707964f)) * 0.4f) * g;
        float o = Math.abs(Mth.sin((double)(f + 4.712389f)) * 0.4f) * g;
