...
VillagerLikeModel<WitchRenderState> {
    ...
    public void setupAnim(WitchRenderState witchRenderState) {
        ...
        this.rightLeg.xRot = Mth.cos((double)(witchRenderState.walkAnimationPos * 0.6662f)) * 1.4f * witchRenderState.walkAnimationSpeed * 0.5f;
        this.leftLeg.xRot = Mth.cos((double)(witchRenderState.walkAnimationPos * 0.6662f + (float)Math.PI)) * 1.4f * witchRenderState.walkAnimationSpeed * 0.5f;
        float f = 0.01f * (float)(witchRenderState.entityId % 10);
        this.nose.xRot = Mth.sin((double)(witchRenderState.ageInTicks * f)) * 4.5f * ((float)Math.PI / 180);
        this.nose.zRot = Mth.cos((double)(witchRenderState.ageInTicks * f)) * 2.5f * ((float)Math.PI / 180);
