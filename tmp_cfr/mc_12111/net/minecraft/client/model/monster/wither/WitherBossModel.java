...
extends EntityModel<WitherRenderState> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        partDefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(12, 22).addBox(0.0f, 0.0f, 0.0f, 3.0f, 6.0f, 3.0f, cubeDeformation), PartPose.offsetAndRotation(-2.0f, 6.9f + Mth.cos((double)0.2042035162448883) * 10.0f, -0.5f + Mth.sin((double)0.2042035162448883) * 10.0f, 0.83252203f, 0.0f, 0.0f));
    ...
    public void setupAnim(WitherRenderState witherRenderState) {
        ...
        float f = Mth.cos((double)(witherRenderState.ageInTicks * 0.1f));
