...
extends Model<State> {
    ...
    public void setupAnim(State state) {
        ...
        float f = (Mth.sin((double)(state.animationPos * 0.02f)) * 0.1f + 1.25f) * state.open;
        ...
        this.leftPages.x = Mth.sin((double)f);
        this.rightPages.x = Mth.sin((double)f);
        this.flipPage1.x = Mth.sin((double)f);
        this.flipPage2.x = Mth.sin((double)f);
    }
