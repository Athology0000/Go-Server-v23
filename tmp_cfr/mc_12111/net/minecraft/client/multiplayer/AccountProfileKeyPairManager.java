...
implements ProfileKeyPairManager {
    ...
    private @Nullable ProfileKeyPair fetchProfileKeyPair(UserApiService userApiService) throws CryptException, IOException {
        ...
        if (keyPairResponse != null) {
            ...
            return new ProfileKeyPair(Crypt.stringToPemRsaPrivateKey((String)keyPairResponse.keyPair().privateKey()), new ProfilePublicKey(data), Instant.parse(keyPairResponse.refreshedAfter()));
        }
        return null;
    }
    ...
    private static ProfilePublicKey.Data parsePublicKey(KeyPairResponse keyPairResponse) throws CryptException {
        ...
        try {
            ...
            PublicKey publicKey = Crypt.stringToRsaPublicKey((String)keyPair.publicKey());
            ...
            throw new CryptException((Throwable)runtimeException);
        }
    }
}
