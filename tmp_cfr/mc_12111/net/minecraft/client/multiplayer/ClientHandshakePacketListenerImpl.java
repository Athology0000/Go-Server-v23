...
implements ClientLoginPacketListener {
    ...
    public void handleHello(ClientboundHelloPacket clientboundHelloPacket) {
        ...
        try {
            ...
            string = new BigInteger(Crypt.digestData((String)clientboundHelloPacket.getServerId(), (PublicKey)publicKey, (SecretKey)secretKey)).toString(16);
            cipher = Crypt.getCipher((int)2, (Key)secretKey);
            cipher2 = Crypt.getCipher((int)1, (Key)secretKey);
    ...
    private void setEncryption(ServerboundKeyPacket serverboundKeyPacket, Cipher cipher, Cipher cipher2) {
        ...
        this.connection.send((Packet)serverboundKeyPacket, PacketSendListener.thenRun(() -> this.connection.setEncryptionKey(cipher, cipher2)));
    }
    ...
    private @Nullable Component authenticateServer(String string) {
        try {
            ...
            return Component.translatable((String)"disconnect.loginFailedInfo", (Object[])new Object[]{authenticationException.getMessage()});
        }
        return null;
    }
    ...
    public void handleCustomQuery(ClientboundCustomQueryPacket clientboundCustomQueryPacket) {
        ...
        this.connection.send((Packet)new ServerboundCustomQueryAnswerPacket(clientboundCustomQueryPacket.transactionId(), null));
    }
    ...
    public void handleRequestCookie(ClientboundCookieRequestPacket clientboundCookieRequestPacket) {
        this.connection.send((Packet)new ServerboundCookieResponsePacket(clientboundCookieRequestPacket.key(), this.cookies.get(clientboundCookieRequestPacket.key())));
    }
