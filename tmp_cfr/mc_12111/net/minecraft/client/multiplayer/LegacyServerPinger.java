...
extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(ChannelHandlerContext channelHandlerContext) throws Exception {
        ...
        try {
            ...
            LegacyProtocolUtils.writeLegacyString((ByteBuf)byteBuf, (String)"MC|PingHost");
            int i = byteBuf.writerIndex();
            byteBuf.writeShort(0);
            int j = byteBuf.writerIndex();
            byteBuf.writeByte(127);
            LegacyProtocolUtils.writeLegacyString((ByteBuf)byteBuf, (String)this.address.getHost());
    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf) {
        ...
        if (s == 255 && "\u00a71".equals((list = SPLITTER.splitToList((CharSequence)(string = LegacyProtocolUtils.readLegacyString((ByteBuf)byteBuf)))).get(0))) {
            int i = Mth.getInt((String)((String)list.get(1)), (int)0);
            String string2 = (String)list.get(2);
            String string3 = (String)list.get(3);
            int j = Mth.getInt((String)((String)list.get(4)), (int)-1);
            int k = Mth.getInt((String)((String)list.get(5)), (int)-1);
