...
public class ServerData {
    ...
    public CompoundTag write() {
        ...
        compoundTag.storeNullable("icon", ExtraCodecs.BASE64_STRING, (Object)this.iconBytes);
        compoundTag.store(ServerPackStatus.FIELD_CODEC, (Object)this.packStatus);
    ...
    public static byte @Nullable [] validateIcon(byte @Nullable [] bs) {
        if (bs != null) {
            try {
                PngInfo pngInfo = PngInfo.fromBytes((byte[])bs);
    ...
    public static enum ServerPackStatus {
        ...
        private ServerPackStatus(String string2) {
            this.name = Component.translatable((String)("manageServer.resourcePack." + string2));
        }
