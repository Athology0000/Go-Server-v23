...
public class ServerStatusPinger {
    ...
    public void pingServer(final ServerData serverData, final Runnable runnable, final Runnable runnable2, final EventLoopGroupHolder eventLoopGroupHolder) throws UnknownHostException {
        ...
        final Connection connection = Connection.connectToServer((InetSocketAddress)inetSocketAddress, (EventLoopGroupHolder)eventLoopGroupHolder, null);
        this.connections.add(connection);
        serverData.motd = Component.translatable((String)"multiplayer.status.pinging");
        ...
        ClientStatusPacketListener clientStatusPacketListener = new ClientStatusPacketListener(){
            ...
            public void handleStatusResponse(ClientboundStatusResponsePacket clientboundStatusResponsePacket) {
                ...
                serverStatus.version().ifPresentOrElse(version -> {
                    serverData2.version = Component.literal((String)version.name());
                    serverData2.protocol = version.protocol();
                }, () -> {
                    serverData2.version = Component.translatable((String)"multiplayer.status.old");
                ...
                serverStatus.players().ifPresentOrElse(players -> {
                    ...
                    if (!players.sample().isEmpty()) {
                        ...
                        for (NameAndId nameAndId : players.sample()) {
                            MutableComponent component = nameAndId.equals((Object)MinecraftServer.ANONYMOUS_PLAYER_PROFILE) ? Component.translatable((String)"multiplayer.status.anonymous_player") : Component.literal((String)nameAndId.name());
                            list.add((Component)component);
                        }
                        if (players.sample().size() < players.online()) {
                            list.add((Component)Component.translatable((String)"multiplayer.status.and_more", (Object[])new Object[]{players.online() - players.sample().size()}));
                        }
                    ...
                    serverData2.status = Component.translatable((String)"multiplayer.status.unknown").withStyle(ChatFormatting.DARK_GRAY);
                });
        ...
        ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group(eventLoopGroupHolder.eventLoopGroup())).handler((ChannelHandler)new ChannelInitializer<Channel>(this){
            ...
            protected void initChannel(Channel channel) {
                ...
                channel.pipeline().addLast(new ChannelHandler[]{new LegacyServerPinger(serverAddress, (i, string, string2, j, k) -> {
                    ...
                    serverData2.version = Component.literal((String)string);
                    serverData2.motd = Component.literal((String)string2);
    ...
    public static Component formatPlayerCount(int i, int j) {
        MutableComponent component = Component.literal((String)Integer.toString(i)).withStyle(ChatFormatting.GRAY);
        MutableComponent component2 = Component.literal((String)Integer.toString(j)).withStyle(ChatFormatting.GRAY);
        return Component.translatable((String)"multiplayer.status.player_count", (Object[])new Object[]{component, component2}).withStyle(ChatFormatting.DARK_GRAY);
    }
