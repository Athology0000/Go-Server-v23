...
extends LoggedChatEvent {
    ...
    public record Player(GameProfile profile, PlayerChatMessage message, ChatTrustLevel trustLevel) implements LoggedChatMessage
    {
        ...
        public Component toNarrationComponent() {
            ...
            return Component.translatable((String)"gui.chatSelection.message.narrate", (Object[])new Object[]{this.profile.name(), component, component2});
        }

        public Component toHeadingComponent() {
            Component component = this.getTimeComponent();
            return Component.translatable((String)"gui.chatSelection.heading", (Object[])new Object[]{this.profile.name(), component});
        }
        ...
        private Component getTimeComponent() {
            ...
            return Component.literal((String)zonedDateTime.format(TIME_FORMATTER)).withStyle(new ChatFormatting[]{ChatFormatting.ITALIC, ChatFormatting.GRAY});
        }
