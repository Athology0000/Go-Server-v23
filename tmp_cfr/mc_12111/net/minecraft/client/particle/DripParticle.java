...
extends SingleQuadParticle {
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            FallAndLandParticle dripParticle = new FallAndLandParticle(clientLevel, d, e, f, Fluids.EMPTY, (ParticleOptions)ParticleTypes.LANDING_OBSIDIAN_TEAR, this.sprite.get(randomSource));
            dripParticle.isGlowing = true;
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripHangParticle dripHangParticle = new DripHangParticle(clientLevel, d, e, f, Fluids.EMPTY, (ParticleOptions)ParticleTypes.FALLING_OBSIDIAN_TEAR, this.sprite.get(randomSource));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            ...
            dripParticle.lifetime = (int)(64.0f / Mth.randomBetween((RandomSource)dripParticle.random, (float)0.1f, (float)0.9f));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripstoneFallAndLandParticle dripParticle = new DripstoneFallAndLandParticle(clientLevel, d, e, f, (Fluid)Fluids.LAVA, (ParticleOptions)ParticleTypes.LANDING_LAVA, this.sprite.get(randomSource));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            CoolingDripHangParticle coolingDripHangParticle = new CoolingDripHangParticle(clientLevel, d, e, f, (Fluid)Fluids.LAVA, (ParticleOptions)ParticleTypes.FALLING_DRIPSTONE_LAVA, this.sprite.get(randomSource));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripstoneFallAndLandParticle dripParticle = new DripstoneFallAndLandParticle(clientLevel, d, e, f, (Fluid)Fluids.WATER, (ParticleOptions)ParticleTypes.SPLASH, this.sprite.get(randomSource));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripHangParticle dripParticle = new DripHangParticle(clientLevel, d, e, f, (Fluid)Fluids.WATER, (ParticleOptions)ParticleTypes.FALLING_DRIPSTONE_WATER, this.sprite.get(randomSource));
            dripParticle.setColor(0.2f, 0.3f, 1.0f);
            return dripParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            HoneyFallAndLandParticle dripParticle = new HoneyFallAndLandParticle(clientLevel, d, e, f, Fluids.EMPTY, (ParticleOptions)ParticleTypes.LANDING_HONEY, this.sprite.get(randomSource));
            dripParticle.gravity = 0.01f;
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripHangParticle dripHangParticle = new DripHangParticle(clientLevel, d, e, f, Fluids.EMPTY, (ParticleOptions)ParticleTypes.FALLING_HONEY, this.sprite.get(randomSource));
            dripHangParticle.gravity *= 0.01f;
            dripHangParticle.lifetime = 100;
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripLandParticle dripParticle = new DripLandParticle(clientLevel, d, e, f, (Fluid)Fluids.LAVA, this.sprite.get(randomSource));
            dripParticle.setColor(1.0f, 0.2857143f, 0.083333336f);
            return dripParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            FallAndLandParticle dripParticle = new FallAndLandParticle(clientLevel, d, e, f, (Fluid)Fluids.LAVA, (ParticleOptions)ParticleTypes.LANDING_LAVA, this.sprite.get(randomSource));
            dripParticle.setColor(1.0f, 0.2857143f, 0.083333336f);
            return dripParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            CoolingDripHangParticle coolingDripHangParticle = new CoolingDripHangParticle(clientLevel, d, e, f, (Fluid)Fluids.LAVA, (ParticleOptions)ParticleTypes.FALLING_LAVA, this.sprite.get(randomSource));
            return coolingDripHangParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            FallAndLandParticle dripParticle = new FallAndLandParticle(clientLevel, d, e, f, (Fluid)Fluids.WATER, (ParticleOptions)ParticleTypes.SPLASH, this.sprite.get(randomSource));
            dripParticle.setColor(0.2f, 0.3f, 1.0f);
            return dripParticle;
        }
    }
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            DripHangParticle dripParticle = new DripHangParticle(clientLevel, d, e, f, (Fluid)Fluids.WATER, (ParticleOptions)ParticleTypes.FALLING_WATER, this.sprite.get(randomSource));
            dripParticle.setColor(0.2f, 0.3f, 1.0f);
            return dripParticle;
        }
    }
