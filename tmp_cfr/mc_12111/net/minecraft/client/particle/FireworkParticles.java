...
public class FireworkParticles {
    ...
    extends SingleQuadParticle {
        ...
        public float getQuadSize(float f) {
            return 7.1f * Mth.sin((double)(((float)this.age + f - 1.0f) * 0.25f * (float)Math.PI));
        }
    }
    ...
    extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
                ...
                this.engine.createParticle((ParticleOptions)ColorParticleOption.create((ParticleType)ParticleTypes.FLASH, (int)j), this.x, this.y, this.z, 0.0, 0.0, 0.0);
            }
            ++this.life;
        ...
        private void createParticle(double d, double e, double f, double g, double h, double i, IntList intList, IntList intList2, boolean bl, boolean bl2) {
            SparkParticle sparkParticle = (SparkParticle)this.engine.createParticle((ParticleOptions)ParticleTypes.FIREWORK, d, e, f, g, h, i);
            sparkParticle.setTrail(bl);
            sparkParticle.setTwinkle(bl2);
            sparkParticle.setAlpha(0.99f);
            sparkParticle.setColor((Integer)Util.getRandom((List)intList, (RandomSource)this.random));
            if (!intList2.isEmpty()) {
                sparkParticle.setFadeColor((Integer)Util.getRandom((List)intList2, (RandomSource)this.random));
            }
        }
