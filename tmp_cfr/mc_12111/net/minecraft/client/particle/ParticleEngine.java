...
public class ParticleEngine {
    ...
    private <T extends ParticleOptions> @Nullable Particle makeParticle(T particleOptions, double d, double e, double f, double g, double h, double i) {
        ParticleProvider particleProvider = (ParticleProvider)this.resourceManager.getProviders().get(BuiltInRegistries.PARTICLE_TYPE.getId((Object)particleOptions.getType()));
