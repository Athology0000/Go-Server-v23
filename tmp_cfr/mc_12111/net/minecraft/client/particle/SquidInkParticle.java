...
extends SimpleAnimatedParticle {
    SquidInkParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, int j, SpriteSet spriteSet) {
        ...
        this.quadSize = 0.5f;
        this.setAlpha(1.0f);
        this.setColor(ARGB.redFloat((int)j), ARGB.greenFloat((int)j), ARGB.blueFloat((int)j));
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, RandomSource randomSource) {
            return new SquidInkParticle(clientLevel, d, e, f, g, h, i, ARGB.colorFromFloat((float)1.0f, (float)0.2f, (float)0.8f, (float)0.6f), this.sprites);
        }
    }
