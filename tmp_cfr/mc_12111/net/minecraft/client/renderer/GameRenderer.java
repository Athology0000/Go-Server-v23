...
AutoCloseable {
    ...
    protected final CubeMap cubeMap = new CubeMap(Identifier.withDefaultNamespace((String)"textures/gui/title/background/panorama"));
    ...
    public void checkEntityPostEffect(@Nullable Entity entity) {
        ...
        int n = 0;
        switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{Creeper.class, Spider.class, EnderMan.class}, (Object)entity2, n)) {
            case 0: {
    ...
    public void tick() {
        ...
        if (this.minecraft.getCameraEntity() == null) {
            this.minecraft.setCameraEntity((Entity)localPlayer);
        }
    ...
    private float getFov(Camera camera, float f, boolean bl) {
        ...
        if (bl) {
            ...
            g *= Mth.lerp((float)f, (float)this.oldFovModifier, (float)this.fovModifier);
        }
        ...
        if ((fogType = camera.getFluidInCamera()) == FogType.LAVA || fogType == FogType.WATER) {
            ...
            g *= Mth.lerp((float)h, (float)1.0f, (float)0.85714287f);
        }
        return g;
    }
    ...
    private void bobView(PoseStack poseStack, float f) {
        ...
        poseStack.mulPose((Quaternionfc)Axis.ZP.rotationDegrees(Mth.sin((double)(g * (float)Math.PI)) * h * 3.0f));
        poseStack.mulPose((Quaternionfc)Axis.XP.rotationDegrees(Math.abs(Mth.cos((double)(g * (float)Math.PI - 0.2f)) * h) * 5.0f));
    }
    ...
    public static float getNightVisionScale(LivingEntity livingEntity, float f) {
        ...
        return 0.7f + Mth.sin((double)(((float)mobEffectInstance.getDuration() - f) * (float)Math.PI * 0.2f)) * 0.3f;
    }
    ...
    public void render(DeltaTracker deltaTracker, boolean bl) {
        ...
        if (this.minecraft.getOverlay() != null) {
            try {
                ...
                CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"Rendering overlay");
        ...
        if (bl2 && this.minecraft.screen != null) {
            try {
                ...
                CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"Rendering screen");
            ...
            try {
                ...
                CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"Narrating screen");
    ...
    private void renderActiveTextDebug() {
        ...
        this.guiRenderState.forEachText(guiTextRenderState -> guiTextRenderState.ensurePrepared().visit(new Font.GlyphVisitor(){
            ...
            private void renderDebugMarkers(ActiveArea activeArea, boolean bl) {
                ...
                int l = j == 0 || k == 0 ? i : 0;
                int m = ARGB.color((int)128, (int)j, (int)k, (int)l);
        ...
        if (bl && !((Player)entity).getAbilities().mayBuild) {
            ...
            if (hitResult != null && hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                if (this.minecraft.gameMode.getPlayerMode() == GameType.SPECTATOR) {
                    bl = blockState.getMenuProvider((Level)this.minecraft.level, blockPos) != null;
                } else {
                    BlockInWorld blockInWorld = new BlockInWorld((LevelReader)this.minecraft.level, blockPos, false);
    ...
    public void updateCamera(DeltaTracker deltaTracker) {
        ...
        this.mainCamera.setup(this.minecraft.level, (Entity)entity, !this.minecraft.options.getCameraType().isFirstPerson(), this.minecraft.options.getCameraType().isMirrored(), g);
    }
    ...
    public void renderLevel(DeltaTracker deltaTracker) {
        ...
        float i = Mth.lerp((float)f, (float)localPlayer.oPortalEffectIntensity, (float)localPlayer.portalEffectIntensity);
    ...
    public float getDarkenWorldAmount(float f) {
        return Mth.lerp((float)f, (float)this.darkenWorldAmountO, (float)this.darkenWorldAmount);
    }
