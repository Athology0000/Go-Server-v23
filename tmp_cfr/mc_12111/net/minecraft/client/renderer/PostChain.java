        ...
        block9: while (true) {
            ...
            switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{PostChainConfig.TextureInput.class, PostChainConfig.TargetInput.class}, (Object)input, n)) {
                case 0: {
                    ...
                    AbstractTexture abstractTexture = textureManager.getTexture(identifier2.withPath(string -> "textures/effect/" + string + ".png"));
                ...
                case 1: {
                    ...
                    try {
                        boolean bl;
                        String string3;
                        String string32 = string3 = ((PostChainConfig.TargetInput)object).samplerName();
                        String identifier3 = string3 = ((PostChainConfig.TargetInput)object).targetId();
                        ...
                        list.add(new PostPass.TargetInput(string32, (Identifier)identifier3, bl2, bl3));
                    }
        ...
        public static TargetBundle of(final Identifier identifier, final ResourceHandle<RenderTarget> resourceHandle) {
            return new TargetBundle(){
                ...
                public @Nullable ResourceHandle<RenderTarget> get(Identifier identifier2) {
                    return identifier2.equals((Object)identifier) ? this.handle : null;
                }
            };
        }
