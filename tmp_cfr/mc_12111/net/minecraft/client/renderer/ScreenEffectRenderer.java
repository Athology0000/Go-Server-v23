...
public class ScreenEffectRenderer {
    ...
    private void renderItemActivationAnimation(PoseStack poseStack, float f, SubmitNodeCollector submitNodeCollector) {
        ...
        poseStack.pushPose();
        poseStack.translate(n * Mth.abs((float)Mth.sin((double)(l * 2.0f))), o * Mth.abs((float)Mth.sin((double)(l * 2.0f))), -10.0f + 9.0f * Mth.sin((double)l));
        float p = 0.8f;
        poseStack.scale(0.8f, 0.8f, 0.8f);
        poseStack.mulPose((Quaternionfc)Axis.YP.rotationDegrees(900.0f * Mth.abs((float)Mth.sin((double)l))));
        poseStack.mulPose((Quaternionfc)Axis.XP.rotationDegrees(6.0f * Mth.cos((double)(g * 8.0f))));
        poseStack.mulPose((Quaternionfc)Axis.ZP.rotationDegrees(6.0f * Mth.cos((double)(g * 8.0f))));
    ...
    private static void renderTex(TextureAtlasSprite textureAtlasSprite, PoseStack poseStack, MultiBufferSource multiBufferSource) {
        float f = 0.1f;
        int i = ARGB.colorFromFloat((float)1.0f, (float)0.1f, (float)0.1f, (float)0.1f);
        float g = -1.0f;
        float h = 1.0f;
        float j = -1.0f;
        float k = 1.0f;
    ...
    private static void renderWater(Minecraft minecraft, PoseStack poseStack, MultiBufferSource multiBufferSource) {
        ...
        int i = ARGB.colorFromFloat((float)0.1f, (float)f, (float)f, (float)f);
        float g = 4.0f;
        float h = -1.0f;
        float j = 1.0f;
        float k = -1.0f;
