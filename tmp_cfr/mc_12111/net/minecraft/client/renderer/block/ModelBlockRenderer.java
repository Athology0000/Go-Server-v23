...
public class ModelBlockRenderer {
    ...
    private static boolean shouldRenderFace(BlockAndTintGetter blockAndTintGetter, BlockState blockState, boolean bl, Direction direction, BlockPos blockPos) {
        ...
        return Block.shouldRenderFace((BlockState)blockState, (BlockState)blockState2, (Direction)direction);
    }
    ...
    public void tesselateWithAO(BlockAndTintGetter blockAndTintGetter, List<BlockModelPart> list, BlockState blockState, BlockPos blockPos, PoseStack poseStack, VertexConsumer vertexConsumer, boolean bl, int i) {
        ...
        for (BlockModelPart blockModelPart : list) {
            for (Direction direction : DIRECTIONS) {
                ...
                if (!bl2) {
                    bl3 = ModelBlockRenderer.shouldRenderFace(blockAndTintGetter, blockState, bl, direction, (BlockPos)ambientOcclusionRenderStorage.scratchPos.setWithOffset((Vec3i)blockPos, direction));
                    j |= l;
                    if (bl3) {
                        k |= l;
                    }
    ...
    public void tesselateWithoutAO(BlockAndTintGetter blockAndTintGetter, List<BlockModelPart> list, BlockState blockState, BlockPos blockPos, PoseStack poseStack, VertexConsumer vertexConsumer, boolean bl, int i) {
        ...
        for (BlockModelPart blockModelPart : list) {
            for (Direction direction : DIRECTIONS) {
                ...
                if (!bl2) {
                    bl3 = ModelBlockRenderer.shouldRenderFace(blockAndTintGetter, blockState, bl, direction, (BlockPos)blockPos2);
                    j |= l;
                    if (bl3) {
                        k |= l;
                    }
                ...
                if (!bl3) continue;
                int m = commonRenderStorage.cache.getLightColor(blockState, blockAndTintGetter, (BlockPos)blockPos2);
    ...
    public static void renderModel(PoseStack.Pose pose, VertexConsumer vertexConsumer, BlockStateModel blockStateModel, float f, float g, float h, int i, int j) {
        for (BlockModelPart blockModelPart : blockStateModel.collectParts(RandomSource.create((long)42L))) {
            for (Direction direction : DIRECTIONS) {
    ...
    extends CommonRenderStorage {
        ...
        public void calculate(BlockAndTintGetter blockAndTintGetter, BlockState blockState, BlockPos blockPos, Direction direction, boolean bl) {
            ...
            BlockState blockState2 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
            int i = this.cache.getLightColor(blockState2, blockAndTintGetter, (BlockPos)mutableBlockPos);
            float f = this.cache.getShadeBrightness(blockState2, blockAndTintGetter, (BlockPos)mutableBlockPos);
            mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[1]);
            BlockState blockState3 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
            int j = this.cache.getLightColor(blockState3, blockAndTintGetter, (BlockPos)mutableBlockPos);
            float g = this.cache.getShadeBrightness(blockState3, blockAndTintGetter, (BlockPos)mutableBlockPos);
            mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[2]);
            BlockState blockState4 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
            int k = this.cache.getLightColor(blockState4, blockAndTintGetter, (BlockPos)mutableBlockPos);
            float h = this.cache.getShadeBrightness(blockState4, blockAndTintGetter, (BlockPos)mutableBlockPos);
            mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[3]);
            BlockState blockState5 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
            int l = this.cache.getLightColor(blockState5, blockAndTintGetter, (BlockPos)mutableBlockPos);
            float m = this.cache.getShadeBrightness(blockState5, blockAndTintGetter, (BlockPos)mutableBlockPos);
            BlockState blockState6 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[0]).move(direction));
            boolean bl2 = !blockState6.isViewBlocking((BlockGetter)blockAndTintGetter, (BlockPos)mutableBlockPos) || blockState6.getLightBlock() == 0;
            BlockState blockState7 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[1]).move(direction));
            boolean bl3 = !blockState7.isViewBlocking((BlockGetter)blockAndTintGetter, (BlockPos)mutableBlockPos) || blockState7.getLightBlock() == 0;
            BlockState blockState8 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[2]).move(direction));
            boolean bl4 = !blockState8.isViewBlocking((BlockGetter)blockAndTintGetter, (BlockPos)mutableBlockPos) || blockState8.getLightBlock() == 0;
            BlockState blockState9 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[3]).move(direction));
            boolean bl6 = bl5 = !blockState9.isViewBlocking((BlockGetter)blockAndTintGetter, (BlockPos)mutableBlockPos) || blockState9.getLightBlock() == 0;
            if (bl4 || bl2) {
                mutableBlockPos.setWithOffset((Vec3i)blockPos2, adjacencyInfo.corners[0]).move(adjacencyInfo.corners[2]);
                blockState10 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
                n = this.cache.getShadeBrightness(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
                o = this.cache.getLightColor(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
            } else {
                n = f;
                o = i;
            }
            if (bl5 || bl2) {
                ...
                blockState10 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
                p = this.cache.getShadeBrightness(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
                q = this.cache.getLightColor(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
            } else {
                p = f;
                q = i;
            }
            if (bl4 || bl3) {
                ...
                blockState10 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
                r = this.cache.getShadeBrightness(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
                s = this.cache.getLightColor(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
            } else {
                r = f;
                s = i;
            }
            if (bl5 || bl3) {
                ...
                blockState10 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
                t = this.cache.getShadeBrightness(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
                u = this.cache.getLightColor(blockState10, blockAndTintGetter, (BlockPos)mutableBlockPos);
            } else {
                t = f;
                u = i;
            }
            ...
            BlockState blockState11 = blockAndTintGetter.getBlockState((BlockPos)mutableBlockPos);
            if (this.faceCubic || !blockState11.isSolidRender()) {
                v = this.cache.getLightColor(blockState11, blockAndTintGetter, (BlockPos)mutableBlockPos);
            }
    ...
    static class Cache {
        ...
        public float getShadeBrightness(BlockState blockState, BlockAndTintGetter blockAndTintGetter, BlockPos blockPos) {
            ...
            f = blockState.getShadeBrightness((BlockGetter)blockAndTintGetter, blockPos);
            if (this.enabled) {
    ...
    protected static enum AdjacencyInfo {
        ...
        static {
            BY_FACING = (AdjacencyInfo[])Util.make((Object)new AdjacencyInfo[6], adjacencyInfos -> {
    ...
    static enum AmbientVertexRemap {
        ...
        static {
            BY_FACING = (AmbientVertexRemap[])Util.make((Object)new AmbientVertexRemap[6], ambientVertexRemaps -> {
