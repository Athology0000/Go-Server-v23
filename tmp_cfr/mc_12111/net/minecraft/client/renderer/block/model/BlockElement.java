...
public record BlockElement(Vector3fc from, Vector3fc to, Map<Direction, BlockElementFace> faces, @Nullable BlockElementRotation rotation, boolean shade, int lightEmission) {
    ...
    implements JsonDeserializer<BlockElement> {
        ...
        public BlockElement deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            if (jsonObject.has(FIELD_SHADE) && !GsonHelper.isBooleanValue((JsonObject)jsonObject, (String)FIELD_SHADE)) {
                throw new JsonParseException("Expected 'shade' to be a Boolean");
            }
            boolean bl = GsonHelper.getAsBoolean((JsonObject)jsonObject, (String)FIELD_SHADE, (boolean)true);
            int i = 0;
            if (jsonObject.has(FIELD_LIGHT_EMISSION)) {
                boolean bl2 = GsonHelper.isNumberValue((JsonObject)jsonObject, (String)FIELD_LIGHT_EMISSION);
                if (bl2) {
                    i = GsonHelper.getAsInt((JsonObject)jsonObject, (String)FIELD_LIGHT_EMISSION);
                }
                if (!bl2 || i < 0 || i > 15) {
        ...
        private @Nullable BlockElementRotation getRotation(JsonObject jsonObject) {
            if (jsonObject.has(FIELD_ROTATION)) {
                ...
                JsonObject jsonObject2 = GsonHelper.getAsJsonObject((JsonObject)jsonObject, (String)FIELD_ROTATION);
                ...
                if (jsonObject2.has(FIELD_AXIS) || jsonObject2.has(FIELD_ANGLE)) {
                    ...
                    float f = GsonHelper.getAsFloat((JsonObject)jsonObject2, (String)FIELD_ANGLE);
                    ...
                    float g = GsonHelper.getAsFloat((JsonObject)jsonObject2, (String)FIELD_X, (float)0.0f);
                    float f = GsonHelper.getAsFloat((JsonObject)jsonObject2, (String)FIELD_Y, (float)0.0f);
                    float h = GsonHelper.getAsFloat((JsonObject)jsonObject2, (String)FIELD_Z, (float)0.0f);
                ...
                boolean bl = GsonHelper.getAsBoolean((JsonObject)jsonObject2, (String)FIELD_RESCALE, (boolean)false);
                return new BlockElementRotation((Vector3fc)vector3f, (BlockElementRotation.RotationValue)((Object)rotationValue), bl);
            }
            return null;
        }

        private Direction.Axis getAxis(JsonObject jsonObject) {
            String string = GsonHelper.getAsString((JsonObject)jsonObject, (String)FIELD_AXIS);
            Direction.Axis axis = Direction.Axis.byName((String)string.toLowerCase(Locale.ROOT));
            if (axis == null) {
        ...
        private Map<Direction, BlockElementFace> filterNullFromFaces(JsonDeserializationContext jsonDeserializationContext, JsonObject jsonObject) {
            ...
            JsonObject jsonObject2 = GsonHelper.getAsJsonObject((JsonObject)jsonObject, (String)FIELD_FACES);
        ...
        private static Vector3f getVector3f(JsonObject jsonObject, String string) {
            JsonArray jsonArray = GsonHelper.getAsJsonArray((JsonObject)jsonObject, (String)string);
            if (jsonArray.size() != 3) {
                throw new JsonParseException("Expected 3 " + string + " values, found: " + jsonArray.size());
            }
            float[] fs = new float[3];
            for (int i = 0; i < fs.length; ++i) {
                fs[i] = GsonHelper.convertToFloat((JsonElement)jsonArray.get(i), (String)(string + "[" + i + "]"));
            }
