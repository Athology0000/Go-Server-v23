...
implements SectionMesh {
    ...
    public void uploadMeshLayer(ChunkSectionLayer chunkSectionLayer, MeshData meshData, long l) {
        ...
        if (sectionBuffers != null) {
            if (sectionBuffers.getVertexBuffer().size() < (long)meshData.vertexBuffer().remaining()) {
                ...
                sectionBuffers.setVertexBuffer(RenderSystem.getDevice().createBuffer(() -> "Section vertex buffer - layer: " + chunkSectionLayer.label() + "; cords: " + SectionPos.x((long)l) + ", " + SectionPos.y((long)l) + ", " + SectionPos.z((long)l), 40, meshData.vertexBuffer()));
            ...
            if (byteBuffer != null) {
                if (sectionBuffers.getIndexBuffer() == null || sectionBuffers.getIndexBuffer().size() < (long)byteBuffer.remaining()) {
                    ...
                    sectionBuffers.setIndexBuffer(RenderSystem.getDevice().createBuffer(() -> "Section index buffer - layer: " + chunkSectionLayer.label() + "; cords: " + SectionPos.x((long)l) + ", " + SectionPos.y((long)l) + ", " + SectionPos.z((long)l), 72, byteBuffer));
            ...
            GpuBuffer gpuBuffer = RenderSystem.getDevice().createBuffer(() -> "Section vertex buffer - layer: " + chunkSectionLayer.label() + "; cords: " + SectionPos.x((long)l) + ", " + SectionPos.y((long)l) + ", " + SectionPos.z((long)l), 40, meshData.vertexBuffer());
            ByteBuffer byteBuffer2 = meshData.indexBuffer();
            GpuBuffer gpuBuffer2 = byteBuffer2 != null ? RenderSystem.getDevice().createBuffer(() -> "Section index buffer - layer: " + chunkSectionLayer.label() + "; cords: " + SectionPos.x((long)l) + ", " + SectionPos.y((long)l) + ", " + SectionPos.z((long)l), 72, byteBuffer2) : null;
    ...
    public void uploadLayerIndexBuffer(ChunkSectionLayer chunkSectionLayer, ByteBufferBuilder.Result result, long l) {
        ...
        if (sectionBuffers.getIndexBuffer() == null) {
            sectionBuffers.setIndexBuffer(RenderSystem.getDevice().createBuffer(() -> "Section index buffer - layer: " + chunkSectionLayer.label() + "; cords: " + SectionPos.x((long)l) + ", " + SectionPos.y((long)l) + ", " + SectionPos.z((long)l), 72, result.byteBuffer()));
        } else {
            CommandEncoder commandEncoder = RenderSystem.getDevice().createCommandEncoder();
