...
public class SectionCompiler {
    ...
    public Results compile(SectionPos sectionPos, RenderSectionRegion renderSectionRegion, VertexSorting vertexSorting, SectionBufferBuilderPack sectionBufferBuilderPack) {
        ...
        for (BlockPos blockPos3 : BlockPos.betweenClosed((BlockPos)blockPos, (BlockPos)blockPos2)) {
            ...
            poseStack.pushPose();
            poseStack.translate(SectionPos.sectionRelative((int)blockPos3.getX()), SectionPos.sectionRelative((int)blockPos3.getY()), SectionPos.sectionRelative((int)blockPos3.getZ()));
