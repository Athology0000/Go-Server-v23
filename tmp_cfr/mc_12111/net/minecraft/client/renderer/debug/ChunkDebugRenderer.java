...
implements DebugRenderer.SimpleDebugRenderer {
        ...
        if (this.data != null) {
            ...
            for (Map.Entry<ChunkPos, String> entry : this.data.clientData.entrySet()) {
                ...
                for (String string2 : strings) {
                    Gizmos.billboardText((String)string2, (Vec3)new Vec3((double)SectionPos.sectionToBlockCoord((int)chunkPos.x, (int)8), i + (double)j, (double)SectionPos.sectionToBlockCoord((int)chunkPos.z, (int)8)), (TextGizmo.Style)TextGizmo.Style.whiteAndCentered().withScale(2.4f)).setAlwaysOnTop();
                    j -= 2;
                }
            }
        }
    ...
    final class ChunkData {
        ...
        ChunkData(ChunkDebugRenderer chunkDebugRenderer, IntegratedServer integratedServer, double d, double e) {
            ...
            ResourceKey resourceKey = clientLevel.dimension();
            int i = SectionPos.posToSectionCoord((double)d);
            int j = SectionPos.posToSectionCoord((double)e);
