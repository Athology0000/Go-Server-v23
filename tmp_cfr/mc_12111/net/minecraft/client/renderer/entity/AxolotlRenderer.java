...
extends AgeableMobRenderer<Axolotl, AxolotlRenderState, AxolotlModel> {
    private static final Map<Axolotl.Variant, Identifier> TEXTURE_BY_TYPE = (Map)Util.make((Object)Maps.newHashMap(), hashMap -> {
        for (Axolotl.Variant variant : Axolotl.Variant.values()) {
            hashMap.put(variant, Identifier.withDefaultNamespace((String)String.format(Locale.ROOT, "textures/entity/axolotl/axolotl_%s.png", variant.getName())));
        }
    });
