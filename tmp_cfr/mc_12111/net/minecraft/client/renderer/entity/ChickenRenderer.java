...
extends MobRenderer<Chicken, ChickenRenderState, ChickenModel> {
    ...
    public void extractRenderState(Chicken chicken, ChickenRenderState chickenRenderState, float f) {
        ...
        chickenRenderState.flap = Mth.lerp((float)f, (float)chicken.oFlap, (float)chicken.flap);
        chickenRenderState.flapSpeed = Mth.lerp((float)f, (float)chicken.oFlapSpeed, (float)chicken.flapSpeed);
