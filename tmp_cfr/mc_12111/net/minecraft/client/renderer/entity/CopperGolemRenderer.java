...
extends MobRenderer<CopperGolem, CopperGolemRenderState, CopperGolemModel> {
    ...
    public Identifier getTextureLocation(CopperGolemRenderState copperGolemRenderState) {
        return CopperGolemOxidationLevels.getOxidationLevel((WeatheringCopper.WeatherState)copperGolemRenderState.weathering).texture();
    }

    private static Function<CopperGolemRenderState, Identifier> getEyeTextureLocationProvider() {
        return copperGolemRenderState -> CopperGolemOxidationLevels.getOxidationLevel((WeatheringCopper.WeatherState)copperGolemRenderState.weathering).eyeTexture();
    }
    ...
    public void extractRenderState(CopperGolem copperGolem, CopperGolemRenderState copperGolemRenderState, float f) {
        ...
        ArmedEntityRenderState.extractArmedEntityRenderState((LivingEntity)copperGolem, copperGolemRenderState, this.itemModelResolver, f);
        ...
        copperGolemRenderState.blockOnAntenna = Optional.of(copperGolem.getItemBySlot(CopperGolem.EQUIPMENT_SLOT_ANTENNA)).flatMap(itemStack -> {
            ...
            BlockItemStateProperties blockItemStateProperties = (BlockItemStateProperties)itemStack.getOrDefault(DataComponents.BLOCK_STATE, (Object)BlockItemStateProperties.EMPTY);
