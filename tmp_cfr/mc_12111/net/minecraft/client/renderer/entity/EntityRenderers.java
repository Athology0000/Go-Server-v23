...
public class EntityRenderers {
    ...
    public static Map<EntityType<?>, EntityRenderer<?, ?>> createEntityRenderers(EntityRendererProvider.Context context) {
        ...
        PROVIDERS.forEach((entityType, entityRendererProvider) -> {
            try {
                ...
                throw new IllegalArgumentException("Failed to create model for " + String.valueOf(BuiltInRegistries.ENTITY_TYPE.getKey(entityType)), exception);
            }
        });
    ...
    public static boolean validateRegistrations() {
        ...
        for (EntityType entityType : BuiltInRegistries.ENTITY_TYPE) {
            ...
            LOGGER.warn("No renderer registered for {}", (Object)BuiltInRegistries.ENTITY_TYPE.getKey((Object)entityType));
            bl = false;
        }
        return !bl;
    }
