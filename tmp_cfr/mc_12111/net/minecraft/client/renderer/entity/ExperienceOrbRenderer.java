...
extends EntityRenderer<ExperienceOrb, ExperienceOrbRenderState> {
    private static final Identifier EXPERIENCE_ORB_LOCATION = Identifier.withDefaultNamespace((String)"textures/entity/experience_orb.png");
    ...
    protected int getBlockLightLevel(ExperienceOrb experienceOrb, BlockPos blockPos) {
        return Mth.clamp((int)(super.getBlockLightLevel(experienceOrb, blockPos) + 7), (int)0, (int)15);
    }
    ...
    public void submit(ExperienceOrbRenderState experienceOrbRenderState, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState cameraRenderState) {
        ...
        int p = (int)((Mth.sin((double)(o + 0.0f)) + 1.0f) * 0.5f * 255.0f);
        int q = 255;
        int r = (int)((Mth.sin((double)(o + 4.1887903f)) + 1.0f) * 0.1f * 255.0f);
