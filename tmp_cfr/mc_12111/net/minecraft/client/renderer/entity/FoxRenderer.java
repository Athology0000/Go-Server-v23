...
extends AgeableMobRenderer<Fox, FoxRenderState, FoxModel> {
    ...
    private static final Identifier SNOW_FOX_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/fox/snow_fox.png");
    private static final Identifier SNOW_FOX_SLEEP_TEXTURE = Identifier.withDefaultNamespace((String)"textures/entity/fox/snow_fox_sleep.png");
    ...
    public void extractRenderState(Fox fox, FoxRenderState foxRenderState, float f) {
        ...
        HoldingEntityRenderState.extractHoldingEntityRenderState((LivingEntity)fox, foxRenderState, this.itemModelResolver);
