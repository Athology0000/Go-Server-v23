...
extends AgeableMobRenderer<MushroomCow, MushroomCowRenderState, CowModel> {
    private static final Map<MushroomCow.Variant, Identifier> TEXTURES = (Map)Util.make((Object)Maps.newHashMap(), hashMap -> {
        hashMap.put(MushroomCow.Variant.BROWN, Identifier.withDefaultNamespace((String)"textures/entity/cow/brown_mooshroom.png"));
        hashMap.put(MushroomCow.Variant.RED, Identifier.withDefaultNamespace((String)"textures/entity/cow/red_mooshroom.png"));
    });
