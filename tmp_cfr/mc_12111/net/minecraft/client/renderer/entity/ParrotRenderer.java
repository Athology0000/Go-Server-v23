...
extends MobRenderer<Parrot, ParrotRenderState, ParrotModel> {
    ...
    public void extractRenderState(Parrot parrot, ParrotRenderState parrotRenderState, float f) {
        ...
        float g = Mth.lerp((float)f, (float)parrot.oFlap, (float)parrot.flap);
        float h = Mth.lerp((float)f, (float)parrot.oFlapSpeed, (float)parrot.flapSpeed);
        parrotRenderState.flapAngle = (Mth.sin((double)g) + 1.0f) * h;
