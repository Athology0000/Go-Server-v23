...
extends AgeableMobRenderer<Villager, VillagerRenderState, VillagerModel> {
    private static final Identifier VILLAGER_BASE_SKIN = Identifier.withDefaultNamespace((String)"textures/entity/villager/villager.png");
    ...
    public void extractRenderState(Villager villager, VillagerRenderState villagerRenderState, float f) {
        ...
        HoldingEntityRenderState.extractHoldingEntityRenderState((LivingEntity)villager, villagerRenderState, this.itemModelResolver);
