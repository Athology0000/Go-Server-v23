...
extends MobRenderer<Warden, WardenRenderState, WardenModel> {
    ...
    public WardenRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new LivingEntityEmissiveLayer<WardenRenderState, WardenModel>(this, wardenRenderState -> PULSATING_SPOTS_TEXTURE_1, (wardenRenderState, f) -> Math.max(0.0f, Mth.cos((double)(f * 0.045f)) * 0.25f), wardenModel2, RenderTypes::entityTranslucentEmissive, false));
        this.addLayer(new LivingEntityEmissiveLayer<WardenRenderState, WardenModel>(this, wardenRenderState -> PULSATING_SPOTS_TEXTURE_2, (wardenRenderState, f) -> Math.max(0.0f, Mth.cos((double)(f * 0.045f + (float)Math.PI)) * 0.25f), wardenModel2, RenderTypes::entityTranslucentEmissive, false));
