...
extends RenderLayer<HorseRenderState, HorseModel> {
    ...
    private static final Map<Markings, Identifier> TEXTURE_BY_MARKINGS = Maps.newEnumMap(Map.of(Markings.NONE, INVISIBLE_TEXTURE, Markings.WHITE, Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_markings_white.png"), Markings.WHITE_FIELD, Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_markings_whitefield.png"), Markings.WHITE_DOTS, Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_markings_whitedots.png"), Markings.BLACK_DOTS, Identifier.withDefaultNamespace((String)"textures/entity/horse/horse_markings_blackdots.png")));
