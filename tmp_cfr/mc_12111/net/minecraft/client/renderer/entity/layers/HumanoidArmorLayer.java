...
extends RenderLayer<S, M> {
    ...
    private void renderArmorPiece(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, ItemStack itemStack, EquipmentSlot equipmentSlot, int i, S humanoidRenderState) {
        ...
        this.equipmentRenderer.renderLayers(layerType, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().orElseThrow()), humanoidModel, humanoidRenderState, itemStack, poseStack, submitNodeCollector, i, ((HumanoidRenderState)humanoidRenderState).outlineColor);
    }
