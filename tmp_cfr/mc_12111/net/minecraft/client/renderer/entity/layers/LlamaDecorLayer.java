...
extends RenderLayer<LlamaRenderState, LlamaModel> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, LlamaRenderState llamaRenderState, float f, float g) {
        ...
        if (equippable != null && equippable.assetId().isPresent()) {
            this.renderEquipment(poseStack, submitNodeCollector, llamaRenderState, itemStack, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().get()), i);
        } else if (llamaRenderState.isTraderLlama) {
            this.renderEquipment(poseStack, submitNodeCollector, llamaRenderState, ItemStack.EMPTY, (ResourceKey<EquipmentAsset>)EquipmentAssets.TRADER_LLAMA, i);
        }
    }
