...
extends RenderLayer<S, RM> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, S livingEntityRenderState, float f, float g) {
        ...
        this.equipmentRenderer.renderLayers(this.layer, (ResourceKey<EquipmentAsset>)((ResourceKey)equippable.assetId().get()), entityModel, livingEntityRenderState, itemStack, poseStack, submitNodeCollector, i, (Identifier)null, ((LivingEntityRenderState)livingEntityRenderState).outlineColor, this.order);
    }
}
