...
extends FogEnvironment {
    ...
    public void setupFog(FogData fogData, Camera camera, ClientLevel clientLevel, float f, DeltaTracker deltaTracker) {
        ...
        fogData.environmentalStart = ((Float)camera.attributeProbe().getValue(EnvironmentAttributes.WATER_FOG_START_DISTANCE, g)).floatValue();
        fogData.environmentalEnd = ((Float)camera.attributeProbe().getValue(EnvironmentAttributes.WATER_FOG_END_DISTANCE, g)).floatValue();
