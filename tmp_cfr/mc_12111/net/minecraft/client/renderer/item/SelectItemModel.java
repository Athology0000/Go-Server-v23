...
implements ItemModel {
    ...
    extends Record {
        ...
        public static <T> Codec<SwitchCase<T>> codec(Codec<T> codec) {
            return RecordCodecBuilder.create(instance -> instance.group((App)ExtraCodecs.nonEmptyList((Codec)ExtraCodecs.compactListCodec((Codec)codec)).fieldOf("when").forGetter(SwitchCase::values), (App)ItemModels.CODEC.fieldOf("model").forGetter(SwitchCase::model)).apply((Applicative)instance, SwitchCase::new));
        }
    ...
    public record UnbakedSwitch<P extends SelectItemModelProperty<T>, T>(P property, List<SwitchCase<T>> cases) {
        ...
        private /* synthetic */ void method_67280(RegistryContextSwapper registryContextSwapper, ClientLevel clientLevel, Object2ObjectMap object2ObjectMap, Object object2, ItemModel itemModel) {
            registryContextSwapper.swapTo(this.property.valueCodec(), object2, (HolderLookup.Provider)clientLevel.registryAccess()).ifSuccess(object -> object2ObjectMap.put(object, (Object)itemModel));
        }
    }
