...
implements NoDataSpecialModelRenderer {
    ...
    {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("texture").forGetter(Unbaked::texture), (App)Codec.FLOAT.optionalFieldOf("openness", (Object)Float.valueOf(0.0f)).forGetter(Unbaked::openness), (App)Direction.CODEC.optionalFieldOf("orientation", (Object)Direction.UP).forGetter(Unbaked::orientation)).apply((Applicative)instance, Unbaked::new));

        public Unbaked() {
            this(Identifier.withDefaultNamespace((String)"shulker"), 0.0f, Direction.UP);
        }
