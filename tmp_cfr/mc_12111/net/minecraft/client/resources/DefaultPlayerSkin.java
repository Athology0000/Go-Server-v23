...
public class DefaultPlayerSkin {
    ...
    private static PlayerSkin create(String string, PlayerModelType playerModelType) {
        return new PlayerSkin((ClientAsset.Texture)new ClientAsset.ResourceTexture(Identifier.withDefaultNamespace((String)string)), null, null, playerModelType, true);
    }
}
