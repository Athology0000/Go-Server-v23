...
public class SkinManager {
    ...
    CompletableFuture<PlayerSkin> registerTextures(UUID uUID, MinecraftProfileTextures minecraftProfileTextures) {
        ...
        if (minecraftProfileTexture != null) {
            ...
            playerModelType = PlayerModelType.byLegacyServicesName((String)minecraftProfileTexture.getMetadata("model"));
        } else {
    ...
    class TextureCache {
        ...
        private Identifier getTextureLocation(String string) {
            ...
            return Identifier.withDefaultNamespace((String)(string2 + "/" + string));
        }
    }
