...
public record EquipmentClientInfo(Map<LayerType, List<Layer>> layers) {
    ...
    public static final Codec<EquipmentClientInfo> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ExtraCodecs.nonEmptyMap((Codec)Codec.unboundedMap(LayerType.CODEC, LAYER_LIST_CODEC)).fieldOf("layers").forGetter(EquipmentClientInfo::layers)).apply((Applicative)instance, EquipmentClientInfo::new));
    ...
    public List<Layer> getLayers(LayerType layerType) {
        return this.layers.getOrDefault((Object)layerType, List.of());
    }
