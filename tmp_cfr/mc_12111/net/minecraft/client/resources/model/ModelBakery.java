...
public class ModelBakery {
    ...
    public static final Material BANNER_BASE = new Material(Sheets.BANNER_SHEET, Identifier.withDefaultNamespace((String)"entity/banner_base"));
    public static final Material SHIELD_BASE = new Material(Sheets.SHIELD_SHEET, Identifier.withDefaultNamespace((String)"entity/shield_base"));
    public static final Material NO_PATTERN_SHIELD = new Material(Sheets.SHIELD_SHEET, Identifier.withDefaultNamespace((String)"entity/shield_base_nopattern"));
    ...
    public CompletableFuture<BakingResult> bakeModels(SpriteGetter spriteGetter, Executor executor) {
        ...
        CompletableFuture completableFuture = ParallelMapTransform.schedule(this.unbakedBlockStateModels, (blockState, unbakedRoot) -> {
            try {
        ...
        CompletableFuture completableFuture2 = ParallelMapTransform.schedule(this.clientInfos, (identifier, clientItem) -> {
            try {
        ...
        return completableFuture.thenCombine((CompletionStage)completableFuture2, (map2, map3) -> new BakingResult(missingModels, (Map<BlockState, BlockStateModel>)map2, (Map<Identifier, ItemModel>)map3, map));
    }
