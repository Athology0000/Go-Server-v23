...
implements AmbientSoundHandler {
    ...
    public void tick() {
        ...
        ambientSounds.mood().ifPresent(ambientMoodSettings -> {
            ...
            BlockPos blockPos = BlockPos.containing((double)(this.player.getX() + (double)this.random.nextInt(i) - (double)ambientMoodSettings.blockSearchExtent()), (double)(this.player.getEyeY() + (double)this.random.nextInt(i) - (double)ambientMoodSettings.blockSearchExtent()), (double)(this.player.getZ() + (double)this.random.nextInt(i) - (double)ambientMoodSettings.blockSearchExtent()));
            ...
            if (this.moodiness >= 1.0f) {
                ...
                SimpleSoundInstance simpleSoundInstance = SimpleSoundInstance.forAmbientMood((SoundEvent)ambientMoodSettings.soundEvent().value(), this.random, this.player.getX() + g / l * m, this.player.getEyeY() + h / l * m, this.player.getZ() + k / l * m);
