        ...
        new Thread("Realms-connect-task"){
            ...
            public void run() {
                ...
                try {
                    ...
                    RealmsConnect.this.connection = Connection.connectToServer((InetSocketAddress)inetSocketAddress, (EventLoopGroupHolder)EventLoopGroupHolder.remote((boolean)minecraft.options.useNativeTransport()), (LocalSampleLogger)minecraft.getDebugOverlay().getBandwidthLogger());
                    if (RealmsConnect.this.aborted) {
                        return;
                    }
                    ...
                    RealmsConnect.this.connection.initiateServerboundPlayConnection(string, i, (ClientLoginPacketListener)clientHandshakePacketListenerImpl);
                    if (RealmsConnect.this.aborted) {
                        return;
                    }
                    RealmsConnect.this.connection.send((Packet)new ServerboundHelloPacket(minecraft.getUser().getName(), minecraft.getUser().getProfileId()));
                    ...
                    DisconnectedScreen disconnectedScreen = new DisconnectedScreen(RealmsConnect.this.onlineScreen, (Component)Component.translatable((String)"mco.connect.failed"), (Component)Component.translatable((String)"disconnect.genericReason", (Object[])new Object[]{string3}), CommonComponents.GUI_BACK);
